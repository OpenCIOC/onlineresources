...
'Call makePageHeader(TXT_FIELD_HELP, TXT_FIELD_HELP, False, False, True, False)

Dim	strNUM
strNUM = TrimAll(Request("NUM"))
...
<p><strong><%=TXT_SHOW_FIELD%></strong> <%=makeIndexFieldList("ShowField",strNUM)%></p>
<div id="FieldContents"></div>
<p>
</div>
</body>
</html>
