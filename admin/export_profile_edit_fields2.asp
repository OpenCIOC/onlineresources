...
If Nl(strErrorMessage) Then
	Call handleMessage(TXT_FIELD_LIST_UPDATED, _
		"export_profile_edit_fields.asp", _
		"ProfileID=" & intProfileID, _
		False)
Else
	Call handleError(TXT_FIELD_LIST_NOT_UPDATED & strErrorMessage, _
		"export_profile_edit_fields.asp", _
