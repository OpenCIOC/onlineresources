...
strUpdateAccountEmail = Left(Trim(Request("UpdateAccountEmail")),60)
...
Else
	...
	With cmdUpdateAgency 	
		...
		.Parameters.Append .CreateParameter("@UpdateEmailCIC", adVarChar, adParamInput, 60, strUpdateEmailCIC)
		...
		.Parameters.Append .CreateParameter("@UpdateEmailVOL", adVarChar, adParamInput, 60, strUpdateEmailVOL)
		...
		.Parameters.Append .CreateParameter("@UpdateAccountEmail", adVarChar, adParamInput, 60, strUpdateAccountEmail)
