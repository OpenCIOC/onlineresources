...
all_fields = tuple(six.iterkeys(TemplateBaseSchema.fields)) + colour_fields + link_fields
...
class TemplateDescriptionSchema(Schema):
	...
	Logo = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	LogoAltText = ciocvalidators.UnicodeString(max=255)
	LogoLink = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	LogoMobile = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	Banner = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	...
	Web = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	Facebook = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	Twitter = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	Instagram = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	LinkedIn = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
	YouTube = Pipe(ciocvalidators.URLWithProto(add_http=True, require_tld=False), validators.MaxLength(255))
