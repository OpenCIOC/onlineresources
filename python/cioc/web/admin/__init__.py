...
def includeme(config):
	...
	config.add_route('admin_checklists_hide', urlprefix + 'checklist/hide', factory=checklist_factory)
	config.add_route('admin_checklists_sharedstate', urlprefix + 'checklist/sharedstate', factory=checklist_factory)
	config.add_route('admin_checklists_local', urlprefix + 'checklist/local', factory=checklist_factory)
	config.add_route('admin_checklists_shared', urlprefix + 'checklist/shared', factory=checklist_factory)
	config.add_route('admin_checklists', urlprefix + 'checklist', factory=checklist_factory)
	...
	# /admin/listsvalues
	config.add_route('admin_listvalues', urlprefix + 'listvalues', factory='cioc.web.admin.listvalues.ListValuesContext')
	...
	config.add_route('admin_sharingprofile', urlprefix + 'sharingprofile/{action}',
	...
	config.add_route('admin_thesaurus', urlprefix + 'thesaurus/{action}', factory='cioc.web.admin.thesaurus.ThesaurusContext')

	factory = partial(AdminUserApiCredsContext, list_page=True)
	config.add_route('admin_userapicreds_index', urlprefix + 'userapicreds', factory=factory)
	config.add_route('admin_userapicreds', urlprefix + 'userapicreds/{action}', factory='cioc.web.admin.userapicreds.AdminUserApiCredsContext')
