...
class FieldHelp(viewbase.AdminViewBase):
    ...
    def save(self):
        ...
        SuperUserGlobal = (domain.id == const.DM_CIC and user.cic.SuperUserGlobal) or (
            ...
            if not result.Return:
                self._go_to_route(
                    ...
                    _query=[
                        ...
                        (
                            "InfoMsg",
                            _("The Field Help was updated successfully.", request),
                        ),
                        ("FieldID", FieldID),
    ...
    def edit(self):
        ...
        model_state = request.model_state
        model_state.validators = {"FieldID": ciocvalidators.IDValidator(not_empty=True)}
