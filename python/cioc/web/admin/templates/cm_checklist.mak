...
<%def name="make_cm_checklist_ui(name, name_map)">
		...
		<div id="cm_checklist_new_input_table"><input type="text" class="text" id="NEW_cm_checklist" title="${_('Add New Community')}" maxlength="200"> <input type="button" id="add_cm_checklist" value="${_('Add')}"></div>
</%def>
