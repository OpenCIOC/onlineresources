...
<tr>
	...
	<td>${renderer.errorlist('topicsearch.TopicSearchTag')}
    ${renderer.text('topic_search.TopicSearchTag', maxlength=20)}</td>
</tr>
...
<tr>
	...
	<td>${renderer.errorlist("descriptions." + lang.FormCulture + ".SearchTitle")}
	${renderer.text("descriptions." + lang.FormCulture + ".SearchTitle", maxlength=50)}</td>
</tr>
%endfor
%for culture in culture_order:
<% lang = culture_map[culture] %>
<tr>
	...
	<td>${renderer.errorlist("descriptions." + lang.FormCulture + ".SearchDescription")}
	${renderer.textarea("descriptions." + lang.FormCulture + ".SearchDescription", cols=const.TEXTAREA_COLS - 10)}</td>
</tr>
%endfor
<tr>
	<td class="FieldLabelLeft">${renderer.label('topic_search.DisplayOrder', _('Display Order'))}</td>
	<td>${renderer.errorlist("topic_search.DisplayOrder")}
    ${renderer.text('topic_search.DisplayOrder', maxlength=3)}</td>
</tr>
...
<tr>
	...
	<td>${renderer.errorlist(prefix + "Required")}
    ${renderer.checkbox(prefix + 'Required')}</td>
</tr>
%endif
...
<tr>
	...
	<td>${renderer.errorlist("topic_search.PB_ID" + heading_no)}
...
<tr>
	...
	<td>${renderer.errorlist(prefix + "ListType")}
...
<tr>
	...
	<td>${renderer.errorlist(full_name)}
