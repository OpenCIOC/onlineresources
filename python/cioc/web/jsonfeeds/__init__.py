...
def includeme(config):
	...
	config.add_route('jsonfeeds_vacancy', urlprefix + 'vacancy/{action}', factory=factory_cic)

	config.add_route('jsonfeeds_volpopularorgs', urlprefix + 'volunteer/popular_orgs', factory=factory_vol)

	config.add_route('jsonfeeds_volpopularinterests', urlprefix + 'volunteer/popular_interests', factory=factory_vol)

	config.add_route('jsonfeeds_volnewest', urlprefix + 'volunteer/newest', factory=factory_vol)

	config.add_route('jsonfeeds_volorg', urlprefix + 'volunteer/org', factory=factory_vol)

	config.add_route('jsonfeeds_volinterest', urlprefix + 'volunteer/interest', factory=factory_vol)

	config.add_route('jsonfeeds_cicnewest', urlprefix + 'cominfo/newest', factory=factory_cic)
	...
	config.add_route('jsonfeeds_cictaxonomy', urlprefix + 'cominfo/taxonomy', factory=factory_cic)
	config.add_route('jsonfeeds_icons', urlprefix + 'icons',
