...
CREATE PROCEDURE [dbo].[sp_CIC_View_UpdateFields_l_Contact]
	@ViewType int
...
WHERE DisplayFM like 'dbo.fn_GBL_FullContact%'
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_View_UpdateFields_l_Contact] TO [cioc_login_role]
GO
