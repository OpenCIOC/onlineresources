...
CREATE PROCEDURE [dbo].[sp_CIC_View_s_CSrch] @ViewType int
...
SELECT
    ...
    vw.CSrchSubsidy,
    CASE
        WHEN memd.SubsidyNamedProgramSearchLabel IS NOT NULL
        THEN
        vw.CSrchSubsidyNamedProgram ELSE 0 END AS CSrchSubsidyNamedProgram,
