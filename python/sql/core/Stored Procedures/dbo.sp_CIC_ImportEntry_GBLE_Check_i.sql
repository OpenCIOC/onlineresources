...
CREATE PROCEDURE [dbo].[sp_CIC_ImportEntry_GBLE_Check_i]
	@MemberID int,
	@NUM varchar(8)
...
WHERE NUM=@NUM
	...
	AND NOT EXISTS(SELECT * FROM GBL_BaseTable_Description WHERE NUM=bt.NUM AND LangID=0)
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_ImportEntry_GBLE_Check_i] TO [cioc_login_role]
GO
