...
CREATE PROCEDURE [dbo].[sp_CIC_Agency_Update_s]
	@AgencyCode char(3)
...
SELECT 	dbo.fn_GBL_DisplayFullOrgName_Agency_2(bt.NUM,btd.ORG_LEVEL_1,btd.ORG_LEVEL_2,btd.ORG_LEVEL_3,btd.ORG_LEVEL_4,btd.ORG_LEVEL_5,btd.LOCATION_NAME,btd.SERVICE_NAME_LEVEL_1,btd.SERVICE_NAME_LEVEL_2) AS ORG_NAME_FULL,
		btd.FAX, 
		ISNULL(a.UpdateEmailCIC, btd.E_MAIL) AS UPDATE_EMAIL, 
		ISNULL(a.UpdatePhoneCIC, btd.OFFICE_PHONE) AS UPDATE_PHONE,
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_Agency_Update_s] TO [cioc_login_role]
GO
