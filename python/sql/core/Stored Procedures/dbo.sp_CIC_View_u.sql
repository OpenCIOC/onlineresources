...
IF @Error = 0 BEGIN
	...
	IF @Error=0 BEGIN
		EXEC @Error = dbo.sp_GBL_Display_u NULL, @ViewType, 1, @ShowID, @ShowOwner, @ShowAlert, @ShowOrg, @ShowCommunity, @ShowUpdateSchedule, @LinkUpdate, @LinkEmail, @LinkSelect, @LinkWeb, @LinkListAdd, @OrderBy, @OrderByCustom, @OrderByDesc, @GlinkMail, @GLinkPub, @VShowTable, @VShowPosition, @VShowDuties, @DisplayOptFields, @ErrMsg OUTPUT
	END
END
