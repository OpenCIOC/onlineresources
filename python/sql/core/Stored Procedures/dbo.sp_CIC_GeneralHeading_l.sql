...
CREATE PROCEDURE [dbo].[sp_CIC_GeneralHeading_l]
	@MemberID int,
	@PB_ID [int],
	@Used [bit],
	@NonPublic [bit],
...
GRANT EXECUTE ON  [dbo].[sp_CIC_GeneralHeading_l] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[sp_CIC_GeneralHeading_l] TO [cioc_login_role]
GO
