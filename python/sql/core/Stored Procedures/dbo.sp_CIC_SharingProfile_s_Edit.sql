...
CREATE PROCEDURE [dbo].[sp_CIC_SharingProfile_s_Edit]
	@MemberID int,
	@ProfileID int
...
SELECT * 
FROM GBL_SharingProfile_CIC_Fld
WHERE ProfileID=@ProfileID

SELECT *
FROM GBL_SharingProfile_CIC_View
WHERE ProfileID=@ProfileID
...
GRANT EXECUTE ON  [dbo].[sp_CIC_SharingProfile_s_Edit] TO [cioc_login_role]
GO
