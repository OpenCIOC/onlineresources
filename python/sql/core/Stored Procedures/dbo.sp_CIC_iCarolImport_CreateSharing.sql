...
SELECT 
		...
		COALESCE(s.[ImportDate], a.[ImportDate]) AS [ImportDate],
		COALESCE(s.[ImportStatus], a.[ImportStatus]) AS [ImportStatus],
		COALESCE(s.[Refresh], a.[Refresh]) AS [Refresh],
		...
		COALESCE(s.[AgencyDescription], a.[AgencyDescription]) AS [AgencyDescription],
		COALESCE(s.[SearchHints], a.[SearchHints]) AS [SearchHints],
		...
		COALESCE(s.[IRSStatus], a.[IRSStatus]) AS [IRSStatus],
		COALESCE(s.[FEIN], a.[FEIN]) AS [FEIN],
		...
		COALESCE(s.[Custom_A1) Does your organization consent to participate in the], a.[Custom_A1) Does your organization consent to participate in the]) AS [Custom_A1) Does your organization consent to participate in the],
		COALESCE(s.[Custom_Public Comments], a.[Custom_Public Comments]) AS [Custom_Public Comments],
		COALESCE(s.[Custom_A2) What is the likelihood that within the next 2-5 year], a.[Custom_A2) What is the likelihood that within the next 2-5 year]) AS [Custom_A2) What is the likelihood that within the next 2-5 year],
		COALESCE(s.[Custom_S1) Does your organization own/rent/sublease the space], a.[Custom_S1) Does your organization own/rent/sublease the space]) AS [Custom_S1) Does your organization own/rent/sublease the space],
		COALESCE(s.[Custom_S2) If your organization rents the space please state fr], a.[Custom_S2) If your organization rents the space please state fr]) AS [Custom_S2) If your organization rents the space please state fr],
		COALESCE(s.[Custom_S3) What type of facilities do you have at the space (Ch], a.[Custom_S3) What type of facilities do you have at the space (Ch]) AS [Custom_S3) What type of facilities do you have at the space (Ch],
		COALESCE(s.[Custom_S4) What is the approximate square footage of the space], a.[Custom_S4) What is the approximate square footage of the space]) AS [Custom_S4) What is the approximate square footage of the space],
		COALESCE(s.[Custom_S5) In what type of building is the space located], a.[Custom_S5) In what type of building is the space located]) AS [Custom_S5) In what type of building is the space located],
		COALESCE(s.[Custom_S6) If your organization plans to move from the space in], a.[Custom_S6) If your organization plans to move from the space in]) AS [Custom_S6) If your organization plans to move from the space in],
		COALESCE(s.[Custom_Former Names], a.[Custom_Former Names]) AS [Custom_Former Names],
		COALESCE(s.[Custom_Headings], a.[Custom_Headings]) AS [Custom_Headings],
		COALESCE(s.[Custom_Legal Name], a.[Custom_Legal Name]) AS [Custom_Legal Name],
		COALESCE(s.[Custom_Pub Codes], a.[Custom_Pub Codes]) AS [Custom_Pub Codes],
		COALESCE(s.[Custom_Record Owner (211 Central)], a.[Custom_Record Owner (211 Central)]) AS [Custom_Record Owner (211 Central)],
		COALESCE(s.[Custom_Record Owner (controlled)], a.[Custom_Record Owner (controlled)]) AS [Custom_Record Owner (controlled)],
		COALESCE(s.[Custom_SINV], a.[Custom_SINV]) AS [Custom_SINV],
		COALESCE(s.[Custom_iCarol-managed record], a.[Custom_iCarol-managed record]) AS [Custom_iCarol-managed record],
...
SELECT 
		...
		COALESCE(pas.[ImportDate], p.[ImportDate], s.[ImportDate], a.[ImportDate]) AS [ImportDate],
		COALESCE(pas.[ImportStatus], p.[ImportStatus], s.[ImportStatus], a.[ImportStatus]) AS [ImportStatus],
		COALESCE(pas.[Refresh], p.[Refresh], s.[Refresh], a.[Refresh]) AS [Refresh],
		...
		a.[AgencyDescription] AS [AgencyDescription],
		COALESCE(pas.[SearchHints], p.[SearchHints], s.[SearchHints], a.[SearchHints]) AS [SearchHints],
		...
		COALESCE(pas.[IRSStatus], p.[IRSStatus], s.[IRSStatus], a.[IRSStatus]) AS [IRSStatus],
		COALESCE(pas.[FEIN], p.[FEIN], s.[FEIN], a.[FEIN]) AS [FEIN],
		...
		COALESCE(pas.[Custom_A1) Does your organization consent to participate in the], p.[Custom_A1) Does your organization consent to participate in the], s.[Custom_A1) Does your organization consent to participate in the], a.[Custom_A1) Does your organization consent to participate in the]) AS [Custom_A1) Does your organization consent to participate in the],
		...
		COALESCE(pas.[Custom_A2) What is the likelihood that within the next 2-5 year], p.[Custom_A2) What is the likelihood that within the next 2-5 year], s.[Custom_A2) What is the likelihood that within the next 2-5 year], a.[Custom_A2) What is the likelihood that within the next 2-5 year]) AS [Custom_A2) What is the likelihood that within the next 2-5 year],
		COALESCE(pas.[Custom_S1) Does your organization own/rent/sublease the space], p.[Custom_S1) Does your organization own/rent/sublease the space], s.[Custom_S1) Does your organization own/rent/sublease the space], a.[Custom_S1) Does your organization own/rent/sublease the space]) AS [Custom_S1) Does your organization own/rent/sublease the space],
		COALESCE(pas.[Custom_S2) If your organization rents the space please state fr], p.[Custom_S2) If your organization rents the space please state fr], s.[Custom_S2) If your organization rents the space please state fr], a.[Custom_S2) If your organization rents the space please state fr]) AS [Custom_S2) If your organization rents the space please state fr],
		COALESCE(pas.[Custom_S3) What type of facilities do you have at the space (Ch], p.[Custom_S3) What type of facilities do you have at the space (Ch], s.[Custom_S3) What type of facilities do you have at the space (Ch], a.[Custom_S3) What type of facilities do you have at the space (Ch]) AS [Custom_S3) What type of facilities do you have at the space (Ch],
		COALESCE(pas.[Custom_S4) What is the approximate square footage of the space], p.[Custom_S4) What is the approximate square footage of the space], s.[Custom_S4) What is the approximate square footage of the space], a.[Custom_S4) What is the approximate square footage of the space]) AS [Custom_S4) What is the approximate square footage of the space],
		COALESCE(pas.[Custom_S5) In what type of building is the space located], p.[Custom_S5) In what type of building is the space located], s.[Custom_S5) In what type of building is the space located], a.[Custom_S5) In what type of building is the space located]) AS [Custom_S5) In what type of building is the space located],
		COALESCE(pas.[Custom_S6) If your organization plans to move from the space in], p.[Custom_S6) If your organization plans to move from the space in], s.[Custom_S6) If your organization plans to move from the space in], a.[Custom_S6) If your organization plans to move from the space in]) AS [Custom_S6) If your organization plans to move from the space in],
		...
		COALESCE(pas.[Custom_Headings], p.[Custom_Headings], s.[Custom_Headings], a.[Custom_Headings]) AS [Custom_Headings],
		COALESCE(pas.[Custom_Legal Name], p.[Custom_Legal Name], s.[Custom_Legal Name], a.[Custom_Legal Name]) AS [Custom_Legal Name],
		COALESCE(pas.[Custom_Pub Codes], p.[Custom_Pub Codes], s.[Custom_Pub Codes], a.[Custom_Pub Codes]) AS [Custom_Pub Codes],
		COALESCE(pas.[Custom_Record Owner (211 Central)], p.[Custom_Record Owner (211 Central)], s.[Custom_Record Owner (211 Central)], a.[Custom_Record Owner (211 Central)]) AS [Custom_Record Owner (211 Central)],
		COALESCE(pas.[Custom_Record Owner (controlled)], p.[Custom_Record Owner (controlled)], s.[Custom_Record Owner (controlled)], a.[Custom_Record Owner (controlled)]) AS [Custom_Record Owner (controlled)],
		COALESCE(pas.[Custom_SINV], p.[Custom_SINV], s.[Custom_SINV], a.[Custom_SINV]) AS [Custom_SINV],
		COALESCE(pas.[Custom_iCarol-managed record], p.[Custom_iCarol-managed record], s.[Custom_iCarol-managed record], a.[Custom_iCarol-managed record]) AS [Custom_iCarol-managed record],
