...
CREATE PROCEDURE [dbo].[sp_CCR_NUMSchoolEscort_s]
	@NUM varchar(8)
...
SELECT	sch.SCH_ID, schn.Name AS SchoolName, sch.SchoolBoard, prn.EscortNotes AS Notes
	FROM CCR_School sch
...
GO
GRANT EXECUTE ON  [dbo].[sp_CCR_NUMSchoolEscort_s] TO [cioc_login_role]
GO
