...
CREATE PROCEDURE [dbo].[sp_GBL_Agency_lf]
	@MemberID [int],
...
GO
GRANT EXECUTE ON  [dbo].[sp_GBL_Agency_lf] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[sp_GBL_Agency_lf] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[sp_GBL_Agency_lf] TO [cioc_vol_search_role]
GO
