...
CREATE PROCEDURE [dbo].[sp_VOL_View_i_Lang]
	@ViewType [int],
...
END ELSE IF EXISTS(SELECT * FROM VOL_View_Description WHERE ViewType=@ViewType AND LangID=@LangID) BEGIN
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_View_i_Lang] TO [cioc_login_role]
GO
