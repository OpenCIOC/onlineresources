...
CREATE PROCEDURE [dbo].[sp_VOL_Stats2]
	@MemberID int,
	@ViewType int,
	@LimitByView bit
...
SELECT dbo.fn_GBL_DisplayFullOrgName_2(vo.NUM,btd.ORG_LEVEL_1,btd.ORG_LEVEL_2,btd.ORG_LEVEL_3,btd.ORG_LEVEL_4,btd.ORG_LEVEL_5,btd.LOCATION_NAME,btd.SERVICE_NAME_LEVEL_1,btd.SERVICE_NAME_LEVEL_2,bt.DISPLAY_LOCATION_NAME,bt.DISPLAY_ORG_NAME) AS ORG_NAME_FULL,
...
ORDER BY CASE WHEN vo.VNUM IS NULL THEN 1 ELSE 0 END,
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_Stats2] TO [cioc_login_role]
GO
