...
CREATE PROCEDURE [dbo].[sp_VOL_OP_Referral_u_VProfile_Outcome]
	@ProfileID [uniqueidentifier],
	@REF_ID int,
	@VolunteerSuccessfulPlacement bit,
	@VolunteerOutcomeNotes nvarchar(max),
...
END ELSE BEGIN
	UPDATE VOL_OP_Referral
		SET VolunteerSuccessfulPlacement = @VolunteerSuccessfulPlacement,
			VolunteerOutcomeNotes = @VolunteerOutcomeNotes
	WHERE REF_ID=@REF_ID
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_OP_Referral_u_VProfile_Outcome] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[sp_VOL_OP_Referral_u_VProfile_Outcome] TO [cioc_vol_search_role]
GO
