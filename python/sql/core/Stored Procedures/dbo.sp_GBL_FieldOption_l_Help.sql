...
CREATE PROCEDURE [dbo].[sp_GBL_FieldOption_l_Help]
	@MemberID int,
	@LangID smallint
...
WHERE @MemberID IS NULL
	OR NOT EXISTS(SELECT * FROM GBL_FieldOption_InactiveByMember fi WHERE fi.FieldID=fo.FieldID AND fi.MemberID=@MemberID)
...
GRANT EXECUTE ON  [dbo].[sp_GBL_FieldOption_l_Help] TO [cioc_login_role]
GO
