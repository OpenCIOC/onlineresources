...
CREATE PROCEDURE [dbo].[sp_NAICS_BroaderCodes_sl]
	@Code [varchar](6)
...
WHERE nc.Code <> @Code AND (nc.Code = left(@Code,5) OR
...
GO
GRANT EXECUTE ON  [dbo].[sp_NAICS_BroaderCodes_sl] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[sp_NAICS_BroaderCodes_sl] TO [cioc_login_role]
GO
