...
SELECT 
		...
		CASE WHEN pas.[MailingCountry] IS NOT NULL THEN pas.[MailingCountry] WHEN ISNULL(p.MailingAddressIsPrivate, 'No') = 'No' AND p.[MailingCountry]  IS NOT NULL THEN p.[MailingCountry]  WHEN ISNULL(s.MailingAddressIsPrivate, 'No') = 'No' AND s.[MailingCountry]  IS NOT NULL THEN s.[MailingCountry]  WHEN ISNULL(a.MailingAddressIsPrivate, 'No') = 'No' AND a.[MailingCountry]  IS NOT NULL THEN a.[MailingCountry]  ELSE NULL END AS [MailingCountry],
		...
		CASE WHEN pas.[PhysicalCountry] IS NOT NULL THEN pas.[PhysicalCountry] WHEN ISNULL(p.PhysicalAddressIsPrivate, 'No') = 'No' AND p.[PhysicalCountry]  IS NOT NULL THEN p.[PhysicalCountry]  WHEN ISNULL(s.PhysicalAddressIsPrivate, 'No') = 'No' AND s.[PhysicalCountry]  IS NOT NULL THEN s.[PhysicalCountry]  WHEN ISNULL(a.PhysicalAddressIsPrivate, 'No') = 'No' AND a.[PhysicalCountry]  IS NOT NULL THEN a.[PhysicalCountry]  ELSE NULL END AS [PhysicalCountry],
...
SELECT 
		...
		CASE WHEN s.[MailingCountry] IS NOT NULL THEN s.[MailingCountry] WHEN ISNULL(a.[MailingAddressIsPrivate], 'No') = 'No' AND a.[MailingCountry]  IS NOT NULL THEN a.[MailingCountry]  ELSE NULL END AS [MailingCountry],
		...
		CASE WHEN s.[PhysicalCountry] IS NOT NULL THEN s.[PhysicalCountry] WHEN ISNULL(a.[PhysicalAddressIsPrivate], 'No') = 'No' AND a.[PhysicalCountry]  IS NOT NULL THEN a.[PhysicalCountry]  ELSE NULL END AS [PhysicalCountry],
