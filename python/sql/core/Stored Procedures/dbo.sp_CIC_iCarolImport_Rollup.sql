...
SELECT 
		...
		CASE WHEN pas.[Phone1Number] IS NOT NULL THEN pas.[Phone1Number] WHEN ISNULL(p.[Phone1IsPrivate], 'No') = 'False' AND p.[Phone1Number]  IS NOT NULL THEN p.[Phone1Number]  ELSE NULL END AS [Phone1Number],
		COALESCE(pas.[Phone1Name], CASE WHEN p.[Phone1IsPrivate] = 'True' THEN NULL ELSE p.[Phone1Name] END) AS [Phone1Name],
		CASE WHEN pas.[Phone1Description] IS NOT NULL THEN pas.[Phone1Description] WHEN ISNULL(p.[Phone1IsPrivate], 'No') = 'False' AND p.[Phone1Description]  IS NOT NULL THEN p.[Phone1Description] ELSE NULL END AS [Phone1Description],
		COALESCE(pas.[Phone1IsPrivate], p.[Phone1IsPrivate]) AS [Phone1IsPrivate],
		CASE WHEN pas.[Phone1Type] IS NOT NULL THEN pas.[Phone1Type] WHEN ISNULL(p.[Phone1IsPrivate], 'No') = 'False' AND p.[Phone1Type]  IS NOT NULL THEN p.[Phone1Type] ELSE NULL END AS [Phone1Type],
		CASE WHEN pas.[Phone2Number] IS NOT NULL THEN pas.[Phone2Number] WHEN ISNULL(p.[Phone2IsPrivate], 'No') = 'False' AND p.[Phone2Number]  IS NOT NULL THEN p.[Phone2Number] ELSE NULL END AS [Phone2Number],
		CASE WHEN pas.[Phone2Name] IS NOT NULL THEN pas.[Phone2Name] WHEN ISNULL(p.[Phone2IsPrivate], 'No') = 'False' AND p.[Phone2Name]  IS NOT NULL THEN p.[Phone2Name] ELSE NULL END AS [Phone2Name],
		CASE WHEN pas.[Phone2Description] IS NOT NULL THEN pas.[Phone2Description] WHEN ISNULL(p.[Phone2IsPrivate], 'No') = 'False' AND p.[Phone2Description]  IS NOT NULL THEN p.[Phone2Description] ELSE NULL END AS [Phone2Description],
		COALESCE(pas.[Phone2IsPrivate], p.[Phone2IsPrivate]) AS [Phone2IsPrivate],
		CASE WHEN pas.[Phone2Type] IS NOT NULL THEN pas.[Phone2Type] WHEN ISNULL(p.[Phone2IsPrivate], 'No') = 'False' AND p.[Phone2Type]  IS NOT NULL THEN p.[Phone2Type] ELSE NULL END AS [Phone2Type],
		CASE WHEN pas.[Phone3Number] IS NOT NULL THEN pas.[Phone3Number] WHEN ISNULL(p.[Phone3IsPrivate], 'No') = 'False' AND p.[Phone3Number]  IS NOT NULL THEN p.[Phone3Number] ELSE NULL END AS [Phone3Number],
		CASE WHEN pas.[Phone3Name] IS NOT NULL THEN pas.[Phone3Name] WHEN ISNULL(p.[Phone3IsPrivate], 'No') = 'False' AND p.[Phone3Name]  IS NOT NULL THEN p.[Phone3Name] ELSE NULL END AS [Phone3Name],
		CASE WHEN pas.[Phone3Description] IS NOT NULL THEN pas.[Phone3Description] WHEN ISNULL(p.[Phone3IsPrivate], 'No') = 'False' AND p.[Phone3Description]  IS NOT NULL THEN p.[Phone3Description] ELSE NULL END AS [Phone3Description],
		COALESCE(pas.[Phone3IsPrivate], p.[Phone3IsPrivate]) AS [Phone3IsPrivate],
		CASE WHEN pas.[Phone3Type] IS NOT NULL THEN pas.[Phone3Type] WHEN ISNULL(p.[Phone3IsPrivate], 'No') = 'False' AND p.[Phone3Type]  IS NOT NULL THEN p.[Phone3Type] ELSE NULL END AS [Phone3Type],
		CASE WHEN pas.[Phone4Number] IS NOT NULL THEN pas.[Phone4Number] WHEN ISNULL(p.[Phone4IsPrivate], 'No') = 'False' AND p.[Phone4Number]  IS NOT NULL THEN p.[Phone4Number] ELSE NULL END AS [Phone4Number],
		CASE WHEN pas.[Phone4Name] IS NOT NULL THEN pas.[Phone4Name] WHEN ISNULL(p.[Phone4IsPrivate], 'No') = 'False' AND p.[Phone4Name]  IS NOT NULL THEN p.[Phone4Name] ELSE NULL END AS [Phone4Name],
		CASE WHEN pas.[Phone4Description] IS NOT NULL THEN pas.[Phone4Description] WHEN ISNULL(p.[Phone4IsPrivate], 'No') = 'False' AND p.[Phone4Description]  IS NOT NULL THEN p.[Phone4Description] ELSE NULL END AS [Phone4Description],
		COALESCE(pas.[Phone4IsPrivate], p.[Phone4IsPrivate]) AS [Phone4IsPrivate],
		CASE WHEN pas.[Phone4Type] IS NOT NULL THEN pas.[Phone4Type] WHEN ISNULL(p.[Phone4IsPrivate], 'No') = 'False' AND p.[Phone4Type]  IS NOT NULL THEN p.[Phone4Type] ELSE NULL END AS [Phone4Type],
		CASE WHEN pas.[Phone5Number] IS NOT NULL THEN pas.[Phone5Number] WHEN ISNULL(p.[Phone5IsPrivate], 'No') = 'False' AND p.[Phone5Number]  IS NOT NULL THEN p.[Phone5Number] ELSE NULL END AS [Phone5Number],
		CASE WHEN pas.[Phone5name] IS NOT NULL THEN pas.[Phone5name] WHEN ISNULL(p.[Phone5IsPrivate], 'No') = 'False' AND p.[Phone5name]  IS NOT NULL THEN p.[Phone5name] ELSE NULL END AS [Phone5name],
		CASE WHEN pas.[Phone5Description] IS NOT NULL THEN pas.[Phone5Description] WHEN ISNULL(p.[Phone5IsPrivate], 'No') = 'False' AND p.[Phone5Description]  IS NOT NULL THEN p.[Phone5Description] ELSE NULL END AS [Phone5Description],
		COALESCE(pas.[Phone5IsPrivate], p.[Phone5IsPrivate]) AS [Phone5IsPrivate],
		CASE WHEN pas.[Phone5Type] IS NOT NULL THEN pas.[Phone5Type] WHEN ISNULL(p.[Phone5IsPrivate], 'No') = 'False' AND p.[Phone5Type]  IS NOT NULL THEN p.[Phone5Type] ELSE NULL END AS [Phone5Type],
		CASE WHEN pas.[PhoneFax] IS NOT NULL THEN pas.[PhoneFax] WHEN ISNULL(p.[PhoneFaxIsPrivate], 'No') = 'False' AND p.[PhoneFax]  IS NOT NULL THEN p.[PhoneFax] ELSE NULL END AS [PhoneFax],
		CASE WHEN pas.[PhoneFaxDescription] IS NOT NULL THEN pas.[PhoneFaxDescription] WHEN ISNULL(p.[PhoneFaxIsPrivate], 'No') = 'False' AND p.[PhoneFaxDescription]  IS NOT NULL THEN p.[PhoneFaxDescription] ELSE NULL END AS [PhoneFaxDescription],
		COALESCE(pas.[PhoneFaxIsPrivate], p.[PhoneFaxIsPrivate]) AS [PhoneFaxIsPrivate],
		CASE WHEN pas.[PhoneTTY] IS NOT NULL THEN pas.[PhoneTTY] WHEN ISNULL(p.[PhoneTTYIsPrivate], 'No') = 'False' AND p.[PhoneTTY]  IS NOT NULL THEN p.[PhoneTTY] ELSE NULL END AS [PhoneTTY],
		CASE WHEN pas.[PhoneTTYDescription] IS NOT NULL THEN pas.[PhoneTTYDescription] WHEN ISNULL(p.[PhoneTTYIsPrivate], 'No') = 'False' AND p.[PhoneTTYDescription]  IS NOT NULL THEN p.[PhoneTTYDescription] ELSE NULL END AS [PhoneTTYDescription],
		COALESCE(pas.[PhoneTTYIsPrivate], p.[PhoneTTYIsPrivate]) AS [PhoneTTYIsPrivate],
		CASE WHEN pas.[PhoneTollFree] IS NOT NULL THEN pas.[PhoneTollFree] WHEN ISNULL(p.[PhoneTollFreeIsPrivate], 'No') = 'False' AND p.[PhoneTollFree]  IS NOT NULL THEN p.[PhoneTollFree] ELSE NULL END AS [PhoneTollFree],
		CASE WHEN pas.[PhoneTollFreeDescription] IS NOT NULL THEN pas.[PhoneTollFreeDescription] WHEN ISNULL(p.[PhoneTollFreeIsPrivate], 'No') = 'False' AND p.[PhoneTollFreeDescription]  IS NOT NULL THEN p.[PhoneTollFreeDescription] ELSE NULL END AS [PhoneTollFreeDescription],
		COALESCE(pas.[PhoneTollFreeIsPrivate], p.[PhoneTollFreeIsPrivate]) AS [PhoneTollFreeIsPrivate],
		CASE WHEN pas.[PhoneNumberHotline] IS NOT NULL THEN pas.[PhoneNumberHotline] WHEN ISNULL(p.[PhoneNumberHotlineIsPrivate], 'No') = 'False' AND p.[PhoneNumberHotline]  IS NOT NULL THEN p.[PhoneNumberHotline] ELSE NULL END AS [PhoneNumberHotline],
		CASE WHEN pas.[PhoneNumberHotlineDescription] IS NOT NULL THEN pas.[PhoneNumberHotlineDescription] WHEN ISNULL(p.[PhoneNumberHotlineIsPrivate], 'No') = 'False' AND p.[PhoneNumberHotlineDescription]  IS NOT NULL THEN p.[PhoneNumberHotlineDescription] ELSE NULL END AS [PhoneNumberHotlineDescription],
		COALESCE(pas.[PhoneNumberHotlineIsPrivate], p.[PhoneNumberHotlineIsPrivate]) AS [PhoneNumberHotlineIsPrivate],
		CASE WHEN pas.[PhoneNumberBusinessLine] IS NOT NULL THEN pas.[PhoneNumberBusinessLine] WHEN ISNULL(p.[PhoneNumberBusinessLineIsPrivate], 'No') = 'False' AND p.[PhoneNumberBusinessLine]  IS NOT NULL THEN p.[PhoneNumberBusinessLine] ELSE NULL END AS [PhoneNumberBusinessLine],
		CASE WHEN pas.[PhoneNumberBusinessLineDescription] IS NOT NULL THEN pas.[PhoneNumberBusinessLineDescription] WHEN ISNULL(p.[PhoneNumberBusinessLineIsPrivate], 'No') = 'False' AND p.[PhoneNumberBusinessLineDescription]  IS NOT NULL THEN p.[PhoneNumberBusinessLineDescription] ELSE NULL END AS [PhoneNumberBusinessLineDescription],
		COALESCE(pas.[PhoneNumberBusinessLineIsPrivate], p.[PhoneNumberBusinessLineIsPrivate]) AS [PhoneNumberBusinessLineIsPrivate],
		CASE WHEN pas.[PhoneNumberOutOfArea] IS NOT NULL THEN pas.[PhoneNumberOutOfArea] WHEN ISNULL(p.[PhoneNumberOutOfAreaIsPrivate], 'No') = 'False' AND p.[PhoneNumberOutOfArea]  IS NOT NULL THEN p.[PhoneNumberOutOfArea] ELSE NULL END AS [PhoneNumberOutOfArea],
		CASE WHEN pas.[PhoneNumberOutOfAreaDescription] IS NOT NULL THEN pas.[PhoneNumberOutOfAreaDescription] WHEN ISNULL(p.[PhoneNumberOutOfAreaIsPrivate], 'No') = 'False' AND p.[PhoneNumberOutOfAreaDescription]  IS NOT NULL THEN p.[PhoneNumberOutOfAreaDescription] ELSE NULL END AS [PhoneNumberOutOfAreaDescription],
		COALESCE(pas.[PhoneNumberOutOfAreaIsPrivate], p.[PhoneNumberOutOfAreaIsPrivate]) AS [PhoneNumberOutOfAreaIsPrivate],
		CASE WHEN pas.[PhoneNumberAfterHours] IS NOT NULL THEN pas.[PhoneNumberAfterHours] WHEN ISNULL(p.[PhoneNumberAfterHoursIsPrivate], 'No') = 'False' AND p.[PhoneNumberAfterHours]  IS NOT NULL THEN p.[PhoneNumberAfterHours] ELSE NULL END AS [PhoneNumberAfterHours],
		CASE WHEN pas.[PhoneNumberAfterHoursDescription] IS NOT NULL THEN pas.[PhoneNumberAfterHoursDescription] WHEN ISNULL(p.[PhoneNumberAfterHoursIsPrivate], 'No') = 'False' AND p.[PhoneNumberAfterHoursDescription]  IS NOT NULL THEN p.[PhoneNumberAfterHoursDescription] ELSE NULL END AS [PhoneNumberAfterHoursDescription],
		COALESCE(pas.[PhoneNumberAfterHoursIsPrivate], p.[PhoneNumberAfterHoursIsPrivate]) AS [PhoneNumberAfterHoursIsPrivate],
