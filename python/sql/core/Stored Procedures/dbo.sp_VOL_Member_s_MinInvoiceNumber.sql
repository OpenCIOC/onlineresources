...
CREATE PROCEDURE [dbo].[sp_VOL_Member_s_MinInvoiceNumber]
	@MemberID int,
	@VMEM_ID int
...
DECLARE @NextInvoiceNum varchar(10)

SELECT @NextInvoiceNum = MAX(InvoiceNumber) + 1
...
SELECT	vm.NUM,
		...
		@NextInvoiceNum AS NextInvoiceNum
	FROM VOL_Member vm
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_Member_s_MinInvoiceNumber] TO [cioc_login_role]
GO
