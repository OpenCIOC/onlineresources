...
CREATE PROCEDURE [dbo].[sp_VOL_OP_Referral_ls_Days]
	@MemberID int,
	@NumDays [int],
...
WHERE rf.MemberID=@MemberID
	AND rf.MODIFIED_DATE >= DATEADD(d,-@NumDays, GETDATE())
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_OP_Referral_ls_Days] TO [cioc_login_role]
GO
