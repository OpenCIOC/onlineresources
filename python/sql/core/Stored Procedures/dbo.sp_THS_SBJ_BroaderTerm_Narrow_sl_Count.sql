...
CREATE PROCEDURE [dbo].[sp_THS_SBJ_BroaderTerm_Narrow_sl_Count]
	@Subj_ID int,
	@ViewType int,
	@NoDeleted bit
...
GO
GRANT EXECUTE ON  [dbo].[sp_THS_SBJ_BroaderTerm_Narrow_sl_Count] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[sp_THS_SBJ_BroaderTerm_Narrow_sl_Count] TO [cioc_login_role]
GO
