...
CREATE PROCEDURE [dbo].[sp_CIC_ImportEntry_Data_lc]
	@EF_ID int,
	@ViewType int
...
IF @Error = 0 BEGIN
	...
	WHERE ied.EF_ID=@EF_ID
		...
		AND (bt.MemberID=@MemberID OR bt.NUM IS NULL)
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_ImportEntry_Data_lc] TO [cioc_login_role]
GO
