...
IF @MemberID IS NOT NULL
	...
	SELECT TOP 1 @NUM=NUM FROM GBL_BaseTable WHERE EXTERNAL_ID=@EXTERNAL_ID AND @NUM IS NULL AND ((@SourceDbCode IS NOT NULL AND SOURCE_DB_CODE=@SourceDbCode) OR (@SourceDbCode IS NULL AND SOURCE_DB_CODE IS NULL))
