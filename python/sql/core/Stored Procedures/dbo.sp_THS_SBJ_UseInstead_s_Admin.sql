...
CREATE PROCEDURE [dbo].[sp_THS_SBJ_UseInstead_s_Admin]
	@Subj_ID int,
	@MemberID int
...
SELECT	sj.Subj_ID,
	...
	INNER JOIN THS_SBJ_UseInstead ui
		ON ui.Subj_ID=@Subj_ID
			AND ui.UsedSubj_ID=sj.Subj_ID
ORDER BY sjn.Name
...
GO
GRANT EXECUTE ON  [dbo].[sp_THS_SBJ_UseInstead_s_Admin] TO [cioc_login_role]
GO
