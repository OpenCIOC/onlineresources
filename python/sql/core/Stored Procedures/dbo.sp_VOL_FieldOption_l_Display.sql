...
CREATE PROCEDURE [dbo].[sp_VOL_FieldOption_l_Display]
	@MemberID [int],
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_FieldOption_l_Display] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[sp_VOL_FieldOption_l_Display] TO [cioc_vol_search_role]
GO
