...
CREATE PROCEDURE [dbo].[sp_CIC_View_UpdateFieldIDs_d_RT]
	@ViewType int,
...
DECLARE	@MemberObjectName nvarchar(100),
		@RecordTypeObjectName nvarchar(60),
		@ViewObjectName nvarchar(60),		
		@ViewFieldObjectName nvarchar(60)
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_View_UpdateFieldIDs_d_RT] TO [cioc_login_role]
GO
