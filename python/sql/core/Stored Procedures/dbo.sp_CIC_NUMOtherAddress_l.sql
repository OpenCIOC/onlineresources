...
SELECT ADDR_ID, CASE
	WHEN TITLE IS NOT NULL OR SITE_CODE IS NOT NULL
		THEN  '[ '
			...
			+ ' ] '
		ELSE ''
	END + dbo.fn_GBL_FullAddress(NUM,NULL,NULL,NULL,NULL,STREET_NUMBER,STREET,STREET_TYPE,STREET_TYPE_AFTER,STREET_DIR,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,LangID,0) AS Display
