...
CREATE PROCEDURE [dbo].[sp_VOL_Agency_l]
	@MemberID [int],
...
GO
GRANT EXECUTE ON  [dbo].[sp_VOL_Agency_l] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[sp_VOL_Agency_l] TO [cioc_vol_search_role]
GO
