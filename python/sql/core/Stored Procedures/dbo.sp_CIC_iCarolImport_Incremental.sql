...
WHEN MATCHED THEN
	UPDATE SET 
		...
		[HasMailingAddress]=CASE WHEN COALESCE(src.MailingAttentionName, src.MailingAddress1, src.MailingAddress2, src.MailingCity, src.MailingStateProvince, src.MailingPostalCode, NULLIF(src.MailingCountry, '-1'), src.MailingCommunity) IS NOT NULL THEN 1 ELSE 0 END,
		...
		[HasPhysicalAddress]=CASE WHEN COALESCE(src.PhysicalAddress1, src.PhysicalAddress2, src.PhysicalCity, src.PhysicalCounty, src.PhysicalStateProvince, src.PhysicalPostalCode, NULLIF(src.PhysicalCountry, '-1'), src.PhysicalCommunity) IS NOT NULL THEN 1 ELSE 0 END,
		...
		[HasSeniorWorker]=CASE WHEN COALESCE(src.SeniorWorkerName, src.SeniorWorkerTitle, src.SeniorWorkerEmailAddress, src.SeniorWorkerPhoneNumber) IS NULL THEN 1 ELSE 0 END,
		...
		[HasMainContact]=CASE WHEN COALESCE(src.MainContactName, src.MainContactTitle, src.MainContactEmailAddress, src.MainContactPhoneNumber, src.MainContactType) IS NULL THEN 1 ELSE 0 END,
