...
CREATE PROCEDURE [dbo].[sp_CIC_Agency_lf]
	@MemberID [int],
...
WHERE a.RecordOwnerCIC=1 AND (a.MemberID=@MemberID OR (@ListForeignAgency=1 AND memf.AgencyID IS NOT NULL))
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_Agency_lf] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[sp_CIC_Agency_lf] TO [cioc_login_role]
GO
