...
CREATE PROCEDURE [dbo].[sp_THS_SBJ_RelatedTerm_sl]
	@Subj_ID int,
	@ViewType int
...
GO
GRANT EXECUTE ON  [dbo].[sp_THS_SBJ_RelatedTerm_sl] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[sp_THS_SBJ_RelatedTerm_sl] TO [cioc_login_role]
GO
