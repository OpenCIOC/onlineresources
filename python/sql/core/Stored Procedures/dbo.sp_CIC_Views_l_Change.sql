...
CREATE PROCEDURE [dbo].[sp_CIC_Views_l_Change]
	@MemberID int,
	@User_ID int,
	@CurrentView int
...
GO
GRANT EXECUTE ON  [dbo].[sp_CIC_Views_l_Change] TO [cioc_login_role]
GO
