...
CREATE FUNCTION [dbo].[fn_CIC_CanCreateEquivalent](
	@NUM varchar(8),
	@User_ID int,
	@ViewType int,
	@LangID smallint,
...
SELECT @returnVal = CASE
		...
		WHEN dbo.fn_CIC_RecordInView(@NUM,@ViewType,@SourceLangID,0,@Today)<>1 THEN 0
...
GRANT EXECUTE ON  [dbo].[fn_CIC_CanCreateEquivalent] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_CIC_CanCreateEquivalent] TO [cioc_login_role]
GO
