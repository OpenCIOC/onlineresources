...
CREATE FUNCTION [dbo].[fn_GBL_VNUMToRecordNote_Web](
	@MemberID int,
...
GRANT EXECUTE ON  [dbo].[fn_GBL_VNUMToRecordNote_Web] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_VNUMToRecordNote_Web] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_VNUMToRecordNote_Web] TO [cioc_vol_search_role]
GO
