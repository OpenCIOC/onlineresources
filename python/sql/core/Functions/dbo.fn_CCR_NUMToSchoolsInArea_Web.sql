...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_CCR_NUMToSchoolsInArea_Web](
	@NUM varchar(8),
	@Notes nvarchar(max),
...
SELECT @returnStr =  COALESCE(@returnStr + @conStr,'') 
		+ cioc_shared.dbo.fn_SHR_CCR_Link_SchoolsInArea(sch.SCH_ID,sch.SchoolName,@HTTPVals,@PathToStart)
...
GO
GRANT EXECUTE ON  [dbo].[fn_CCR_NUMToSchoolsInArea_Web] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_CCR_NUMToSchoolsInArea_Web] TO [cioc_login_role]
GO
