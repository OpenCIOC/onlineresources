...
CREATE FUNCTION [dbo].[fn_CIC_NUMToStatsCache_Public](
	@MemberID int,
	@NUM [varchar](8)
)
...
GO
GRANT EXECUTE ON  [dbo].[fn_CIC_NUMToStatsCache_Public] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_CIC_NUMToStatsCache_Public] TO [cioc_login_role]
GO
