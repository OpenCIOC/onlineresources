...
CREATE FUNCTION [dbo].[fn_GBL_NUMToOrgServices](
	@NUM varchar(8),
	@ViewType int,
	@ShowNotInView bit
)
...
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToOrgServices] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToOrgServices] TO [cioc_login_role]
GO
