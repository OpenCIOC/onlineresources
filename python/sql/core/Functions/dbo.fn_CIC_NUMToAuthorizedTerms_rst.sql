...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_CIC_NUMToAuthorizedTerms_rst](
	@NUM varchar(8),
	@LangID smallint
)
RETURNS @AuthorizedTerms TABLE (
	[Subj_ID] int NULL,
...
GO
GRANT SELECT ON  [dbo].[fn_CIC_NUMToAuthorizedTerms_rst] TO [cioc_cic_search_role]
GRANT SELECT ON  [dbo].[fn_CIC_NUMToAuthorizedTerms_rst] TO [cioc_login_role]
GO
