...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_VOL_FullSource_Web](
	@Pub nvarchar(100),
...
IF @Email IS NOT NULL BEGIN
	SET @returnStr = @returnStr + @conStr + cioc_shared.dbo.fn_SHR_STP_ObjectName('Email') + @colonStr + cioc_shared.dbo.fn_SHR_GBL_Link_Email(@Email)
END
...
GO
GRANT EXECUTE ON  [dbo].[fn_VOL_FullSource_Web] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_VOL_FullSource_Web] TO [cioc_vol_search_role]
GO
