...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_VOL_CanUpdateRecord](
	@VNUM varchar(10),
	@User_ID int,
	@ViewType int,
	@LangID smallint,
...
SELECT @returnVal = CASE
		...
		WHEN dbo.fn_VOL_RecordInView(@VNUM,@ViewType,@LangID,0,@Today)<>1 THEN 0
...
GRANT EXECUTE ON  [dbo].[fn_VOL_CanUpdateRecord] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_VOL_CanUpdateRecord] TO [cioc_vol_search_role]
GO
