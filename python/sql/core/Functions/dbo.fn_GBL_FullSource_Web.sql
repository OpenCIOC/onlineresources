...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_GBL_FullSource_Web](
	@Name nvarchar(100),
	@Title nvarchar(100),
	@Org nvarchar(100),
	@Phone nvarchar(100),
...
GO
GRANT EXECUTE ON  [dbo].[fn_GBL_FullSource_Web] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_FullSource_Web] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_FullSource_Web] TO [cioc_vol_search_role]
GO
