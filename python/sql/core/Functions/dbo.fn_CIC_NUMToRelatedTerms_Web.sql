...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_CIC_NUMToRelatedTerms_Web](
	@MemberID int,
	@NUM varchar(8),
...
GO
GRANT EXECUTE ON  [dbo].[fn_CIC_NUMToRelatedTerms_Web] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_CIC_NUMToRelatedTerms_Web] TO [cioc_login_role]
GO
