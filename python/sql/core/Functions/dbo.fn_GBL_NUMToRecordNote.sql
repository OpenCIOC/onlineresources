...
CREATE FUNCTION [dbo].[fn_GBL_NUMToRecordNote](
...
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToRecordNote] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToRecordNote] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToRecordNote] TO [cioc_vol_search_role]
GO
