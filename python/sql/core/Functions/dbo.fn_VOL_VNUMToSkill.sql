...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[fn_VOL_VNUMToSkill](
	@VNUM varchar(10),
	@Notes nvarchar(max)
)
...
GO
GRANT EXECUTE ON  [dbo].[fn_VOL_VNUMToSkill] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_VOL_VNUMToSkill] TO [cioc_vol_search_role]
GO
