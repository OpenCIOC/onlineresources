...
CREATE FUNCTION [dbo].[fn_VOL_VNUMToSuitability_Web](
	@VNUM varchar(10),
...
SELECT @returnStr =  COALESCE(@returnStr + @conStr,'') 
		+ cioc_shared.dbo.fn_SHR_VOL_Link_Suitability(sb.SB_ID,sbn.Name,@HTTPVals,@PathToStart)
...
GO
GRANT EXECUTE ON  [dbo].[fn_VOL_VNUMToSuitability_Web] TO [cioc_login_role]
GRANT EXECUTE ON  [dbo].[fn_VOL_VNUMToSuitability_Web] TO [cioc_vol_search_role]
GO
