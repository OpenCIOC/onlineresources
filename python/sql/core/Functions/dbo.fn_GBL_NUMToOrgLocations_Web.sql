...
CREATE FUNCTION [dbo].[fn_GBL_NUMToOrgLocations_Web](
	@NUM varchar(8),
	@ViewType int,
	@ShowNotInView bit,
...
IF @returnStr = '' BEGIN
	SET @returnStr = NULL
END ELSE BEGIN
	SET @returnStr = '<ul class="OrgLocationList"><li' + @returnStr + '</li></ul>'
END
...
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToOrgLocations_Web] TO [cioc_cic_search_role]
GRANT EXECUTE ON  [dbo].[fn_GBL_NUMToOrgLocations_Web] TO [cioc_login_role]
GO
