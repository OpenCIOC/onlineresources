...
[OLS_ID] [int] NOT NULL,
[EXTERNAL_ID] [varchar] (max) COLLATE Latin1_General_100_CI_AI NULL,
[QUEUE_FOR_EXPORT] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_QUEUE_FOR_EXPORT] DEFAULT ((0)),
[EXPORT_DATE] [smalldatetime] NULL,
[SKIP_EXPORT_SITE_POSTAL_CODE] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_SKIP_EXPORT_POSTAL] DEFAULT ((0)),
[SKIP_EXPORT_SITE_CITY] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_SKIP_EXPORT_SITE_CITY] DEFAULT ((0)),
[SKIP_EXPORT_MAIL_POSTAL_CODE] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_SKIP_EXPORT_MAIL_POSTAL_CODE] DEFAULT ((0)),
[SKIP_EXPORT_MAIL_CITY] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_SKIP_EXPORT_MAIL_CITY] DEFAULT ((0)),
[POSTAL_CODE_ERROR] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_POSTAL_CODE_ERROR] DEFAULT ((0)),
[CITY_ERROR] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_CITY_ERROR] DEFAULT ((0)),
[OTHER_ERROR] [bit] NOT NULL CONSTRAINT [DF_GBL_BT_OLS_OTHER_ERROR] DEFAULT ((0))
) ON [PRIMARY]
GO
