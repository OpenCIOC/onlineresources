...
[SOURCE_DB_CODE] [varchar] (20) COLLATE Latin1_General_100_CI_AI NULL,
[SOURCE_FROM_ICAROL] [bit] NOT NULL CONSTRAINT [DF_GBL_BaseTable_SOURCE_FROM_ICAROL] DEFAULT ((0))
) ON [PRIMARY]
GO
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_GBL_BaseTable_MemberIDNUMinclROLatLngMapPin] ON [dbo].[GBL_BaseTable] ([MemberID], [NUM]) INCLUDE ([LATITUDE], [LONGITUDE], [MAP_PIN], [RECORD_OWNER], [DISPLAY_ORG_NAME], [DISPLAY_LOCATION_NAME]) ON [PRIMARY]
GO
