...
[Link] [varchar] (255) COLLATE Latin1_General_100_CI_AI NOT NULL,
...
GO
ALTER TABLE [dbo].[GBL_Template_Menu] ADD CONSTRAINT [CK_GBL_Template_Menu_MenuGroup] CHECK (([MenuGroup] IS NULL OR [MenuGroup]>(0) AND [MenuGroup]<(4)))
GO
