...
CREATE UNIQUE NONCLUSTERED INDEX [IX_GBL_BaseTable_Description_LangIDNUMinclNONPUBLICUPDATESCHEDULEDELETIONDATE] ON [dbo].[GBL_BaseTable_Description] ([LangID], [NUM]) INCLUDE ([DELETION_DATE], [NON_PUBLIC], [UPDATE_SCHEDULE]) WITH (FILLFACTOR=80) ON [PRIMARY]
...
GO
CREATE STATISTICS [_dta_stat_1934629935_19_20_16] ON [dbo].[GBL_BaseTable_Description] ([ORG_LEVEL_2], [ORG_LEVEL_3], [DELETION_DATE])
...
UPDATE btd
	SET CMP_SiteAddress = dbo.fn_GBL_FullAddress(bt.NUM,bt.RSN,btd.SITE_BUILDING,btd.SITE_STREET_NUMBER,btd.SITE_STREET,btd.SITE_STREET_TYPE,btd.SITE_STREET_TYPE_AFTER,btd.SITE_STREET_DIR,btd.SITE_SUFFIX,btd.SITE_CITY,btd.SITE_PROVINCE,btd.SITE_COUNTRY,bt.SITE_POSTAL_CODE,NULL,NULL,NULL,bt.LATITUDE,bt.LONGITUDE,btd.LangID,0),
...
GO
CREATE NONCLUSTERED INDEX [IX_GBL_BaseTable_Description_ViewFields] ON [dbo].[GBL_BaseTable_Description] ([NUM]) INCLUDE ([DELETION_DATE], [NON_PUBLIC], [UPDATE_SCHEDULE]) ON [PRIMARY]
GO
