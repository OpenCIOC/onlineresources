...
GO
ALTER TABLE [dbo].[VOL_View_FeedbackField] WITH NOCHECK ADD CONSTRAINT [FK_VOL_View_FeedbackField_VOL_View] FOREIGN KEY ([ViewType]) REFERENCES [dbo].[VOL_View] ([ViewType]) ON DELETE CASCADE
GO
