...
bBlock = Request("submit") = TXT_BLOCK
if bBlock Then
	strAction = TXT_BLOCKED
Else
	strAction = TXT_UNBLOCKED
End If
...
With cmdProfileInfo
	...
	.CommandText = "sp_VOL_Profile_u_Block"
	...
	.Parameters.Append .CreateParameter("@Blocked", adBoolean, adParamInput, 1, bBlock)
...
Else 
	Call handleMessage(TXT_PROFILE_WAS & " " & strAction, "profiles_details.asp", "ProfileID=" & strProfileID, False)
End If
