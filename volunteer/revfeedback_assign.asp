...
<%
If Not user_bCanAssignFeedbackVOL Then
...
With cmdAssignFb
	...
	.CommandText = "dbo.sp_VOL_Feedback_Assign"
...
Select Case cmdAssignFb.Parameters("@RETURN_VALUE").Value
	Case 0
		Call handleMessage(TXT_RECORDS_WERE_SUCCESSFULLY & TXT_ASSIGNED, _
			...
			False)
	Case Else
		Call handleError(TXT_RECORDS_WERE_NOT & TXT_ASSIGNED & TXT_COLON & cmdAssignFb.Parameters("@ErrMsg").Value, _
			"revfeedback.asp", _
			vbNullString)
End Select
%>
