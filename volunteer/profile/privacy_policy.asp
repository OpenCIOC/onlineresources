...
<%
If Not g_bUseVolunteerProfiles Or Nl(g_strVolProfilePrivacyPolicy) Then
	Call goToPageB(ps_strPathToStart & "volunteer/")
End If
Call makePageHeader(TXT_VOL_PROFILE_PRIVACY_POLICY, TXT_VOL_PROFILE_PRIVACY_POLICY, False, True, False, False)
%>
<%=g_strVolProfilePrivacyPolicy%>
