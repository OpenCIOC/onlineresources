...
<html>
<head>
<title><%=TXT_OPP_FINDER%></title>
</head>
<frameset rows="50,*" cols="*" framespacing="0" frameborder="no" border="0">
  <frame src="<%=makeLinkB("oppfind_srch.asp")%>" name="topFrame" scrolling="no" noresize >
  <frame src="<%=makeLinkB("oppfind_results.asp")%>" name="mainFrame">
</frameset>
<noframes><body>
<%=TXT_BROWSER_FRAMES%>
</body></noframes>
