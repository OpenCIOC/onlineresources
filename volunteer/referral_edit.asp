...
Else
	...
	With rsReferral
		If Not .EOF Then
            ...
            strAppQ1 = Nz(.Fields("Question1"),strAppQ1)
            strAppQ2 = Nz(.Fields("Question2"),strAppQ2)
            strAppQ3 = Nz(.Fields("Question3"),strAppQ3)
            strQuestion1Answer = .Fields("Question1Answer")
            strQuestion2Answer = .Fields("Question2Answer")
            strQuestion3Answer = .Fields("Question3Answer")
...
<div class="panel panel-default max-width-lg">
    <div class="panel-heading">
        <h3><%=IIf(bNew,TXT_YOU_ARE_SUBMITTING_REFERRAL_REQUEST,TXT_YOU_ARE_UPDATING_REFERRAL_REQUEST)%></h3>
    </div>
...
<form action="referral_edit2.asp" method="GET" name="EntryForm" id="EntryForm">
    ...
    <div class="panel panel-default max-width-lg">
        <div class="panel-heading">
            <h3><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> <%=TXT_ADMINISTRATION%></h3>
        </div>
        <div class="panel-body no-padding">
            <table class="BasicBorder cell-padding-4 full-width form-table inset-table responsive-table">
                <%If Not bNew Then%>
                ...
                <tr>
                    <td class="field-label-cell">
                        <label for="ReferralDate"><%= TXT_DATE_OF_REQUEST %></label></td>
                ...
                <tr>
                    ...
                    <td class="field-data-cell">
                        <label for="FollowUpFlag_Yes">
                            <input type="radio" name="FollowUpFlag" id="FollowUpFlag_Yes" value="on" <%=IIf(bFollowUpFlag," checked",vbNullString)%>>&nbsp;<%=TXT_YES%></label>
                        <label for="FollowUpFlag_No">
                            <input type="radio" name="FollowUpFlag" id="FollowUpFlag_No" value="" <%=IIf(Not bFollowUpFlag," checked",vbNullString)%>>&nbsp;<%=TXT_NO%></label></td>
                </tr>
                <tr>
                    <td class="field-label-cell">
                        <label for="VolunteerContactDate"><%= TXT_VOLUNTEER_CONTACT %></label></td>
                    <td class="field-data-cell form-horizontal">
                        <p><%= TXT_VOL_LAST_CONTACT%></p>
                ...
                <tr>
                    <td class="field-label-cell">
                        <label for="NotifyOrgDate"><%= TXT_POSITION_CONTACT %></label></td>
                    <td class="field-data-cell form-horizontal">
                        <p><%= TXT_ORG_LAST_CONTACT %></p>
                        <div class="form-group row">
                ...
                <tr>
                    ...
                    <td class="field-data-cell">
                        <label for="SuccessfulPlacement_Unknown">
                            <input type="radio" name="SuccessfulPlacement" id="SuccessfulPlacement_Unknown" value="" <%=IIf(Nl(bSuccessfulPlacement)," checked",vbNullString)%>><%=TXT_UNKNOWN%></label>
                        <label for="SuccessfulPlacement_Yes">
                            <input type="radio" name="SuccessfulPlacement" id="SuccessfulPlacement_Yes" value="<%=SQL_TRUE%>" <%=IIf(bSuccessfulPlacement," checked",vbNullString)%>><%=TXT_YES%></label>
                        <label for="SuccessfulPlacement_No">
                            <input type="radio" name="SuccessfulPlacement" id="SuccessfulPlacement_No" value="<%=SQL_FALSE%>" <%=IIf(Not bSuccessfulPlacement," checked",vbNullString)%>><%=TXT_NO%></label>
                    </td>
                </tr>
                <%
...
End If
                ...
                <tr>
                    <td class="field-label-cell">
                        <label for="OutcomeNotes"><%= TXT_OUTCOME_NOTES %></label></td>
                    <td class="field-data-cell">
                        <span class="SmallNote"><%=TXT_INST_MAX_4000%></span>
                        <textarea class="form-control" name="OutcomeNotes" id="OutcomeNotes" rows="<%=getTextAreaRows(intNotesLen,TEXTAREA_ROWS_XLONG)%>" maxlength="4000"><%=strOutcomeNotes%></textarea></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="panel panel-default max-width-lg">
        <div class="panel-heading">
            <h3><span class="glyphicon glyphicon-user" aria-hidden="true"></span> <%=TXT_ABOUT_VOLUNTEER%></h3>
        </div>
        <div class="panel-body no-padding">
            <table class="BasicBorder cell-padding-4 full-width form-table inset-table responsive-table">
                <tr>
                ...
                <tr>
                    <td class="field-label-cell">
                        <label for="VolunteerName"><%=TXT_NAME%></label> <span class="Alert" title="<%=TXT_REQUIRED%>"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></span></td>
                    <td class="field-data-cell">
                        <input type="text" class="form-control" name="VolunteerName" id="VolunteerName" size="<%=TEXT_SIZE%>" maxlength="100" value=<%=AttrQs(strVolunteerName)%>></td>
                </tr>
                <tr>
                    <td class="field-label-cell">
                        <label for="VolunteerEmail"><%=TXT_EMAIL%></label> <span class="Alert" title="<%=TXT_REQUIRED%>"><span class="glyphicon glyphicon-star" aria-hidden="true"></span></span></td>
                    <td class="field-data-cell">
                        <input type="text" class="form-control" name="VolunteerEmail" id="VolunteerEmail" size="<%=TEXT_SIZE%>" maxlength="100" value=<%=AttrQs(strVolunteerEmail)%>></td>
                </tr>
                <tr>
                    <td class="field-label-cell">
                        <label for="VolunteerPhone"><%=TXT_PHONE%></label></td>
                    <td class="field-data-cell">
                        <input type="text" class="form-control" name="VolunteerPhone" id="VolunteerPhone" size="<%=TEXT_SIZE%>" maxlength="100" value=<%=AttrQs(strVolunteerPhone)%>></td>
                </tr>
                <tr>
                    ...
                    <td class="field-data-cell form-horizontal">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="VolunteerAddress" id="VolunteerAddress" maxlength="100" value=<%=AttrQs(strVolunteerAddress)%>></div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="VolunteerCity" id="VolunteerCity" maxlength="100" value=<%=AttrQs(strVolunteerCity)%>></div>
                        </div>
                        <div class="form-group row form-inline">
                            <label class="control-label col-sm-3" for="VolunteerPostalCode"><%=TXT_POSTAL_CODE%></label>
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="VolunteerPostalCode" id="VolunteerPostalCode" size="10" maxlength="10" value=<%=AttrQs(strVolunteerPostalCode)%>></div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="field-data-cell">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="Question1Answer" id="Question1Answer" class="form-control" rows="<%=getTextAreaRows(Len(strQuestion1Answer),TEXTAREA_ROWS_XLONG)%>" maxlength="4000"><%=Server.HTMLEncode(strQuestion1Answer)%></textarea>
                        </div>
                        <%End If%>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="Question2Answer" id="Question2Answer" class="form-control" rows="<%=getTextAreaRows(Len(strQuestion2Answer),TEXTAREA_ROWS_XLONG)%>" maxlength="4000"><%=Server.HTMLEncode(strQuestion2Answer)%></textarea>
                        </div>
                        <%End If%>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="Question3Answer" id="Question3Answer" class="form-control" rows="<%=getTextAreaRows(Len(strQuestion3Answer),TEXTAREA_ROWS_XLONG)%>" maxlength="4000"><%=Server.HTMLEncode(strQuestion3Answer)%></textarea>
                        </div>
                        <%End If%>
                    </td>
                </tr>
...
End If
                ...
                <tr>
                    ...
                    <td class="field-data-cell">
                        <span class="SmallNote"><%=TXT_INST_MAX_4000%></span>
                        <textarea class="form-control" name="VolunteerNotes" id="VolunteerNotes" rows="<%=getTextAreaRows(intNotesLen,TEXTAREA_ROWS_XLONG)%>" maxlength="4000"><%=strVolunteerNotes%></textarea></td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <p>
        ...
        <label for="NotifyAgency_N"><input type="radio" name="NotifyAgency" id="NotifyAgency_N" value="N"><%=TXT_NO%></label>
        <label for="NotifyAgency_Y"><input type="radio" name="NotifyAgency" id="NotifyAgency_Y" value="Y" checked><%=TXT_YES%></label>
    </p>
    <p>
    ...
    <p>
        ...
        <%If Not bNew Then%><input class="btn btn-default" type="submit" name="Submit" value="<%=TXT_DELETE%>"><%End If%>
        <input class="btn btn-default" type="RESET" value="<%=TXT_RESET_FORM%>"></p>
</form>
