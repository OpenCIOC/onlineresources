...
%>
<form action="orgfind_results.asp" target="mainFrame" method="post">
<%=g_strCacheFormVals%>
<table class="BasicBorder cell-padding-2">
	<tr>
		<td class="FieldLabelLeft"><%=TXT_SEARCH_IN_NAME%></td>
		<td><input name="OrgSrch" TYPE="text" size="30" maxlength="150">
			<input type="submit" name="Submit" value="<%=TXT_SEARCH%>"></td>
	</tr>
</table>
</form>
<%
