...
' =========================================================================================
'
' Purpose:		Associate current user with the client tracker.
'
'
%>
...
Call set_launch_values(Trim(Request("ctid")), Trim(Request("login")), Trim(Request("key")))

Call goToPage(ps_strPathToStart, vbNullString, vbNullString)
%>
