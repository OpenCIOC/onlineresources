...
If Err.Number <> 0 Or cmdOrgList.ActiveConnection.Errors.Count > 0 Then
	With cmdOrgList
			...
			If Nl(Request("Limit")) Then
				Call sendEmail(True, "qw4afPcItA5KJ18NH4nV@cioc.ca", "qw4afPcItA5KJ18NH4nV@cioc.ca", vbNullString, "CIC Search SQL Error", strErrorDetails & strSQL)
			End If
	End With
	Err.Clear
...
<% End If %>
<table class="BasicBorder cell-padding-3 HideListUI HideMapColumn <% If Not g_bPrintMode Then %>ResponsiveResults<% End If %>" id="results_table">
<thead>
