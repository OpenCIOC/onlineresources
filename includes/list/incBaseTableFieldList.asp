...
<option value="btd.MAIL_LINE_1">MAIL_LINE_1</option>
<option value="btd.MAIL_LINE_2">MAIL_LINE_2</option>
...
<option value="btd.SITE_LINE_1">SITE_LINE_1</option>
<option value="btd.SITE_LINE_2">SITE_LINE_2</option>
