...
<html>
<head>
<title><%=TXT_ORG_FINDER%></title>
</head>
<frameset rows="50,*" cols="*" framespacing="0" frameborder="no" border="0">
	<frame src="<%=makeLinkB("orgfind_srch.asp")%>" name="topFrame" scrolling="no" noresize >
	<frame src="<%=makeLinkB("orgfind_results.asp")%>" name="mainFrame">
</frameset>
<noframes>
	<body>
	<%=TXT_BROWSER_FRAMES%>
