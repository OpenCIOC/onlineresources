...
Sub setTxtVOLProfile()
	Select Case g_objCurrentLang.Culture
		Case CULTURE_FRENCH_CANADIAN
			...
			TXT_INST_ADD = "Utiliser le formulaire ci-dessous pour ajouter un nouvel ensemble de communautés."
		...
		Case Else
			...
			TXT_INST_ADD = "Use the form below to add a new community set."
