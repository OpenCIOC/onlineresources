...
Sub setTxtSearchBasicVOL()
	Select Case g_objCurrentLang.Culture
		...
		Case Else
			...
			TXT_INST_OSSD_COMPONENT = "Only show opportunities designated as suitable for the OSSD volunteer component."
			...
			TXT_OSSD_COMPONENT_LONG_FORM  = "Ontario Secondary School Diploma Component"
			TXT_RECORDS = "records."
