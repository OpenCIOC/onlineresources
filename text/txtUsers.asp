...
Sub setTxtUsers()
	Select Case g_objCurrentLang.Culture
		...
		Case CULTURE_FRENCH_CANADIAN
			...
			TXT_CAN_UPDATE_VACANCY = "Peut mettre à jour les informations de vacance"
			...
			TXT_CANT_LOGIN_NON_SECURE_DOMAIN = "Connexion non autorisée à partir d'un nom de domaine non sécurisée"
			...
			TXT_SECURE_DOMAIN_LIST = "Veuillez choisir un domaine sécurisé dans la liste ci-dessous pour vous connecter :"
