...
Dim	TXT_CHANGE_EXTRA_FIELD_FAILED, _
	TXT_CHANGE_FIELD_HELP_FAILED, _
	TXT_CHANGE_FIELD_LENGTH, _
	TXT_CHANGE_FIELD_LENGTH_FAILED, _
	TXT_CREATE_EDIT_EXTRA_FIELDS, _
	TXT_DISPLAY, _
	TXT_FIELD_LENGTH, _
	TXT_FULL_TEXT_INDEX, _
	TXT_GLOBAL_HELP, _
	TXT_INST_FIELD_HELP, _
	...
	TXT_NO_YEAR, _
	TXT_REQUIRED, _
	TXT_RETURN_TO_FIELD_HELP, _
	TXT_SHOW_FIELD_HELP, _
...
Sub setTxtField()
	Select Case g_objCurrentLang.Culture
		Case CULTURE_ENGLISH_CANADIAN
			...
			TXT_CHANGE_FIELD_HELP_FAILED = "Change Field Help Failed"
			TXT_CHANGE_FIELD_LENGTH = "Change Field Length"
			TXT_CHANGE_FIELD_LENGTH_FAILED = "Change Field Length Failed"
			...
			TXT_INST_FIELD_HELP = "Field Help cannot exceed 8000 characters"
			...
			TXT_NO_YEAR = "No Year"
			TXT_RETURN_TO_FIELD_HELP = "Return to Field Help"
			TXT_SHOW_FIELD_HELP = "Show Field Help"
		...
		Case CULTURE_FRENCH_CANADIAN
			...
			TXT_CHANGE_FIELD_HELP_FAILED = "La modification de l'aide sur le champ a échoué"
			TXT_CHANGE_FIELD_LENGTH = "Modifier la longueur du champ"
			TXT_CHANGE_FIELD_LENGTH_FAILED = "La modification de la longueur du champ a échoué"
			...
			TXT_INST_FIELD_HELP = "L'aide sur les champs ne peut pas dépasser 8 000 caractères"
			...
			TXT_RETURN_TO_FIELD_HELP = "Retourner à l'aide sur les champs"
			TXT_SHOW_FIELD_HELP = "Afficher l'aide des champs"
