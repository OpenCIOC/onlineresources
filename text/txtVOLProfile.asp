...
Sub setTxtVOLProfile()
	Select Case g_objCurrentLang.Culture
		Case CULTURE_FRENCH_CANADIAN
			...
			TXT_APPLICATION_DATE = "Date de la candidature"
			...
			TXT_LINK_EXPIRE_NOTICE = "Ce lien expirera dès que vous aurez cliqué dessus, ou dans deux semaines, selon la première éventualité."
			...
			TXT_THE_VOLUNTEER_CENTRE = "TR_FR -- The Volunteer Centre"
		...
		Case Else
			...
			TXT_APPLICATION_DATE = "Application Date"
			...
			TXT_LINK_EXPIRE_NOTICE = "The link will expire after you click on it, or in two weeks, whichever comes first."
