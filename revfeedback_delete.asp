...
If Not user_bCanDeleteRecordCIC Then
...
If bConfirmed Then
	Call deleteFeedback(intRevFBID,IIf(bPub,FB_PUB,FB_REC))
Else
%>
...
<%
	Call printFeedbackInfo(intRevFBID,Null,IIf(bPub,FB_PUB,FB_REC))
%>
<hr>
