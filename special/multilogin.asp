...
<table class="BasicBorder cell-padding-3">
	...
	<tr>
		...
		<%
'		<tr><td>
'			<input name="CascadeLogin" class="CascadeLogin" type="checkbox" value="http://localhost:81/cioc" checked data-statusui="localhost">&nbsp;LocalHost
'		</td><td>
'			<span class="LoginStatusUI NotVisible" id="localhost_loading">Loading...</span>
'			<span class="LoginStatusUI NotVisible" id="localhost_success">Success</span>
'			<span class="LoginStatusUI NotVisible" id="localhost_failure">Failure</span>
'		</td></tr>
'		<tr><td>
'			<input name="CascadeLogin" class="CascadeLogin" type="checkbox" value="http://plone.cioc.ca/cioc" checked data-statusui="booger">&nbsp;Booger
'		</td><td>
'			<span class="LoginStatusUI NotVisible" id="booger_loading">Loading...</span>
'			<span class="LoginStatusUI NotVisible" id="booger_success">Success</span>
'			<span class="LoginStatusUI NotVisible" id="booger_failure">Failure</span>
'		</td></tr>
'		<tr><td>
'			<input name="CascadeLogin" class="CascadeLogin" type="checkbox" value="http://fizban.thatsmymeatball.com/cioc" checked data-statusui="fizban">&nbsp;Fizban
'		</td><td>
'			<span class="LoginStatusUI NotVisible" id="fizban_loading">Loading...</span>
'			<span class="LoginStatusUI NotVisible" id="fizban_success">Success</span>
'			<span class="LoginStatusUI NotVisible" id="fizban_failure">Failure</span>
'		</td></tr>
%>
		<tr>
			<td>
