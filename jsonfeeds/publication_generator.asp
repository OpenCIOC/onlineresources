...
Else
	...
	With cmdDstFinder
		...
		.CommandText = "dbo.sp_CIC_Publication_l_Finder"
	...
	With rsDstFinder
		...
		While Not .EOF
			Response.Write(strJSONCon & "{""chkid"":" & JSONQs(.Fields("PB_ID"), True) & _ 
					",""value"":" & JSONQs(.Fields("PubCode") & _
						StringIf(Not Nl(.Fields("Name")), " - " & .Fields("Name")) & _
						StringIf(.Fields("NonPublic"), " *"), True) & _
					"}")
			strJSONCon = ","
			.MoveNext
		Wend
