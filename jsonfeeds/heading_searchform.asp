...
%>
{ 'fail': true, 'errinfo': <%=JSONQs(TXT_INVALID_ID & Server.HTMLEncode(intPBID), True)%> }
<%
Else
'No errors. Return inrequest to calling page.
Call getGeneralHeadingOptionList(intPBID)
%>
{ "fail": false, "innerHTML": <%=JSONQs(strGeneralHeadingUI, True)%> }
<%
End If
End Sub
