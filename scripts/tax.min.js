...
n){n.dpDiv.addClass("NoYearDatePicker")},onClose:function(h,n){n.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});e.dateFormat=b;q.datepicker(a.extend({},a.datepicker.regional[r],e)).prop("autocomplete","off")},t=function(q){a.getScript("https://ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+q+".min.js",function(){k[q]=!0;a.each(c[q],function(){p.call(this)});delete c[q]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var q=
