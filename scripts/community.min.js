...
r){r.dpDiv.addClass("NoYearDatePicker")},onClose:function(m,r){r.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});h.dateFormat=g;n.datepicker(b.extend({},b.datepicker.regional[k],h)).prop("autocomplete","off")},p=function(n){b.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+b.ui.version+"/i18n/jquery.ui.datepicker-"+n+".min.js",function(){d[n]=!0;b.each(a[n],function(){l.call(this)});delete a[n]})};b.datepicker.regional["en-CA"]=b.extend({},b.datepicker.regional[""]);b.fn.extend({autodatepicker:function(){return this.each(function(){var n=
