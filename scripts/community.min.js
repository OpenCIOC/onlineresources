...
"2"==c?(a.find(".repeat-every-ui, .repeat-day-of-month-ui, .recurs-month-label").show(),a.find(".repeat-week-of-month-ui, .repeats-on-ui, .recurs-week-label").hide()):(a.find(".repeat-every-ui, .repeat-week-of-month-ui, .repeats-on-ui, .recurs-month-label").show(),a.find(".repeat-day-of-month-ui, .recurs-week-label").hide())};b("#ScheduleEditArea").on("change",".recur-type-selector",c).find(".recur-type-selector").each(c)}})();
