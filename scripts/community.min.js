...
"2"==a?(b.find(".repeat-every-ui, .repeat-day-of-month-ui, .recurs-month-label").show(),b.find(".repeat-week-of-month-ui, .repeats-on-ui, .recurs-week-label").hide()):(b.find(".repeat-week-of-month-ui, .repeats-on-ui, .recurs-month-label").show(),b.find(".repeat-every-ui, .repeat-day-of-month-ui, .recurs-week-label").hide())};c("#ScheduleEditArea").on("change",".recur-type-selector",d).on("click",".schedule-ui-accept-feedback",function(b){var a=c(this);b=a.parents(".EntryFormItemBox");var a=a.data("schedule"),
f=b.find(".recur-type-selector");restore_form_values(b,a);d.call(f[0]);return!1}).find(".recur-type-selector").each(d)}})();
