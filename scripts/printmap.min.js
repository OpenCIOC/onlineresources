...
ClusterIcon.prototype.onAdd=function(){var a=this,c,d;this.div_=document.createElement("div");this.div_.className=this.className_;this.visible_&&this.show();this.getPanes().overlayMouseTarget.appendChild(this.div_);google.maps.event.addListener(this.getMap(),"bounds_changed",function(){d=c});google.maps.event.addDomListener(this.div_,"mousedown",function(){c=!0;d=!1});google.maps.event.addDomListener(this.div_,"click",function(m){c=!1;if(!d){var k=a.cluster_.getMarkerClusterer();google.maps.event.trigger(k,
"click",a.cluster_);google.maps.event.trigger(k,"clusterclick",a.cluster_);if(k.getZoomOnClick()){var u=k.getMaxZoom();var F=a.cluster_.getBounds();k.getMap().fitBounds(F);setTimeout(function(){k.getMap().fitBounds(F);null!==u&&k.getMap().getZoom()>u&&k.getMap().setZoom(u+1)},100)}m.cancelBubble=!0;m.stopPropagation&&m.stopPropagation()}});google.maps.event.addDomListener(this.div_,"mouseover",function(){var m=a.cluster_.getMarkerClusterer();google.maps.event.trigger(m,"mouseover",a.cluster_)});google.maps.event.addDomListener(this.div_,
"mouseout",function(){var m=a.cluster_.getMarkerClusterer();google.maps.event.trigger(m,"mouseout",a.cluster_)})};ClusterIcon.prototype.onRemove=function(){this.div_&&this.div_.parentNode&&(this.hide(),google.maps.event.clearInstanceListeners(this.div_),this.div_.parentNode.removeChild(this.div_),this.div_=null)};ClusterIcon.prototype.draw=function(){if(this.visible_){var a=this.getPosFromLatLng_(this.center_);this.div_.style.top=a.y+"px";this.div_.style.left=a.x+"px"}};
