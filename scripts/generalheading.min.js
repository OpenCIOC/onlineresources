...
h){h.dpDiv.addClass("NoYearDatePicker")},onClose:function(g,h){h.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});l.dateFormat=f;r.datepicker(a.extend({},a.datepicker.regional[n],l)).prop("autocomplete","off")},t=function(r){a.getScript("https://ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+r+".min.js",function(){k[r]=!0;a.each(b[r],function(){p.call(this)});delete b[r]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var r=
