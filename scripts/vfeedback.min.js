...
[];onbeforerestorevalues_fns=[];n(window).on("beforeunload",function(){var l={form_values:get_form_values(c)};n.each(onbeforeunload_fns,function(f,a){a(l)});document.getElementById("cache_form_values").value=JSON.stringify(l)});window.cache_register_onbeforeunload=function(l){onbeforeunload_fns.push(l)};window.cache_register_onbeforerestorevalues=function(l){onbeforerestorevalues_fns.push(l)};window.restore_cached_state=function(){var l=document.getElementById("cache_form_values");if(l&&l.value){var f=
JSON.parse(l.value);n.each(onbeforerestorevalues_fns,function(a,b){b(f)});restore_form_values(c,f.form_values)}}}})();
