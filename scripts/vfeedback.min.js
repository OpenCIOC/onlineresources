...
x){x.dpDiv.addClass("NoYearDatePicker")},onClose:function(w,x){x.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});r.dateFormat=h;g.datepicker(c.extend({},c.datepicker.regional[p],r)).prop("autocomplete","off")},d=function(g){c.getScript("https://ajax.googleapis.com/ajax/libs/jqueryui/"+c.ui.version+"/i18n/jquery.ui.datepicker-"+g+".min.js",function(){l[g]=!0;c.each(f[g],function(){b.call(this)});delete f[g]})};c.datepicker.regional["en-CA"]=c.extend({},c.datepicker.regional[""]);c.fn.extend({autodatepicker:function(){return this.each(function(){var g=
