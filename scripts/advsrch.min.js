...
b(a.currentTarget).data("id");b.ajax({success:l(a),dataType:"json",error:function(){alert("Error")},data:{ID:a,RemoveItem:c.domain},type:"POST",url:c.current_list_url})},h=function(a){b.ajax({success:l(),dataType:"json",error:function(){alert("Error")},data:{ID:"all",RemoveItem:c.domain},type:"POST",url:c.current_list_url})},m={CIC:function(a){return/^[A-Za-z]{3}[0-9]{4,5}$/.test(a)},VOL:function(a){return/^[1-9][0-9]*$/.test(a)}},s=function(d){if(d.fail)z();else if(d.inrequest){var g=b.grep(d.ids,
m[c.domain]);e(g);a(g.length);(d=d.previous_ids)&&b.each(d,function(a,c){b("#ct_added_to_previous_request_"+c).show()});b(".ListUI img").prop("src",function(a,b){return b.replace("list","referral")});b("#list_header_text").hide();b("#ct_header_text").show();c.current_list_url=c.ct_update_url;u()}else z()},z=function(){var d=function(){c.list_view_mode||e(c.already_added||[]);c.current_list_url=c.list_view_mode&&"ct"===c.list_view_mode?c.ct_update_url:c.list_update_url;a((c.already_added||[]).length);
u()};c.list_view_mode||c.has_session?d():b.ajax({dataType:"json",error:null,url:c.list_update_url,data:{SessionTest:"on"},type:"POST",success:function(a){a.has_session&&d()}})},u=function(){b(".HideListUI").delegate(".add_to_list","click",g).delegate(".remove_from_list","click",f).removeClass("HideListUI");b("#remove_all_from_list").click(h);b.browser.msie&&"8.0">b.browser.msie&&b(".ListUI").removeClass("FixIE")};window.init_list_adder=function(a){c=a;c.myListLink=b("#myListLink").parent(":hidden").add("#myListLink");
a.in_request?b.ajax({success:s,dataType:"json",error:null,type:"POST",url:a.in_request}):z()}})();this.JSON||(this.JSON={});
(function(){function b(a){return 10>a?"0"+a:a}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=f[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function a(b,d){var e,f,v,x,C=g,p,n=d[b];n&&"object"===typeof n&&"function"===typeof n.toJSON&&(n=n.toJSON(b));"function"===typeof h&&(n=h.call(d,b,n));switch(typeof n){case "string":return c(n);case "number":return isFinite(n)?String(n):"null";case "boolean":case "null":return String(n);
case "object":if(!n)return"null";g+=l;p=[];if("[object Array]"===Object.prototype.toString.apply(n)){x=n.length;for(e=0;e<x;e+=1)p[e]=a(e,n)||"null";v=0===p.length?"[]":g?"[\n"+g+p.join(",\n"+g)+"\n"+C+"]":"["+p.join(",")+"]";g=C;return v}if(h&&"object"===typeof h)for(x=h.length,e=0;e<x;e+=1)f=h[e],"string"===typeof f&&(v=a(f,n))&&p.push(c(f)+(g?": ":":")+v);else for(f in n)Object.hasOwnProperty.call(n,f)&&(v=a(f,n))&&p.push(c(f)+(g?": ":":")+v);v=0===p.length?"{}":g?"{\n"+g+p.join(",\n"+g)+"\n"+
C+"}":"{"+p.join(",")+"}";g=C;return v}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(a){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+b(this.getUTCMonth()+1)+"-"+b(this.getUTCDate())+"T"+b(this.getUTCHours())+":"+b(this.getUTCMinutes())+":"+b(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var e=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
(function(){var b=jQuery;window.init_pubs_dropdown=function(a){var c=b("#GHPBID");if(0!==c.length){var g={},l={},f=null,h=null,m=b("#general_heading_search_selection"),s=b("#publication_search_selection"),z=c[0],u=function(){h?(b("#GHID").parent().html('<select id="GHID" name="GHID" multiple>'+h+"</select>"),b("#GHIDx").parent().html('<select id="GHIDx" name="GHIDx" multiple>'+h+"</select>")):(b("GHID").empty(),b("GHIDx").empty())};c.change(function(c){var d=c.target;""===d.value?(m.addClass("NotVisible"),
s.removeClass("NotVisible"),restore_form_values(s,g),l=get_form_values(m),b("#GHID").empty(),b("#GHIDx").empty()):(m.removeClass("NotVisible"),s.addClass("NotVisible"),g=get_form_values(g),f===d.value?(u(),null!==h&&restore_form_values(m,l)):b.getJSON(a,{PBID:d.value},function(a){(a=a.innerHTML)?(f=d.value,h=a,u()):(h="",b("#GHID").empty(),b("#GHIDx").empty())}))});cache_register_onbeforeunload(function(a){a.pubsearch={last_gh_ui:h,pb_selection_state:g,gh_selection_state:l,last_non_pub_selection:f,
pubs_value:z.value}});cache_register_onbeforerestorevalues(function(a){if(a=a.pubsearch)h=a.last_gh_ui,f=a.last_non_pub_selection,g=a.pb_selection_state,l=a.gh_selection_state,a.pubs_value&&(m.removeClass("NotVisible"),s.addClass("NotVisible"),u())})}};var c,a=function(a,d,g){var l=b("#Chk"+d).remove().html();0===g[0].options.length&&b("#CheckListSourceContainer").addClass("NotVisible");return b.getJSON(a,{ChkType:d}).done(function(a){var d=a.innerHTML;if(d)return c.append(b("<p>").html('<div class="FieldLabelLeftClr">'+
...
a.cultures["default"].calendar=a.cultures["default"].calendars.standard;a.cultures.en=a.cultures["default"];a.cultureSelector="en";e=/^0x[a-f0-9]+$/i;d=/^[+\-]?infinity$/i;g=/^[+\-]?\d*\.?\d*(e[+\-]?\d+)?$/;l=/^\s+|\s+$/g;f=function(a,b){if(a.indexOf)return a.indexOf(b);for(var c=0,d=a.length;c<d;c++)if(a[c]===b)return c;return-1};h=function(a,b){return a.substr(a.length-b.length)===b};m=function(){var a,b,d,t,g,e=arguments[0]||{},f=1,k=arguments.length,G=!1;"boolean"===typeof e&&(G=e,e=arguments[1]||
{},f=2);for("object"===typeof e||z(e)||(e={});f<k;f++)if(null!=(a=arguments[f]))for(b in a)d=e[b],t=a[b],e!==t&&(G&&t&&(u(t)||(g=s(t)))?(g?(g=!1,d=d&&s(d)?d:[]):d=d&&u(d)?d:{},e[b]=m(G,d,t)):t!==c&&(e[b]=t));return e};s=Array.isArray||function(a){return"[object Array]"===Object.prototype.toString.call(a)};z=function(a){return"[object Function]"===Object.prototype.toString.call(a)};u=function(a){return"[object Object]"===Object.prototype.toString.call(a)};v=function(a,b){return 0===a.indexOf(b)};x=
function(a){return(a+"").replace(l,"")};C=function(a){return isNaN(a)?NaN:Math[0>a?"ceil":"floor"](a)};p=function(a,b,c){var d;for(d=a.length;d<b;d+=1)a=c?"0"+a:a+"0";return a};n=function(a,b){for(var c=0,d=!1,g=0,e=a.length;g<e;g++){var f=a.charAt(g);switch(f){case "'":d?b.push("'"):c++;d=!1;break;case "\\":d&&b.push("\\");d=!d;break;default:b.push(f),d=!1}}return c};I=function(a,b){b=b||"F";var c;c=a.patterns;var d=b.length;if(1===d){c=c[b];if(!c)throw"Invalid date format string '"+b+"'.";b=c}else 2===
d&&"%"===b.charAt(0)&&(b=b.charAt(1));return b};J=function(a,b,c){function d(a,b){var c;c=a+"";return 1<b&&c.length<b?(c=l[b-2]+c,c.substr(c.length-b,b)):c}function g(){if(m||p)return m;m=s.test(b);p=!0;return m}function e(a,b){if(L)return L[b];switch(b){case 0:return a.getFullYear();case 1:return a.getMonth();case 2:return a.getDate();default:throw"Invalid part value "+b;}}var f=c.calendar,k=f.convert;if(!b||!b.length||"i"===b){if(c&&c.name.length)if(k)c=J(a,f.patterns.F,c);else{c=new Date(a.getTime());
var G=B(a,f.eras);c.setFullYear(F(a,f,G));c=c.toLocaleString()}else c=a.toString();return c}var G=f.eras,h="s"===b;b=I(f,b);c=[];var r,l=["0","00","000"],m,p,s=/([^d]|^)(d|dd)([^d]|$)/g,v=0,P=q(),L;for(!h&&k&&(L=k.fromGregorian(a));;){r=P.lastIndex;k=P.exec(b);r=b.slice(r,k?k.index:b.length);v+=n(r,c);if(!k)break;if(v%2)c.push(k[0]);else switch(r=k[0],k=r.length,r){case "ddd":case "dddd":c.push((3===k?f.days.namesAbbr:f.days.names)[a.getDay()]);break;case "d":case "dd":m=!0;c.push(d(e(a,2),k));break;
case "MMM":case "MMMM":r=e(a,1);c.push(f.monthsGenitive&&g()?f.monthsGenitive[3===k?"namesAbbr":"names"][r]:f.months[3===k?"namesAbbr":"names"][r]);break;case "M":case "MM":c.push(d(e(a,1)+1,k));break;case "y":case "yy":case "yyyy":r=L?L[0]:F(a,f,B(a,G),h);4>k&&(r%=100);c.push(d(r,k));break;case "h":case "hh":r=a.getHours()%12;0===r&&(r=12);c.push(d(r,k));break;case "H":case "HH":c.push(d(a.getHours(),k));break;case "m":case "mm":c.push(d(a.getMinutes(),k));break;case "s":case "ss":c.push(d(a.getSeconds(),
k));break;case "t":case "tt":r=12>a.getHours()?f.AM?f.AM[0]:" ":f.PM?f.PM[0]:" ";c.push(1===k?r.charAt(0):r);break;case "f":case "ff":case "fff":c.push(d(a.getMilliseconds(),3).substr(0,k));break;case "z":case "zz":r=a.getTimezoneOffset()/60;c.push((0>=r?"+":"-")+d(Math.floor(Math.abs(r)),k));break;case "zzz":r=a.getTimezoneOffset()/60;c.push((0>=r?"+":"-")+d(Math.floor(Math.abs(r)),2)+":"+d(Math.abs(a.getTimezoneOffset()%60),2));break;case "g":case "gg":f.eras&&c.push(f.eras[B(a,G)].name);break;
case "/":c.push(f["/"]);break;default:throw"Invalid date format pattern '"+r+"'.";}}return c.join("")};(function(){var a;a=function(a,b,c){var d=c.groupSizes,A=d[0],g=1,k=Math.pow(10,b),k=Math.round(a*k)/k;isFinite(k)||(k=a);a=k+"";var k="",k=a.split(/e/i),e=1<k.length?parseInt(k[1],10):0;a=k[0];k=a.split(".");a=k[0];k=1<k.length?k[1]:"";0<e?(k=p(k,e,!1),a+=k.slice(0,e),k=k.substr(e)):0>e&&(e=-e,a=p(a,e+1,!0),k=a.slice(-e,a.length)+k,a=a.slice(0,-e));k=0<b?c["."]+(k.length>b?k.slice(0,b):p(k,b)):
"";b=a.length-1;c=c[","];for(e="";0<=b;){if(0===A||A>b)return a.slice(0,b+1)+(e.length?c+e+k:k);e=a.slice(b-A+1,b+1)+(e.length?c+e:"");b-=A;g<d.length&&(A=d[g],g++)}return a.slice(0,b+1)+c+e+k};M=function(b,c,d){if(!isFinite(b))return Infinity===b?d.numberFormat.positiveInfinity:-Infinity===b?d.numberFormat.negativeInfinity:d.numberFormat.NaN;if(!c||"i"===c)return d.name.length?b.toLocaleString():b.toString();c=c||"D";d=d.numberFormat;var e=Math.abs(b),g=-1;1<c.length&&(g=parseInt(c.slice(1),10));
var f=c.charAt(0).toUpperCase(),k;switch(f){case "D":c="n";e=C(e);-1!==g&&(e=p(""+e,g,!0));0>b&&(e="-"+e);break;case "N":k=d;case "C":k=k||d.currency;case "P":k=k||d.percent;c=0>b?k.pattern[0]:k.pattern[1]||"n";-1===g&&(g=k.decimals);e=a(e*("P"===f?100:1),g,k);break;default:throw"Bad number format specifier: "+f;}b=/n|\$|-|%/g;for(k="";;){g=b.lastIndex;f=b.exec(c);k+=c.slice(g,f?f.index:c.length);if(!f)break;switch(f[0]){case "n":k+=e;break;case "$":k+=d.currency.symbol;break;case "-":/[1-9]/.test(e)&&
(k+=d["-"]);break;case "%":k+=d.percent.symbol}}return k}})();q=function(){return/\/|dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|y|hh|h|HH|H|mm|m|ss|s|tt|t|fff|ff|f|zzz|zz|z|gg|g/g};B=function(a,b){if(!b)return 0;for(var c,d=a.getTime(),e=0,g=b.length;e<g;e++)if(c=b[e].start,null===c||d>=c)return e;return 0};F=function(a,b,c,d){a=a.getFullYear();!d&&b.eras&&(a-=b.eras[c].offset);return a};(function(){var a,b,c,d,e,g,h;a=function(a,b){if(100>b){var c=new Date,d=B(c),c=F(c,a,d),d=a.twoDigitYearMax,d="string"===
typeof d?(new Date).getFullYear()%100+parseInt(d,10):d;b+=c-c%100;b>d&&(b-=100)}return b};b=function(a,b,c){var d=a.days,e=a._upperDays;e||(a._upperDays=e=[h(d.names),h(d.namesAbbr),h(d.namesShort)]);b=g(b);c?(a=f(e[1],b),-1===a&&(a=f(e[2],b))):a=f(e[0],b);return a};c=function(a,b,c){var d=a.months,e=a.monthsGenitive||a.months,A=a._upperMonths,H=a._upperMonthsGen;A||(a._upperMonths=A=[h(d.names),h(d.namesAbbr)],a._upperMonthsGen=H=[h(e.names),h(e.namesAbbr)]);b=g(b);a=f(c?A[1]:A[0],b);0>a&&(a=f(c?
H[1]:H[0],b));return a};d=function(a,b){var c=a._parseRegExp;if(c){var d=c[b];if(d)return d}else a._parseRegExp=c={};for(var d=I(a,b).replace(/([\^\$\.\*\+\?\|\[\]\(\)\{\}])/g,"\\\\$1"),e=["^"],g=[],A=0,f=0,H=q(),h;null!==(h=H.exec(d));){var t=d.slice(A,h.index),A=H.lastIndex,f=f+n(t,e);if(f%2)e.push(h[0]);else{var t=h[0],m=t.length;switch(t){case "dddd":case "ddd":case "MMMM":case "MMM":case "gg":case "g":t="(\\D+)";break;case "tt":case "t":t="(\\D*)";break;case "yyyy":case "fff":case "ff":case "f":t=
"(\\d{"+m+"})";break;case "dd":case "d":case "MM":case "M":case "yy":case "y":case "HH":case "H":case "hh":case "h":case "mm":case "m":case "ss":case "s":t="(\\d\\d?)";break;case "zzz":t="([+-]?\\d\\d?:\\d{2})";break;case "zz":case "z":t="([+-]?\\d\\d?)";break;case "/":t="(\\/)";break;default:throw"Invalid date format pattern '"+t+"'.";}t&&e.push(t);g.push(h[0])}}n(d.slice(A),e);e.push("$");d={regExp:e.join("").replace(/\s+/g,"\\s+"),groups:g};return c[b]=d};e=function(a,b,c){return a<b||a>c};g=function(a){return a.split("\u00a0").join(" ").toUpperCase()};
h=function(a){for(var b=[],c=0,d=a.length;c<d;c++)b[c]=g(a[c]);return b};D=function(g,f,h){g=x(g);h=h.calendar;f=d(h,f);var q=(new RegExp(f.regExp)).exec(g);if(null===q)return null;var m=f.groups,l=f=g=null,B=null,N=null,n=0,p,s=0,F=0,O=0;p=null;for(var z=!1,u=0,C=m.length;u<C;u++){var w=q[u+1];if(w){var y=m[u],D=y.length,E=parseInt(w,10);switch(y){case "dd":case "d":B=E;if(e(B,1,31))return null;break;case "MMM":case "MMMM":l=c(h,w,3===D);if(e(l,0,11))return null;break;case "M":case "MM":l=E-1;if(e(l,
0,11))return null;break;case "y":case "yy":case "yyyy":f=4>D?a(h,E):E;if(e(f,0,9999))return null;break;case "h":case "hh":n=E;12===n&&(n=0);if(e(n,0,11))return null;break;case "H":case "HH":n=E;if(e(n,0,23))return null;break;case "m":case "mm":s=E;if(e(s,0,59))return null;break;case "s":case "ss":F=E;if(e(F,0,59))return null;break;case "tt":case "t":z=h.PM&&(w===h.PM[0]||w===h.PM[1]||w===h.PM[2]);if(!z&&(!h.AM||w!==h.AM[0]&&w!==h.AM[1]&&w!==h.AM[2]))return null;break;case "f":case "ff":case "fff":O=
E*Math.pow(10,3-D);if(e(O,0,999))return null;break;case "ddd":case "dddd":N=b(h,w,3===D);if(e(N,0,6))return null;break;case "zzz":y=w.split(/:/);if(2!==y.length)return null;p=parseInt(y[0],10);if(e(p,-12,13))return null;y=parseInt(y[1],10);if(e(y,0,59))return null;p=60*p+(v(w,"-")?-y:y);break;case "z":case "zz":p=E;if(e(p,-12,13))return null;p*=60;break;case "g":case "gg":if(!w||!h.eras)return null;w=x(w.toLowerCase());y=0;for(D=h.eras.length;y<D;y++)if(w===h.eras[y].name.toLowerCase()){g=y;break}if(null===
g)return null}}}q=new Date;m=(u=h.convert)?u.fromGregorian(q)[0]:q.getFullYear();null===f?f=m:h.eras&&(f+=h.eras[g||0].offset);null===l&&(l=0);null===B&&(B=1);if(u){if(q=u.toGregorian(f,l,B),null===q)return null}else if(q.setFullYear(f,l,B),q.getDate()!==B||null!==N&&q.getDay()!==N)return null;z&&12>n&&(n+=12);q.setHours(n,s,F,O);null!==p&&(h=q.getMinutes()-(p+q.getTimezoneOffset()),q.setHours(q.getHours()+parseInt(h/60,10),h%60));return q}})();K=function(a,b,c){var d=b["-"];b=b["+"];var e;switch(c){case "n -":d=
" "+d,b=" "+b;case "n-":h(a,d)?e=["-",a.substr(0,a.length-d.length)]:h(a,b)&&(e=["+",a.substr(0,a.length-b.length)]);break;case "- n":d+=" ",b+=" ";case "-n":v(a,d)?e=["-",a.substr(d.length)]:v(a,b)&&(e=["+",a.substr(b.length)]);break;case "(n)":v(a,"(")&&h(a,")")&&(e=["-",a.substr(1,a.length-2)])}return e||["",a]};a.prototype.findClosestCulture=function(b){return a.findClosestCulture.call(this,b)};a.prototype.format=function(b,c,d){return a.format.call(this,b,c,d)};a.prototype.localize=function(b,
...
m(!0,{},d,c);e&&(this.cultures[a].calendar=this.cultures[a].calendars.standard)};a.findClosestCulture=function(a){var b;if(!a)return this.findClosestCulture(this.cultureSelector)||this.cultures["default"];"string"===typeof a&&(a=a.split(","));if(s(a)){var c,d=this.cultures,e=a,g,f=e.length,h=[];for(g=0;g<f;g++)a=x(e[g]),a=a.split(";"),c=x(a[0]),1===a.length?a=1:(a=x(a[1]),0===a.indexOf("q=")?(a=a.substr(2),a=parseFloat(a),a=isNaN(a)?0:a):a=1),h.push({lang:c,pri:a});h.sort(function(a,b){return a.pri<
b.pri?1:a.pri>b.pri?-1:0});for(g=0;g<f;g++)if(c=h[g].lang,b=d[c])return b;for(g=0;g<f;g++){c=h[g].lang;do{e=c.lastIndexOf("-");if(-1===e)break;c=c.substr(0,e);if(b=d[c])return b}while(1)}for(g=0;g<f;g++){c=h[g].lang;for(var q in d)if(e=d[q],e.language==c)return e}}else if("object"===typeof a)return a;return b||null};a.format=function(a,b,c){c=this.findClosestCulture(c);a instanceof Date?a=J(a,b,c):"number"===typeof a&&(a=M(a,b,c));return a};a.localize=function(a,b){return this.findClosestCulture(b).messages[a]||
this.cultures["default"].messages[a]};a.parseDate=function(a,b,c){c=this.findClosestCulture(c);var d,e;if(b){if("string"===typeof b&&(b=[b]),b.length){e=0;for(var g=b.length;e<g;e++){var f=b[e];if(f&&(d=D(a,f,c)))break}}}else for(e in b=c.calendar.patterns,b)if(d=D(a,b[e],c))break;return d||null};a.parseInt=function(b,c,d){return C(a.parseFloat(b,c,d))};a.parseFloat=function(a,b,c){"number"!==typeof b&&(c=b,b=10);var f=this.findClosestCulture(c);c=NaN;var h=f.numberFormat;-1<a.indexOf(f.numberFormat.currency.symbol)&&
(a=a.replace(f.numberFormat.currency.symbol,""),a=a.replace(f.numberFormat.currency["."],f.numberFormat["."]));a=x(a);if(d.test(a))c=parseFloat(a);else if(!b&&e.test(a))c=parseInt(a,16);else{f=K(a,h,h.pattern[0]);b=f[0];f=f[1];""===b&&"(n)"!==h.pattern[0]&&(f=K(a,h,"(n)"),b=f[0],f=f[1]);""===b&&"-n"!==h.pattern[0]&&(f=K(a,h,"-n"),b=f[0],f=f[1]);b=b||"+";var q;a=f.indexOf("e");0>a&&(a=f.indexOf("E"));0>a?(q=f,a=null):(q=f.substr(0,a),a=f.substr(a+1));var l=h["."],k=q.indexOf(l);0>k?(f=q,q=null):(f=
q.substr(0,k),q=q.substr(k+l.length));l=h[","];f=f.split(l).join("");k=l.replace(/\u00A0/g," ");l!==k&&(f=f.split(k).join(""));b+=f;null!==q&&(b+="."+q);null!==a&&(h=K(a,h,"-n"),b+="e"+(h[0]||"+")+h[1]);g.test(b)&&(c=parseFloat(b))}return c};a.culture=function(a){"undefined"!==typeof a&&(this.cultureSelector=a);return this.findClosestCulture(a)||this.cultures["default"]}})(this);
(function(){draggable=!1;var b=null,c=null,a=[59.888937,-101.601562],e=null,d=null,g=!0,l=null,f=null,h=function(){d&&d.setMap(null);d=null;f&&(google.maps.event.removeListener(f),f=null)},m=function(a,b){document.getElementById("LATITUDE").value=Globalize.format(a,"n6");document.getElementById("LONGITUDE").value=Globalize.format(b,"n6")},s=function(a,b){var e=new google.maps.LatLng(a,b);g&&c.setZoom(14);c.setCenter(e);g=!1;e=new google.maps.Marker({position:e,map:c,clickable:!1,draggable:draggable});
h();d=e;draggable&&(f=google.maps.event.addListener(e,"dragend",z))},z=function(){$("#GEOCODE_TYPE_SITE_REFRESH, #GEOCODE_TYPE_INTERSECTION_REFRESH").addClass("NotVisible");$("#GEOCODE_TYPE_MANUAL").prop("checked",!0);var a=this.getPosition();m(a.lat(),a.lng())},u=function(a){a&&(l=pending_geocode_address,m(a.lat(),a.lng()),s(a.lat(),a.lng()))},v=function(a){var b=null;switch(a){case google.maps.GeocoderStatus.ZERO_RESULTS:b=pageconstants.txt_geocode_unknown_address;break;case google.maps.GeocoderStatus.REQUEST_DENIED:b=
pageconstants.txt_geocode_map_key_fail;break;case google.maps.GeocoderStatus.OVER_QUERY_LIMIT:b=pageconstants.txt_geocode_too_many_queries;break;default:b=pageconstants.txt_geocode_unknown_error+a}return b};window.get_response_message=v;var x=function(a){return function(b,c){c!==google.maps.GeocoderStatus.OK?a(null,c):a(b[0].geometry.location,c)}};window.handle_geocode=x;var C=function(){var d={zoom:13,mapTypeId:google.maps.MapTypeId.ROADMAP};b=document.getElementById("map_canvas");c=new google.maps.Map(b,
d);c.setCenter(new google.maps.LatLng(a[0],a[1]),2);e||(e=new google.maps.Geocoder);var d=$("#LATITUDE")[0].value,f=$("#LONGITUDE")[0].value;d&&f&&s(Globalize.parseFloat(d),Globalize.parseFloat(f))},p=[],n=!1;window.maps_loaded=function(){n=!0;$.each(p,function(a,b){b()});p=[]};window.add_maps_loaded_callback=function(a){n?a():p.push(a)};window.initialize_maps=function(a,b,c,d){if(!window.cioc_map_script_added){window.cioc_map_script_added=!0;Globalize.culture(a);var e="";d&&(e="&libraries=places");
$.getScript("//maps.googleapis.com/maps/api/js?v=3&"+b+"&sensor=false&callback=maps_loaded&language="+a+e)}add_maps_loaded_callback(c)};var I=function(){return x(function(a,b){a?u(a):alert(v(b))})},J=function(){if(c){var a=document.getElementById("located_near_address").value;if(l==a)return!1;l=a;var b=I();(pending_geocode_address=a)?e.geocode({address:a},b):(h(),m("",""))}return!1};window.searchform_map_loaded=function(){C();var a=$("#located_near_check_button").click(J),b=$("#located_near_address").keydown(M).blur(function(){a.click()});
if(google.maps.places){var c=new google.maps.places.Autocomplete(b[0]);c.addListener("place_changed",function(){var a=c.getPlace();a.geometry&&a.geometry.location&&(pending_geocode_address=b.val(),u(a.geometry.location))})}};var M=function(a){null==a&&(a=window.event);if(13==a.keyCode)return document.getElementById("located_near_check_button").click(),!1}})();
