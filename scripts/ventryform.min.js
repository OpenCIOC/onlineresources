...
"2"==b?(d.find(".repeat-every-ui, .repeat-day-of-month-ui, .recurs-month-label").show(),d.find(".repeat-week-of-month-ui, .repeats-on-ui, .recurs-week-label").hide()):(d.find(".repeat-every-ui, .repeat-week-of-month-ui, .repeats-on-ui, .recurs-month-label").show(),d.find(".repeat-day-of-month-ui, .recurs-week-label").hide())};a("#ScheduleEditArea").on("change",".recur-type-selector",d).find(".recur-type-selector").each(d)}})();
