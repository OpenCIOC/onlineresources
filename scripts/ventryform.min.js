...
*/
window.CIOC={};
(function(a,e){e.do_drop_down_navigation=function(){for(var c=a.getElementById("ActionList").options,b=0;b<c.length;b++)if(c[b].selected){var d=c[b].getAttribute("href");d&&("undefined"!=typeof c[b].attributes.newwindow?e.open(d):e.location.href=d);break}};jQuery(function(c){c("[data-toggle=dialog]").each(function(){var b=c(this),d=c(b.data("target")),g={autoOpen:!1,title:d.data("title"),modal:d.data("modal")};d.dialog(g);b.click(function(){d.dialog("isOpen")?d.dialog("close"):d.dialog("open")})})})})(document,window);
...
a(f.currentTarget).data("id");a.ajax({success:n(f),dataType:"json",error:function(){alert("Error")},data:{ID:f,RemoveItem:e.domain},type:"POST",url:e.current_list_url})},k=function(f){a.ajax({success:n(),dataType:"json",error:function(){alert("Error")},data:{ID:"all",RemoveItem:e.domain},type:"POST",url:e.current_list_url})},h={CIC:function(f){return/^[A-Za-z]{3}[0-9]{4,5}$/.test(f)},VOL:function(f){return/^[1-9][0-9]*$/.test(f)}},q=function(f){if(f.fail)w();else if(f.inrequest){var m=a.grep(f.ids,
h[e.domain]);b(m);c(m.length);(f=f.previous_ids)&&a.each(f,function(u,y){a("#ct_added_to_previous_request_"+y).show()});a(".ListUI img").prop("src",function(u,y){return y.replace("list","referral")});a("#list_header_text").hide();a("#ct_header_text").show();e.current_list_url=e.ct_update_url;l()}else w()},w=function(){var f=function(){e.list_view_mode||b(e.already_added||[]);e.current_list_url=e.list_view_mode&&"ct"===e.list_view_mode?e.ct_update_url:e.list_update_url;c((e.already_added||[]).length);
l()};e.list_view_mode||e.has_session?f():a.ajax({dataType:"json",error:null,url:e.list_update_url,data:{SessionTest:"on"},type:"POST",success:function(m){m.has_session&&f()}})},l=function(){a(".HideListUI").delegate(".add_to_list","click",g).delegate(".remove_from_list","click",r).removeClass("HideListUI");a("#remove_all_from_list").click(k);a.browser.msie&&"8.0">a.browser.msie&&a(".ListUI").removeClass("FixIE")};window.init_list_adder=function(f){e=f;e.myListLink=a("#myListLink").parent(":hidden").add("#myListLink");
f.in_request?a.ajax({success:q,dataType:"json",error:null,type:"POST",url:f.in_request}):w()}})();this.JSON||(this.JSON={});
(function(){function a(h){return 10>h?"0"+h:h}function e(h){d.lastIndex=0;return d.test(h)?'"'+h.replace(d,function(q){var w=r[q];return"string"===typeof w?w:"\\u"+("0000"+q.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+h+'"'}function c(h,q){var w=g,l=q[h];l&&"object"===typeof l&&"function"===typeof l.toJSON&&(l=l.toJSON(h));"function"===typeof k&&(l=k.call(q,h,l));switch(typeof l){case "string":return e(l);case "number":return isFinite(l)?String(l):"null";case "boolean":case "null":return String(l);
case "object":if(!l)return"null";g+=n;var f=[];if("[object Array]"===Object.prototype.toString.apply(l)){var m=l.length;for(h=0;h<m;h+=1)f[h]=c(h,l)||"null";q=0===f.length?"[]":g?"[\n"+g+f.join(",\n"+g)+"\n"+w+"]":"["+f.join(",")+"]";g=w;return q}if(k&&"object"===typeof k)for(m=k.length,h=0;h<m;h+=1){var u=k[h];"string"===typeof u&&(q=c(u,l))&&f.push(e(u)+(g?": ":":")+q)}else for(u in l)Object.hasOwnProperty.call(l,u)&&(q=c(u,l))&&f.push(e(u)+(g?": ":":")+q);q=0===f.length?"{}":g?"{\n"+g+f.join(",\n"+
g)+"\n"+w+"}":"{"+f.join(",")+"}";g=w;return q}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(h){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(h){return this.valueOf()});var b=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
d=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,g,n,r={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k;"function"!==typeof JSON.stringify&&(JSON.stringify=function(h,q,w){var l;n=g="";if("number"===typeof w)for(l=0;l<w;l+=1)n+=" ";else"string"===typeof w&&(n=w);if((k=q)&&"function"!==typeof q&&("object"!==typeof q||"number"!==typeof q.length))throw Error("JSON.stringify");return c("",{"":h})});
"function"!==typeof JSON.parse&&(JSON.parse=function(h,q){function w(l,f){var m,u=l[f];if(u&&"object"===typeof u)for(m in u)if(Object.hasOwnProperty.call(u,m)){var y=w(u,m);void 0!==y?u[m]=y:delete u[m]}return q.call(l,f,u)}h=String(h);b.lastIndex=0;b.test(h)&&(h=h.replace(b,function(l){return"\\u"+("0000"+l.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(h.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
e[this.name];"undefined"!=typeof d&&null!==d&&("input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type?"select"===this.nodeName.toLowerCase()?c(this).find("option").each(function(g){this.selected=1<d.length?0<=c.inArray(this.value,d):0===d.length?!1:this.value===d[0]}):this.value=d.length?d[0]:"":this.checked=1<d.length?0<=c.inArray(this.value,d):0===d.length?!1:this.value===d[0])}})};window.init_cached_state=function(a){var e=jQuery;a=a||"#EntryForm";onbeforeunload_fns=
...
JSON.parse(c.value);e.each(onbeforerestorevalues_fns,function(d,g){g(b)});restore_form_values(a,b.form_values)}}}})();
(function(){var a=jQuery,e={"en-CA":"d M yy",de:"dd.mm.yy",fr:"d M yy",it:"d M yy",nl:"d M yy",no:"d M yy",pt:"d-mm-yy",sv:"d M yy",hu:"M d. yy",ro:"d M yy",hr:"d M yy",sl:"d M yy",bg:"d MM yy",ru:"d M yy",tr:"d M yy",lv:"d M yy",lt:"d M yy",ko:"yy/mm/dd","zh-CN":"yy/mm/dd",th:"d M yy"},c={"en-CA":!0,"":!0},b={},d={"fr-CA":"fr","es-MX":"es"},g=function(){var r=a(this),k=r.data("culture"),h=e[k]||a.datepicker.regional[k].dateFormat,q={};r.hasClass("NoYear")&&(h=h.replace(/[\- .\/]*yy[\/]?/,""),q={beforeShow:function(w,
l){l.dpDiv.addClass("NoYearDatePicker")},onClose:function(w,l){l.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});q.dateFormat=h;r.datepicker(a.extend({},a.datepicker.regional[k],q)).prop("autocomplete","off")},n=function(r){a.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+r+".min.js",function(){c[r]=!0;a.each(b[r],function(){g.call(this)});delete b[r]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var r=
a(this);var k=r.parents("[lang]").first().prop("lang")||"en-CA";k=d[k]||k;r.data("culture",k);c[k]?g.call(this):(r=b[k],r||(r=b[k]=[],n(k)),r.push(this))})}});jQuery(function(){a("input.DatePicker").autodatepicker()})})();
...
"u");return b=b.replace(RegExp("[\u00fd\u00ff]","g"),"y")};window.string_ci_ai=a;var e=function(b,d,g,n,r){g=g||"value";n=n||"";r=r||"";return function(k,h){if(d.term&&(new RegExp(n+b.ui.autocomplete.escapeRegex(d.term)+r,"i")).test(k.term)&&d.content&&13>d.content.length){var q=new RegExp(n+b.ui.autocomplete.escapeRegex(k.term)+r,"i");h(b.grep(d.content,function(w){return q.test(a(w[g]))}));return!0}return!1}};window.default_cache_search_fn=e;var c=function(b,d,g,n,r){g=g||{};r=r||e(b,g,n||"value");
return function(k,h,q){k.term=a(k.term);g.term===k.term&&g.content?h(g.content):r(k,h)||b.ajax({url:q||d,dataType:"json",data:k,cache:!1,success:function(w){g.term=k.term;g.content=w;h(w)}})}};window.create_caching_source_fn=c;window.init_community_autocomplete=function(b,d,g,n,r){var k={};r&&=b(r);r&&!r.length&&(r=null);var h=b("#"+d).autocomplete({focus:function(q,w){return!1},select:function(q,w){h.data({chkid:w.item.chkid,display:w.item.value})},source:c(b,g,k),minLength:n}).keypress(function(q){"13"==
q.keyCode&&(q.preventDefault(),h.autocomplete("close"))});r&&(h.parents("form").on("submit",function(){var q=h.val();if(h.data("display")===q)r.val(h.data("chkid"));else{if(k.content){var w=a(q);q=b.grep(k.content,function(l){return a(l.value)===w});if(1===q.length){r.val(q[0].chkid);h.data({chkid:q[0].chkid,display:q[0].value}).val(q[0].value);return}}r.val("")}}),cache_register_onbeforerestorevalues(function(q){h.length&&(q=q["autocomplete_data_"+h[0].id])&&h.data(q)}),cache_register_onbeforeunload(function(q){if(h.length){var w=
h.data();w.display&&w.chkid&&(q["autocomplete_data_"+h[0].id]={display:w.display,chkid:w.chkid})}}))}})();
(function(){window.entryform=window.entryform||{};window.create_checklist_onbefore_fns=function(c,b,d,g){cache_register_onbeforeunload(function(n){n[b+"_added"]=d});cache_register_onbeforerestorevalues(function(n){(n=n[b+"_added"])&&c.each(n,function(r,k){g(k.chkid,k.display,"")})})};window.basic_chk_add_html=function(c,b){return function(d,g){d=c("<tr>").append(c("<td>").append(c("<input>").prop({id:b+"_ID_"+d,type:"checkbox",checked:!0,defaultChecked:!0,name:b+"_ID",value:d})).append(document.createTextNode(" "+
g))).append(c("<td>").append(c("<input>").prop({id:b+"_NOTES_"+d,name:b+"_NOTES_"+d,size:entryform.chk_notes_size,maxlength:entryform.chk_notes_maxlen})));c("#"+b+"_existing_add_table").append(d);return d.find('input[type="checkbox"]')[0]}};var a={},e=function(c){$("#NEW_"+c).autocomplete(a[c])};window.init_autocomplete_checklist=function(c,b){var d=b.field;if(!a[d]){var g=b.source;b.minLength=b.minLength||1;b.delay=b.delay||300;b.add_new_html=b.add_new_html||basic_chk_add_html(c,d);b.match_prop=
b.match_prop||"value";b.txt_not_found=b.txt_not_found||"Not Found";var n=c(b.delegate_root||document),r=b.added_values||[],k=function(f,m,u){var y=document.getElementById(d+"_ID_"+f);y?(y.checked=!0,b.after_add_new_value&&b.after_add_new_value.call(y)):(r.push({chkid:f,display:m,label:u}),f=b.add_new_html(f,m,u),b.after_add_new_value&&b.after_add_new_value.call(f))};create_checklist_onbefore_fns(c,d,r,k);var h={},q=function(f){c("#NEW_"+d).data({chkid:"",display:"",label:""}).prop("value","").focus();
c("#"+d+"_error").hide("slow",function(){c(this).remove()})},w=null,l=null;(function(f){c.isArray(f)?(l=function(m,u){var y=new RegExp(c.ui.autocomplete.escapeRegex(string_ci_ai(m.term)));u(c.grep(f,function(v){return y.test(string_ci_ai(v[b.match_prop]||v))}))},w=function(m,u){var y=string_ci_ai(m);m=c.grep(f,function(v){return string_ci_ai(string_ci_ai(v[b.match_prop]||v))===y});if(1===m.length)return u(m[0]),!0;u()}):"string"===typeof f?(l=create_caching_source_fn(c,f,h,b.match_prop),w=function(m,
u,y){var v=string_ci_ai(m);if(h.content){var p=c.grep(h.content,function(x){return string_ci_ai(x[b.match_prop])===v});if(1===p.length){u(p[0]);return}}y||string_ci_ai(h.term||"")===v?u():l({term:v},function(x){w(m,u,!0)})}):(l=f,w=b.look_for_fn)})(g);n.on("click","#add_"+d,function(f){f=c("#NEW_"+d);var m=f.data("chkid"),u=f.data("display"),y=f.data("label"),v=f[0].value;if(m&&u&&u==v)return k(m,u,y),q(),!1;w(f[0].value,function(p){p?(k(p.chkid,p.value,p.label),q()):0===c("#"+d+"_error").length&&
...
window.init_languages=function(c,b){var d=null,g=null,n=c("#LN_existing_add_table"),r=function(){var k=c(this).parents(".language-entry").find(".language-details-notes");this.checked?k.slideDown():k.slideUp()};init_autocomplete_checklist(c,{field:"LN",source:entryform.languages_source,txt_not_found:b,after_add_new_value:r,add_new_html:function(k,h){null===d&&(d=c("#add_LN"),g=d.data("newTemplate"));k=g.replace(/LANGNAMELANGNAME/g,h).replace(/IDIDID/g,k);n.append(k)}});n.on("change",".language-primary",
r).uitooltip({items:"[data-help-text]",content:function(){return'<div class="language-help-text">'+c(this).data("helpText")+"</div>"},position:{my:"center bottom-20",at:"center top",using:function(k,h){c(this).css(k);c("<div>").addClass("arrow").addClass(h.vertical).addClass(h.horizontal).appendTo(this)}}});window.languages_check_state=r}})();
...
b=e("input[id^=NEW_]");b.length&&(e("#EntryForm").submit(function(d){var g=b.map(function(){return this.value?this:null});if(g.length&&!d.isDefaultPrevented()){if(!confirm(a)){d.preventDefault();e("#SUBMIT_BUTTON").prop("disabled",!1);d=e("#unadded_checklist_error_box");var n=e("#unadded_checklist_error_list");var r=d.is(":visible");r&&n.children("ul:first").hide("slow",function(){e(this).remove()});var k=e("<ul>");r&&k.hide();n.append(k);e.each(g.map(c),function(){k.append(this)});r?k.show("slow"):
d.show("slow")}}else d.isDefaultPrevented()&&(d=e("#unadded_checklist_error_box"),n=e("#unadded_checklist_error_list"),d.hide("slow",function(){n.children().remove()}))}),e(document).on("click",".UnaddedChecklistJump",function(){var d=e(this).data("jump_location");(d=document.getElementById(d))&&d.scrollIntoView(!0)}))};window.init_entryform_items=function(a,e,c){var b=jQuery;a.each(function(){var d=null,g=this,n=b(g),r=1,k=n.find(".EntryFormItemContainerIds")[0];if(k){var h=n.data("maxAdd");h&&=
parseInt(h,10);var q=[];k.value&&(q=b.map(k.value.split(","),function(v){return 0===v.indexOf("NEW")&&0!==v.indexOf("NEWFB")?null:v}));var w={},l=function(){n.find(".EntryFormItemBox").each(function(v){b(this).find(".EntryFormItemCount").text(v+1)})},f=function(v){if(h){var p=n.find(".EntryFormItemContent:hidden").parent().find("button.EntryFormItemDelete").prop("disabled",!v);y.prop("disabled",!v);v?(p.removeClass("ui-state-disabled"),y.removeClass("ui-state-disabled")):(p.addClass("ui-state-disabled"),
y.addClass("ui-state-disabled"))}},m=function(){var v=0,p;for(p in w)v++;return q.length-v},u=function(v){var p=0;if(h&&!v&&(p=m(),p>=h)){alert("over");return}var x=n.data("addTmpl");q.push("NEW"+r++);k.value=q.join(",");x=b(x.replace(/\[COUNT\]/g,q.length).replace(/\[ID\]/g,q[q.length-1]));x.find(".DatePicker").autodatepicker();x.find(".Province").combobox({source:window.cioc_province_source});entryform.service_titles&&x.find(".ServiceTitleField").combobox({source:entryform.service_titles});n.append(x);
d&&(d.sortable("refresh"),l());h&&!v&&p+1===h&&f(!1)},y=n.parent().find(".EntryFormItemAdd").click(function(){u(!1)});n.on("click","button.EntryFormItemDelete",function(){var v=this,p=b(this).parents(".EntryFormItemBox").find(".EntryFormItemContent"),x=this.id.split("_");x=x[x.length-2];if(p.is(":visible"))p.hide("slow",function(){w[x]=get_form_values(p);b(v).text(c);p.find("input,select,textarea").each(function(){"input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type?
"select"===this.nodeName.toLowerCase()?b(this).find("option").each(function(){this.selected=!1}):this.value="":this.checked=!1});f(!0)});else{var A=0;if(h&&(A=m(),A>=h)){alert("over");return}var B=w[x];B&&(delete w[x],restore_form_values(p,B),p.show("slow",function(){b(v).text(e)}),h&&A+1===h&&f(!1))}});n.hasClass("sortable")&&(d=n.sortable({items:".EntryFormItemBox"}),d.bind("sortstart",function(v,p){p.helper.bgiframe();n.addClass("sorting")}),d.bind("sortstop",function(){var v=d.sortable("toArray");
q=b.map(v,function(p){p=p.split("_");return p[p.length-2]});k.value=q.join(",");setTimeout(function(){n.removeClass("sorting");l()},1)}));cache_register_onbeforeunload(function(v){v[g.id+"_ids"]=q;v[g.id+"_deletes"]=w;d&&(v[g.id+"_order"]=d.sortable("toArray"))});cache_register_onbeforerestorevalues(function(v){v[g.id+"_ids"]&&b.each(v[g.id+"_ids"],function(p,x){0===x.indexOf("NEW")&&u(!0)});v[g.id+"_deletes"]&&(w=v[g.id+"_deletes"],n.find(".EntryFormItemContent").each(function(){var p=this.id.split("_");
p=p[p.length-2];w[p]&&b(this).hide().parent().find("button.EntryFormItemDelete").text(c)}));h&&m()>=h&&f(!1);d&&(v=v[g.id+"_order"])&&(v.reverse(),b.each(v,function(p,x){b("#"+x).detach().prependTo(n)}),d.sortable("refresh"),l())})}})};window.init_schedule=function(a){var e=function(){var c=a(this).parents(".EntryFormItemBox"),b=this.value;"0"===b?c.find(".recurs-ui").hide():"1"==b?(c.find(".repeat-every-ui, .repeats-on-ui, .recurs-week-label").show(),c.find(".repeat-week-of-month-ui, .repeat-day-of-month-ui, .recurs-month-label").hide()):
...
(function(){var a=jQuery,e=function(c,b){var d=a("#CM_existing_add_container"),g=d.data("addonLabel");d.append(a("<div>").addClass("row-border-bottom").append(a("<div>").addClass("row form-group").append(a("<label>").addClass("control-label control-label-left col-md-4").prop({for:"CM_ID_"+c}).append(a("<input>").prop({id:"CM_ID_"+c,type:"checkbox",checked:!0,defaultChecked:!0,name:"CM_ID",value:c})).append(document.createTextNode(" "+b))).append(a("<div>").addClass("col-md-8 form-inline").append(a("<div>").addClass("input-group").append(a("<input>").addClass("form-control").prop({id:"CM_NUM_NEEDED_"+
c,name:"CM_NUM_NEEDED_"+c,size:3,maxlength:3})).append(a("<span>").addClass("input-group-addon").text(g))))))};window.init_num_needed=function(c){init_autocomplete_checklist(a,{field:"CM",source:entryform.community_complete_url,add_new_html:e,minLength:3,txt_not_found:c})};window.init_interests=function(c){var b=[],d=only_items_chk_add_html(a,"AI");init_autocomplete_checklist(a,{field:"AI",source:entryform.interest_complete_url,add_new_html:d,added_values:b,txt_not_found:c});var g=function(r){var k=
a("#AreaOfInterestList");k.length&&k.prop("id","AreaOfInterestListOld");a("<ul>").hide().insertAfter(n).prop("id","AreaOfInterestList").append(a(a.map(r,function(h,q){return a("<li>").append(a("<label>").append(a("<input>").prop({type:"checkbox",value:h.chkid}).data("cioc_chk_display",h.value)).append(document.createTextNode(" "+h.value)))[0]}))).show("slow");k.length&&k.hide("slow",function(){k.remove()})};var n=a("#InterestGroup").change(function(){a.getJSON(entryform.interest_complete_url,{IGID:n.prop("value")},
g)});a("#FIELD_INTERESTS").next().on("click","#AreaOfInterestList input:checkbox",{added_values:b,add_item_fn:d},function(r){var k=a(this),h=document.getElementById("AI_ID_"+this.value);h?h.checked=!0:(h=k.data("cioc_chk_display"),r.data.added_values.push({chkid:this.value,display:h}),r.data.add_item_fn(this.value,h));k.parent().parent().hide("slow",function(){k.remove()})})}})();
(function(){window.init_entryform_notes=function(a,e,c){var b=jQuery;a.each(function(){var d=this,g=b(d),n=g.parent(),r=1,k=g.find(".EntryFormNotesUpdateIds")[0];if(k){var h=g.find(".EntryFormNotesDeleteIds")[0],q=g.find(".EntryFormNotesCancelIds")[0],w=g.find(".EntryFormNotesRestoreIds")[0],l=[],f=[],m=[],u={},y=[],v=function(t,z){l.push(t.id);k.value=l.join(",");var C=g.find(".EntryFormItemBox").length+1;template=g.data("addTmpl");new_item=b(template.replace(/\[COUNT\]/g,C).replace(/\[ID\]/g,t.id).replace(/\[MODIFIED_DATE\]/g,
...
g.append(new_item)};n.find(".EntryFormItemAdd").click(function(){var t="NEW"+r++;v({id:t},!0)});var p=function(t){var z=t.id.split("_");t=b(t);var C=t.parents(".EntryFormNotesItem");C.find(".EntryFormItemContent").css("text-decoration","line-through");f.push(z[z.length-2]);h.value=f.join(",");C.data("actionToRestore","delete");t.parent().hide().prev().show()},x=function(t,z){var C=t.id.split("_"),F=b(t),D=F.parents(".EntryFormNotesItem"),H=D.find(".EntryFormItemContent"),I=t.id.lastIndexOf("_");t=
t.id.substring(0,I)+"_CANCEL_REASON";C=C[C.length-2];H.prepend(z.data("cancelTemplate"));m.push(C);q.value=m.join(",");u[C]=z.data("cancelType");g.append(b("<input>").prop({type:"hidden",id:t,name:t,value:z.data("cancelType")}));D.data("actionToRestore","cancel");F.parent().hide().prev().show()},A={update:function(t){t=b(t).parents(".EntryFormNotesItem");var z=t.find(".EntryFormItemContent");v(z.data("formValues"));t.hide()},"delete":p,cancel:x},B=n.find(".EntryFormItemActionMenu").menu({select:function(t,
...
(function(){window.changeAutoAssign=function(g,n,r){g.checked?(n.value="",n.disabled=!0,r.disabled=!0):(n.disabled=!1,r.disabled=!1)};var a=jQuery,e=function(g){g.find(":input").not('input[type="hidden"]').filter("[name]").addClass("require-group")},c=function(g){g.find(":input").not('input[type="hidden"]').filter("[name]").removeClass("require-group")};window.make_required_group=e;window.remove_required_group=c;var b=function(g,n){var r=g.parent().find("td[data-field-display-name]"),k=r.data("fieldDisplayName");
n?(g.text(k).append(' <span class="Alert">*</span>'),e(r)):(g.text(k),c(r))},d=function(){var g=a("#FIELD_ORG_LEVEL_2");if(g.length){var n=a("#RECORD_TYPE").find(":selected").data("progorbranch");b(g,n)}};window.update_form_make_required_org_level=function(){for(var g,n=0;6>n;n++)if(g=a("#FIELD_ORG_LEVEL_"+n),g.length){b(g,!0);break}};window.init_client_validation=function(g,n){var r=a(g),k=r.prop("lang")||r.parents("[lang]").first().prop("lang")||"en-CA",h=function(p){var x=!1;try{p.each(function(){if(this.name)if(/radio|checkbox/i.test(this.type)){if(this.checked&&
...
a.validator.addMethod("require-group",function(p,x){p=a(x).parents("td[data-field-display-name]");x=p.parent().children("td:first").prop("id");x=x.slice(-(x.length-6));var A=p.find(":input").not("[type=hidden]").not("button");if(window.tinymce){var B=p.find(".WYSIWYG").prop("id");B&&(B=window.tinymce.get(B))&&B.save()}switch(x){case "ACCESSIBILITY":case "AREAS_SERVED":case "LANGUAGES":case "FUNDING":case "SCHOOL_ESCORT":case "SCHOOLS_IN_AREA":case "TYPE_OF_CARE":A=A.not("input:text");break;case "ALT_ORG":case "LEGAL_ORG":A=
A.not("input:checkbox");break;case "FORMER_ORG":A=A.not("input:checkbox").not("[name^=FORMER_ORG_DATE]");break;case "FEES":A=A.not("input:text").add("#FEE_ASSISTANCE_FOR, #FEE_ASSISTANCE_FROM");break;case "VACANCY_INFO":A=A.filter("[name!=VUT_ID]")}(x=h(A))&&p.children("div.required-notice").hide();return x},"Field Required");var y=a('<div id="a_test"></div>').dialog({autoOpen:!1,title:n,closeOnEscape:!1,position:["right","bottom"],resizable:!1,dialogClass:"ValidationErrors"}),v=a("#validation_error_box");
a(document).on("click",".FieldErrorJump",function(p){p=a(p.currentTarget).prop("fieldname");(p=document.getElementById(p))&&p.scrollIntoView(!0)});a(".ValidationErrors.ui-dialog").css({position:"fixed"}).position({my:"right bottom",at:"right bottom",of:window});e(a(g).find("td[data-field-required]"));g=a(g).validate({ignore:"input[type=hidden]",ignoreTitle:!0,errorPlacement:function(p,x){var A=[],B=x[0];if(x.hasClass("require-group")){var G=x.parents("td[data-field-display-name]");A=G.children("div.required-notice");
var E=!1;/radio|checkbox/i.test(B.type)?B.checked&&B.value||(E=!0):a.trim(B.value)||(E=!0);if(E){A.length?(A.empty(),A.show(),A.append(p)):(p.removeAttr("for"),G.prepend(a('<div class="required-notice"></div>').append(p)));return}}A.length&&A.hide();p.insertAfter(x)},showErrors:function(p,x){this.defaultShowErrors();if(0===x.length)y.dialog("close"),v.hide("slow");else{var A={},B=a("<ul>");jQuery.each(x,function(G,E){E=E.element;G=a(E).parents("td[data-field-display-name]");E=G.parent().children("td:first").prop("id");
A[E]||(A[E]=!0,B.append(a("<li>").append(a("<span>").prop({fieldname:E,className:"FieldErrorJump SimulateLink"}).text(G.data("fieldDisplayName")))))});y.empty().append(B);y.dialog("open");v.show("slow");a("#SUBMIT_BUTTON").prop("disabled",!1)}},focusInvalid:!1,onfocusout:!1,onkeyup:!1,onclick:!1});"fr-CA"===k?jQuery.extend(jQuery.validator.messages,{required:"Ce champ est requis.",remote:"Veuillez remplir ce champ pour continuer.",email:"Veuillez entrer une adresse email valide.",url:"Veuillez entrer une URL valide.",
...
"require-group":"Ce champ est requis.",unique:"Une valeur unique est requise."}):jQuery.extend(jQuery.validator.messages,{protourl:"Please enter a valid URL.",posint:"Please enter a positive number.",posdbl:"Please enter a positive number.","record-num":"Please enter a valid record number.","require-group":"Field Required.",unique:"A unique value is required."});return g};window.init_record_type_form=function(g,n,r){var k=null,h=null,q={},w="ORG_LEVEL_1 ORG_LEVEL_2 ORG_LEVEL_3 ORG_LEVEL_4 ORG_LEVEL_5 LOCATION_NAME SERVICE_NAME_LEVEL_1 SERVICE_NAME_LEVEL_2".split(" "),
l=function(){a("#RecordTypeName").html(h);a.each(w,function(m){var u=r[m],y=a("#"+m);y.length&&(y[0].value=u)&&(a("#"+m+"_DISPLAY").text(u),a("#HIDDEN_"+y).prop("value",u))});a("#RECORD_TYPE").prop("value",k[0].value);d()},f=function(){var m=k[0].value;k.data("hasform")||(m=null);k=a(this).find("option:selected");var u=k[0].value;k.data("hasform")||(u=null);u!==m?(q[m]=a("#copyFieldsForm").contents().detach(),q[u]?(a("#copyFieldsForm").append(q[u]),a("#RECORD_TYPE").prop("value",k[0].value)):a("#copyFieldsForm").load(n+
" #copyFieldsInner",{NUM:g,RT:u||k[0].value},l)):d()};jQuery(function(){h=a("#RecordTypeName").html();var m=a("#RECORD_TYPE");a(document).on("change","#RECORD_TYPE",f);k=m.find("option:selected");d()})};window.init_validate_duplicate_org_names=function(g){var n=a.extend({selector:"#EntryForm",fields:"#ORG_LEVEL_1,#ORG_LEVEL_2,#ORG_LEVEL_3,#ORG_LEVEL_4,#ORG_LEVEL_5,#LOCATION_NAME,#SERVICE_NAME_LEVEL_1,#SERVICE_NAME_LEVEL_2,#OLS_SELECT input,#ORG_NUM",only_warn:!0,num:null,org_levels:[],url:null},g),
r=[],k=null!==n.num,h=[],q=a(n.selector).submit(function(w){var l,f=!1,m=a(n.fields).serializeArray();n.num&&m.push({name:"NUM",value:n.num});if(m.length!==r.length)f=!0;else for(l=0;l<m.length;l++){var u=m[l];if(u.name!==r[l].name||u.value!==r[l].value){f=!0;break}}if(!f&&k)return!0;var y=function(){n.only_warn&&confirm(n.confirm_string)?(k=!0,a("#duplicate_name_error_box").hide(),q.submit()):(a("#SUBMIT_BUTTON").prop("disabled",!1),a("#duplicate_name_error_box").show())};w.stopPropagation();w.preventDefault();
if(!f)return y(),!1;a.ajax({url:n.url,dataType:"json",method:"get",data:m,success:function(v){k=!0;h=[];for(var p=0;p<v.length;p++)k&=0===v[p].count,0!==v[p].count&&h.push(v[p].type);r=m;k?(a("#duplicate_name_error_box").hide(),q.submit()):y()}});return!1})}})();
