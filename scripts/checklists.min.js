...
g){g.dpDiv.addClass("NoYearDatePicker")},onClose:function(k,g){g.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});d.dateFormat=b;p.datepicker(a.extend({},a.datepicker.regional[n],d)).prop("autocomplete","off")},t=function(p){a.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+p+".min.js",function(){m[p]=!0;a.each(c[p],function(){l.call(this)});delete c[p]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var p=
