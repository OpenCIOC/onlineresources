window.CIOC={};
(function(a,b){b.do_drop_down_navigation=function(){for(var e=a.getElementById("ActionList").options,f=0;f<e.length;f++)if(e[f].selected){var g=e[f].getAttribute("href");g&&("undefined"!=typeof e[f].attributes.newwindow?b.open(g):b.location.href=g);break}};jQuery(function(e){e("[data-toggle=dialog]").each(function(){var f=e(this),g=e(f.data("target")),m={autoOpen:!1,title:g.data("title"),modal:g.data("modal")};g.dialog(m);f.click(function(){g.dialog("isOpen")?g.dialog("close"):g.dialog("open")})})})})(document,window);
function CheckAll(a,b){a||="IDList";var e=b;b||(e=document.RecordList);b=e.elements.length;for(var f=0;f<b;f++){var g=e.elements[f];g.name===a&&(g.checked=!0)}}function ClearAll(a,b){a||="IDList";var e=b;b||(e=document.RecordList);b=e.elements.length;for(var f=0;f<b;f++){var g=e.elements[f];g.name===a&&(g.checked=!1)}}function add_class(a,b){a&&!(new RegExp("\\b"+b+"\\b")).test(a.className)&&(a.className&&(b=" "+b),a.className+=b)}
function remove_class(a,b){if(a){for(var e=a.className.split(" "),f=[],g=0;g<e.length;g++){var m=e[g];m!==b&&f.push(m)}a.className=f.join(" ")}}function hide(a){add_class(a,"NotVisible")}function show(a){remove_class(a,"NotVisible")}function openWin(a,b){window.open(a,b,"toolbar=no,width=490,height=485,location=no,scrollBars=yes,resizable=no,titlebar=yes").focus()}
...
(function(){var a=jQuery,b={},e=function(d){null!==d&&"undefined"!==typeof d?a("#myListCount").text(d):(d=a("#myListCount").text())&&(d=parseInt(d,10));d?b.myListLink.show():b.myListLink.hide()},f=function(d){a.each(d,function(p,q){a("#added_to_list_"+q).show();a("#add_to_list_"+q).hide()})},g=function(d){return function(p){p.fail?alert(p.errinfo):(p.ids?e(a.grep(p.ids,c[b.domain]).length):p.count?e(p.count):e(0),f([d]))}},m=function(d){d=a(d.currentTarget).data("id");a.ajax({success:g(d),dataType:"json",
...
c[b.domain]);f(p);e(p.length);(d=d.previous_ids)&&a.each(d,function(q,u){a("#ct_added_to_previous_request_"+u).show()});a(".ListUI img").prop("src",function(q,u){return u.replace("list","referral")});a("#list_header_text").hide();a("#ct_header_text").show();b.current_list_url=b.ct_update_url;h()}else n()},n=function(){var d=function(){b.list_view_mode||f(b.already_added||[]);b.current_list_url=b.list_view_mode&&"ct"===b.list_view_mode?b.ct_update_url:b.list_update_url;e((b.already_added||[]).length);
...
g=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,m,t,r={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k;"function"!==typeof JSON.stringify&&(JSON.stringify=function(c,l,n){var h;t=m="";if("number"===typeof n)for(h=0;h<n;h+=1)t+=" ";else"string"===typeof n&&(t=n);if((k=l)&&"function"!==typeof l&&("object"!==typeof l||"number"!==typeof l.length))throw Error("JSON.stringify");return e("",{"":c})});
"function"!==typeof JSON.parse&&(JSON.parse=function(c,l){function n(h,d){var p,q=h[d];if(q&&"object"===typeof q)for(p in q)if(Object.hasOwnProperty.call(q,p)){var u=n(q,p);void 0!==u?q[p]=u:delete q[p]}return l.call(h,d,q)}c=String(c);f.lastIndex=0;f.test(c)&&(c=c.replace(f,function(h){return"\\u"+("0000"+h.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(c.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return c=eval("("+c+")"),"function"===typeof l?n({"":c},""):c;throw new SyntaxError("JSON.parse");})})();
(function(){window.get_form_values=function(a){var b={};jQuery(a).find("input,select,textarea").each(function(e){if(this.name)if(b[this.name]||(b[this.name]=[]),"select"===this.nodeName.toLowerCase()){var f=b[this.name];$(this).find("option").each(function(g){this.selected&&f.push(this.value)})}else("input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type||this.checked)&&b[this.name].push(this.value||"")});return b};window.restore_form_values=function(a,b){var e=jQuery;e(a).find("input,select,textarea").each(function(f){if(this.name){var g=
b[this.name];"undefined"!=typeof g&&null!==g&&("input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type?"select"===this.nodeName.toLowerCase()?e(this).find("option").each(function(m){this.selected=1<g.length?0<=e.inArray(this.value,g):0===g.length?!1:this.value===g[0]}):this.value=g.length?g[0]:"":this.checked=1<g.length?0<=e.inArray(this.value,g):0===g.length?!1:this.value===g[0])}})};window.init_cached_state=function(a){var b=jQuery;a=a||"#EntryForm";onbeforeunload_fns=
[];onbeforerestorevalues_fns=[];var e=function(){var f={form_values:get_form_values(a)};b.each(onbeforeunload_fns,function(g,m){m(f)});document.getElementById("cache_form_values").value=JSON.stringify(f)};document.addEventListener("visibilitychange",function(){"hidden"==document.visibilityState&&e()});document.addEventListener("freeze",e);window.addEventListener("pagehide",e);window.cache_register_onbeforeunload=function(f){onbeforeunload_fns.push(f)};window.cache_register_onbeforerestorevalues=function(f){onbeforerestorevalues_fns.push(f)};
window.restore_cached_state=function(){b(window).on("pageshow",function(f){if(!f.originalEvent.persisted&&(f=document.getElementById("cache_form_values"))&&f.value){var g=JSON.parse(f.value);b.each(onbeforerestorevalues_fns,function(m,t){t(g)});restore_form_values(a,g.form_values)}})}}})();
(function(){var a=jQuery,b={"en-CA":"d M yy",de:"dd.mm.yy",fr:"d M yy",it:"d M yy",nl:"d M yy",no:"d M yy",pt:"d-mm-yy",sv:"d M yy",hu:"M d. yy",ro:"d M yy",hr:"d M yy",sl:"d M yy",bg:"d MM yy",ru:"d M yy",tr:"d M yy",lv:"d M yy",lt:"d M yy",ko:"yy/mm/dd","zh-CN":"yy/mm/dd",th:"d M yy"},e={"en-CA":!0,"":!0},f={},g={"fr-CA":"fr","es-MX":"es"},m=function(){var r=a(this),k=r.data("culture"),c=b[k]||a.datepicker.regional[k].dateFormat,l={};r.hasClass("NoYear")&&(c=c.replace(/[\- .\/]*yy[\/]?/,""),l={beforeShow:function(n,
h){h.dpDiv.addClass("NoYearDatePicker")},onClose:function(n,h){h.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});l.dateFormat=c;r.datepicker(a.extend({},a.datepicker.regional[k],l)).prop("autocomplete","off")},t=function(r){a.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+r+".min.js",function(){e[r]=!0;a.each(f[r],function(){m.call(this)});delete f[r]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var r=
a(this);var k=r.parents("[lang]").first().prop("lang")||"en-CA";k=g[k]||k;r.data("culture",k);e[k]?m.call(this):(r=f[k],r||(r=f[k]=[],t(k)),r.push(this))})}});jQuery(function(){a("input.DatePicker").autodatepicker()})})();
CIOC.initFindAndReplaceCheckList=function(){CIOC.frChk={};var a=jQuery,b="",e="",f="",g=function(){document.getElementById("CheckListType").selectedIndex=0;document.getElementById("CheckListItem1Block").innerHTML="&nbsp;";document.getElementById("CheckListItem2Block").innerHTML="&nbsp;";document.getElementById("CheckListNoteBlock").innerHTML=e;t()},m=function(){for(var k=document.getElementById("CheckListType").value,c="ac cm fd ft ln scha sche sm toc".split(" "),l=!1,n=0;n<c.length;n++)if(c[n]==
k){l=!0;break}c=document.getElementById("CheckListItem1");n=document.getElementById("CheckListItem2");l&&(c&&0==c.selectedIndex&&n&&0!=n.selectedIndex||"sm"==k)?document.getElementById("CheckListNote")||(document.getElementById("CheckListNoteBlock").innerHTML=f):document.getElementById("CheckListNoteBlock").innerHTML=e},t=function(){var k=document.getElementById("CheckListItem1"),c=document.getElementById("CheckListItem2"),l=document.getElementById("CheckListType").value;m();r();"sm"==l&&(0!=k.selectedIndex?
...
g()});a(document).on("paste keyup","#CheckListNote",r);a(document).on("select change","#CheckListItem1Block, #CheckListItem2Block",t);g()}}();
CIOC.initFindAndReplaceName=function(){function a(){return 0==document.getElementById("NameField").selectedIndex?(alert(b),!1):document.getElementById("FindText").value==document.getElementById("ReplaceText").value?(alert(e),!1):!0}var b="",e="";return function(f,g){b=f;e=g;document.getElementById("NameField").selectedIndex=0;document.getElementById("ReplaceWith").innerHTML="&nbsp;";$("#NameForm").submit(a);var m=$("#NameField").change(function(){var t=m.find("option:selected").data("replacewithui")||
"&nbsp;";$("#ReplaceWith").html(t)})}}();
