...
h){h.dpDiv.addClass("NoYearDatePicker")},onClose:function(n,h){h.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});l.dateFormat=c;r.datepicker(a.extend({},a.datepicker.regional[k],l)).prop("autocomplete","off")},t=function(r){a.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+r+".min.js",function(){e[r]=!0;a.each(g[r],function(){m.call(this)});delete g[r]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var r=
