...
b.in_request?c.ajax({success:m,dataType:"json",error:null,type:"POST",url:b.in_request}):q()}})();this.JSON||(this.JSON={});
(function(){function c(a){return 10>a?"0"+a:a}function a(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var b=h[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(c,d){var e,h,r,u,t=g,s,p=d[c];p&&"object"===typeof p&&"function"===typeof p.toJSON&&(p=p.toJSON(c));"function"===typeof l&&(p=l.call(d,c,p));switch(typeof p){case "string":return a(p);case "number":return isFinite(p)?String(p):"null";case "boolean":case "null":return String(p);
case "object":if(!p)return"null";g+=f;s=[];if("[object Array]"===Object.prototype.toString.apply(p)){u=p.length;for(e=0;e<u;e+=1)s[e]=b(e,p)||"null";r=0===s.length?"[]":g?"[\n"+g+s.join(",\n"+g)+"\n"+t+"]":"["+s.join(",")+"]";g=t;return r}if(l&&"object"===typeof l)for(u=l.length,e=0;e<u;e+=1)h=l[e],"string"===typeof h&&(r=b(h,p))&&s.push(a(h)+(g?": ":":")+r);else for(h in p)Object.hasOwnProperty.call(p,h)&&(r=b(h,p))&&s.push(a(h)+(g?": ":":")+r);r=0===s.length?"{}":g?"{\n"+g+s.join(",\n"+g)+"\n"+
t+"}":"{"+s.join(",")+"}";g=t;return r}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(a){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+c(this.getUTCMonth()+1)+"-"+c(this.getUTCDate())+"T"+c(this.getUTCHours())+":"+c(this.getUTCMinutes())+":"+c(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
...
x=!1;"boolean"===typeof f&&(x=f,f=arguments[1]||{},h=2);for("object"===typeof f||q(f)||(f={});h<y;h++)if(null!=(b=arguments[h]))for(c in b)d=f[c],e=b[c],f!==e&&(x&&e&&(n(e)||(g=m(e)))?(g?(g=!1,d=d&&m(d)?d:[]):d=d&&n(d)?d:{},f[c]=k(x,d,e)):e!==a&&(f[c]=e));return f};m=Array.isArray||function(a){return"[object Array]"===Object.prototype.toString.call(a)};q=function(a){return"[object Function]"===Object.prototype.toString.call(a)};n=function(a){return"[object Object]"===Object.prototype.toString.call(a)};
r=function(a,b){return 0===a.indexOf(b)};u=function(a){return(a+"").replace(f,"")};t=function(a){return isNaN(a)?NaN:Math[0>a?"ceil":"floor"](a)};s=function(a,b,c){var d;for(d=a.length;d<b;d+=1)a=c?"0"+a:a+"0";return a};p=function(a,b){for(var c=0,d=!1,e=0,g=a.length;e<g;e++){var f=a.charAt(e);switch(f){case "'":d?b.push("'"):c++;d=!1;break;case "\\":d&&b.push("\\");d=!d;break;default:b.push(f),d=!1}}return c};x=function(a,b){b=b||"F";var c;c=a.patterns;var d=b.length;if(1===d){c=c[b];if(!c)throw"Invalid date format string '"+
b+"'.";b=c}else 2===d&&"%"===b.charAt(0)&&(b=b.charAt(1));return b};D=function(a,b,c){function d(a,b){var c;c=a+"";return 1<b&&c.length<b?(c=r[b-2]+c,c.substr(c.length-b,b)):c}function e(){if(m||B)return m;m=n.test(b);B=!0;return m}function g(a,b){if(t)return t[b];switch(b){case 0:return a.getFullYear();case 1:return a.getMonth();case 2:return a.getDate();default:throw"Invalid part value "+b;}}var f=c.calendar,y=f.convert;if(!b||!b.length||"i"===b){if(c&&c.name.length)if(y)c=D(a,f.patterns.F,c);else{c=
new Date(a.getTime());var h=z(a,f.eras);c.setFullYear(F(a,f,h));c=c.toLocaleString()}else c=a.toString();return c}var h=f.eras,l="s"===b;b=x(f,b);c=[];var k,r=["0","00","000"],m,B,n=/([^d]|^)(d|dd)([^d]|$)/g,u=0,q=v(),t;for(!l&&y&&(t=y.fromGregorian(a));;){k=q.lastIndex;y=q.exec(b);k=b.slice(k,y?y.index:b.length);u+=p(k,c);if(!y)break;if(u%2)c.push(y[0]);else switch(k=y[0],y=k.length,k){case "ddd":case "dddd":c.push((3===y?f.days.namesAbbr:f.days.names)[a.getDay()]);break;case "d":case "dd":m=!0;
c.push(d(g(a,2),y));break;case "MMM":case "MMMM":k=g(a,1);c.push(f.monthsGenitive&&e()?f.monthsGenitive[3===y?"namesAbbr":"names"][k]:f.months[3===y?"namesAbbr":"names"][k]);break;case "M":case "MM":c.push(d(g(a,1)+1,y));break;case "y":case "yy":case "yyyy":k=t?t[0]:F(a,f,z(a,h),l);4>y&&(k%=100);c.push(d(k,y));break;case "h":case "hh":k=a.getHours()%12;0===k&&(k=12);c.push(d(k,y));break;case "H":case "HH":c.push(d(a.getHours(),y));break;case "m":case "mm":c.push(d(a.getMinutes(),y));break;case "s":case "ss":c.push(d(a.getSeconds(),
y));break;case "t":case "tt":k=12>a.getHours()?f.AM?f.AM[0]:" ":f.PM?f.PM[0]:" ";c.push(1===y?k.charAt(0):k);break;case "f":case "ff":case "fff":c.push(d(a.getMilliseconds(),3).substr(0,y));break;case "z":case "zz":k=a.getTimezoneOffset()/60;c.push((0>=k?"+":"-")+d(Math.floor(Math.abs(k)),y));break;case "zzz":k=a.getTimezoneOffset()/60;c.push((0>=k?"+":"-")+d(Math.floor(Math.abs(k)),2)+":"+d(Math.abs(a.getTimezoneOffset()%60),2));break;case "g":case "gg":f.eras&&c.push(f.eras[z(a,h)].name);break;
case "/":c.push(f["/"]);break;default:throw"Invalid date format pattern '"+k+"'.";}}return c.join("")};(function(){var a;a=function(a,b,c){var d=c.groupSizes,e=d[0],g=1,f=Math.pow(10,b),f=Math.round(a*f)/f;isFinite(f)||(f=a);a=f+"";var f="",f=a.split(/e/i),w=1<f.length?parseInt(f[1],10):0;a=f[0];f=a.split(".");a=f[0];f=1<f.length?f[1]:"";0<w?(f=s(f,w,!1),a+=f.slice(0,w),f=f.substr(w)):0>w&&(w=-w,a=s(a,w+1,!0),f=a.slice(-w,a.length)+f,a=a.slice(0,-w));f=0<b?c["."]+(f.length>b?f.slice(0,b):s(f,b)):
"";b=a.length-1;c=c[","];for(w="";0<=b;){if(0===e||e>b)return a.slice(0,b+1)+(w.length?c+w+f:f);w=a.slice(b-e+1,b+1)+(w.length?c+w:"");b-=e;g<d.length&&(e=d[g],g++)}return a.slice(0,b+1)+c+w+f};A=function(b,c,d){if(!isFinite(b))return Infinity===b?d.numberFormat.positiveInfinity:-Infinity===b?d.numberFormat.negativeInfinity:d.numberFormat.NaN;if(!c||"i"===c)return d.name.length?b.toLocaleString():b.toString();c=c||"D";d=d.numberFormat;var e=Math.abs(b),g=-1;1<c.length&&(g=parseInt(c.slice(1),10));
var f=c.charAt(0).toUpperCase(),h;switch(f){case "D":c="n";e=t(e);-1!==g&&(e=s(""+e,g,!0));0>b&&(e="-"+e);break;case "N":h=d;case "C":h=h||d.currency;case "P":h=h||d.percent;c=0>b?h.pattern[0]:h.pattern[1]||"n";-1===g&&(g=h.decimals);e=a(e*("P"===f?100:1),g,h);break;default:throw"Bad number format specifier: "+f;}b=/n|\$|-|%/g;for(h="";;){g=b.lastIndex;f=b.exec(c);h+=c.slice(g,f?f.index:c.length);if(!f)break;switch(f[0]){case "n":h+=e;break;case "$":h+=d.currency.symbol;break;case "-":/[1-9]/.test(e)&&
(h+=d["-"]);break;case "%":h+=d.percent.symbol}}return h}})();v=function(){return/\/|dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|y|hh|h|HH|H|mm|m|ss|s|tt|t|fff|ff|f|zzz|zz|z|gg|g/g};z=function(a,b){if(!b)return 0;for(var c,d=a.getTime(),e=0,g=b.length;e<g;e++)if(c=b[e].start,null===c||d>=c)return e;return 0};F=function(a,b,c,d){a=a.getFullYear();!d&&b.eras&&(a-=b.eras[c].offset);return a};(function(){var a,b,c,d,e,g,f;a=function(a,b){if(100>b){var c=new Date,d=z(c),c=F(c,a,d),d=a.twoDigitYearMax,d="string"===
...
k[1]:k[0],b));return a};d=function(a,b){var c=a._parseRegExp;if(c){var d=c[b];if(d)return d}else a._parseRegExp=c={};for(var d=x(a,b).replace(/([\^\$\.\*\+\?\|\[\]\(\)\{\}])/g,"\\\\$1"),e=["^"],g=[],f=0,w=0,h=v(),k;null!==(k=h.exec(d));){var C=d.slice(f,k.index),f=h.lastIndex,w=w+p(C,e);if(w%2)e.push(k[0]);else{var C=k[0],K=C.length;switch(C){case "dddd":case "ddd":case "MMMM":case "MMM":case "gg":case "g":C="(\\D+)";break;case "tt":case "t":C="(\\D*)";break;case "yyyy":case "fff":case "ff":case "f":C=
"(\\d{"+K+"})";break;case "dd":case "d":case "MM":case "M":case "yy":case "y":case "HH":case "H":case "hh":case "h":case "mm":case "m":case "ss":case "s":C="(\\d\\d?)";break;case "zzz":C="([+-]?\\d\\d?:\\d{2})";break;case "zz":case "z":C="([+-]?\\d\\d?)";break;case "/":C="(\\/)";break;default:throw"Invalid date format pattern '"+C+"'.";}C&&e.push(C);g.push(k[0])}}p(d.slice(f),e);e.push("$");d={regExp:e.join("").replace(/\s+/g,"\\s+"),groups:g};return c[b]=d};e=function(a,b,c){return a<b||a>c};g=function(a){return a.split("\u00a0").join(" ").toUpperCase()};
f=function(a){for(var b=[],c=0,d=a.length;c<d;c++)b[c]=g(a[c]);return b};B=function(g,f,h){g=u(g);h=h.calendar;f=d(h,f);var k=(new RegExp(f.regExp)).exec(g);if(null===k)return null;var x=f.groups,l=f=g=null,p=null,m=null,B=0,n,q=0,t=0,D=0;n=null;for(var I=!1,s=0,E=x.length;s<E;s++){var A=k[s+1];if(A){var v=x[s],G=v.length,z=parseInt(A,10);switch(v){case "dd":case "d":p=z;if(e(p,1,31))return null;break;case "MMM":case "MMMM":l=c(h,A,3===G);if(e(l,0,11))return null;break;case "M":case "MM":l=z-1;if(e(l,
0,11))return null;break;case "y":case "yy":case "yyyy":f=4>G?a(h,z):z;if(e(f,0,9999))return null;break;case "h":case "hh":B=z;12===B&&(B=0);if(e(B,0,11))return null;break;case "H":case "HH":B=z;if(e(B,0,23))return null;break;case "m":case "mm":q=z;if(e(q,0,59))return null;break;case "s":case "ss":t=z;if(e(t,0,59))return null;break;case "tt":case "t":I=h.PM&&(A===h.PM[0]||A===h.PM[1]||A===h.PM[2]);if(!I&&(!h.AM||A!==h.AM[0]&&A!==h.AM[1]&&A!==h.AM[2]))return null;break;case "f":case "ff":case "fff":D=
z*Math.pow(10,3-G);if(e(D,0,999))return null;break;case "ddd":case "dddd":m=b(h,A,3===G);if(e(m,0,6))return null;break;case "zzz":v=A.split(/:/);if(2!==v.length)return null;n=parseInt(v[0],10);if(e(n,-12,13))return null;v=parseInt(v[1],10);if(e(v,0,59))return null;n=60*n+(r(A,"-")?-v:v);break;case "z":case "zz":n=z;if(e(n,-12,13))return null;n*=60;break;case "g":case "gg":if(!A||!h.eras)return null;A=u(A.toLowerCase());v=0;for(G=h.eras.length;v<G;v++)if(A===h.eras[v].name.toLowerCase()){g=v;break}if(null===
g)return null}}}k=new Date;x=(s=h.convert)?s.fromGregorian(k)[0]:k.getFullYear();null===f?f=x:h.eras&&(f+=h.eras[g||0].offset);null===l&&(l=0);null===p&&(p=1);if(s){if(k=s.toGregorian(f,l,p),null===k)return null}else if(k.setFullYear(f,l,p),k.getDate()!==p||null!==m&&k.getDay()!==m)return null;I&&12>B&&(B+=12);k.setHours(B,q,t,D);null!==n&&(h=k.getMinutes()-(n+k.getTimezoneOffset()),k.setHours(k.getHours()+parseInt(h/60,10),h%60));return k}})();E=function(a,b,c){var d=b["-"];b=b["+"];var e;switch(c){case "n -":d=
" "+d,b=" "+b;case "n-":l(a,d)?e=["-",a.substr(0,a.length-d.length)]:l(a,b)&&(e=["+",a.substr(0,a.length-b.length)]);break;case "- n":d+=" ",b+=" ";case "-n":r(a,d)?e=["-",a.substr(d.length)]:r(a,b)&&(e=["+",a.substr(b.length)]);break;case "(n)":r(a,"(")&&l(a,")")&&(e=["-",a.substr(1,a.length-2)])}return e||["",a]};b.prototype.findClosestCulture=function(a){return b.findClosestCulture.call(this,a)};b.prototype.format=function(a,c,d){return b.format.call(this,a,c,d)};b.prototype.localize=function(a,
...
b.pri?1:a.pri>b.pri?-1:0});for(g=0;g<f;g++)if(c=h[g].lang,b=d[c])return b;for(g=0;g<f;g++){c=h[g].lang;do{e=c.lastIndexOf("-");if(-1===e)break;c=c.substr(0,e);if(b=d[c])return b}while(1)}for(g=0;g<f;g++){c=h[g].lang;for(var k in d)if(e=d[k],e.language==c)return e}}else if("object"===typeof a)return a;return b||null};b.format=function(a,b,c){c=this.findClosestCulture(c);a instanceof Date?a=D(a,b,c):"number"===typeof a&&(a=A(a,b,c));return a};b.localize=function(a,b){return this.findClosestCulture(b).messages[a]||
this.cultures["default"].messages[a]};b.parseDate=function(a,b,c){c=this.findClosestCulture(c);var d,e;if(b){if("string"===typeof b&&(b=[b]),b.length){e=0;for(var g=b.length;e<g;e++){var f=b[e];if(f&&(d=B(a,f,c)))break}}}else for(e in b=c.calendar.patterns,b)if(d=B(a,b[e],c))break;return d||null};b.parseInt=function(a,c,d){return t(b.parseFloat(a,c,d))};b.parseFloat=function(a,b,c){"number"!==typeof b&&(c=b,b=10);var f=this.findClosestCulture(c);c=NaN;var h=f.numberFormat;-1<a.indexOf(f.numberFormat.currency.symbol)&&
(a=a.replace(f.numberFormat.currency.symbol,""),a=a.replace(f.numberFormat.currency["."],f.numberFormat["."]));a=u(a);if(e.test(a))c=parseFloat(a);else if(!b&&d.test(a))c=parseInt(a,16);else{f=E(a,h,h.pattern[0]);b=f[0];f=f[1];""===b&&"(n)"!==h.pattern[0]&&(f=E(a,h,"(n)"),b=f[0],f=f[1]);""===b&&"-n"!==h.pattern[0]&&(f=E(a,h,"-n"),b=f[0],f=f[1]);b=b||"+";var k;a=f.indexOf("e");0>a&&(a=f.indexOf("E"));0>a?(k=f,a=null):(k=f.substr(0,a),a=f.substr(a+1));var x=h["."],l=k.indexOf(x);0>l?(f=k,k=null):(f=
k.substr(0,l),k=k.substr(l+x.length));x=h[","];f=f.split(x).join("");l=x.replace(/\u00A0/g," ");x!==l&&(f=f.split(l).join(""));b+=f;null!==k&&(b+="."+k);null!==a&&(h=E(a,h,"-n"),b+="e"+(h[0]||"+")+h[1]);g.test(b)&&(c=parseFloat(b))}return c};b.culture=function(a){"undefined"!==typeof a&&(this.cultureSelector=a);return this.findClosestCulture(a)||this.cultures["default"]}})(this);
(function(){var c=null,a=null,b=[59.888937,-101.601562],d=null,e=null,g=!0,f=null,h=null,l=function(){a.setCenter(new google.maps.LatLng(b[0],b[1]),2)},k=function(){e&&e.setMap(null);e=null;h&&(google.maps.event.removeListener(h),h=null)},m=function(a,b){document.getElementById("LATITUDE").value=Globalize.format(a,"n6");document.getElementById("LONGITUDE").value=Globalize.format(b,"n6")},q=function(b,c){var d=new google.maps.LatLng(b,c);g&&a.setZoom(14);a.setCenter(d);g=!1;d=new google.maps.Marker({position:d,
map:a,clickable:!1,draggable:draggable});k();e=d;draggable&&(h=google.maps.event.addListener(d,"dragend",n))},n=function(){$("#GEOCODE_TYPE_SITE_REFRESH, #GEOCODE_TYPE_INTERSECTION_REFRESH").addClass("NotVisible");$("#GEOCODE_TYPE_MANUAL").prop("checked",!0);var a=this.getPosition();m(a.lat(),a.lng())},r=function(a){a&&(f=z,m(a.lat(),a.lng()),q(a.lat(),a.lng()))},u=function(a){var b=null;switch(a){case google.maps.GeocoderStatus.ZERO_RESULTS:b=pageconstants.txt_geocode_unknown_address;break;case google.maps.GeocoderStatus.REQUEST_DENIED:b=
pageconstants.txt_geocode_map_key_fail;break;case google.maps.GeocoderStatus.OVER_QUERY_LIMIT:b=pageconstants.txt_geocode_too_many_queries;break;default:b=pageconstants.txt_geocode_unknown_error+a}return b};window.get_response_message=u;var t=function(a){return function(b,c){c!==google.maps.GeocoderStatus.OK?a(null,c):a(b[0].geometry.location,c)}};window.handle_geocode=t;var s=function(){var b={zoom:13,mapTypeId:google.maps.MapTypeId.ROADMAP};c=document.getElementById("map_canvas");a=new google.maps.Map(c,
b);l();d||(d=new google.maps.Geocoder);var b=$("#LATITUDE")[0].value,e=$("#LONGITUDE")[0].value;b&&e&&q(Globalize.parseFloat(b),Globalize.parseFloat(e))},p=[],x=!1;window.maps_loaded=function(){x=!0;$.each(p,function(a,b){b()});p=[]};window.add_maps_loaded_callback=function(a){x?a():p.push(a)};window.initialize_maps=function(a,b,c,d){if(!window.cioc_map_script_added){window.cioc_map_script_added=!0;Globalize.culture(a);var e="";d&&(e="&libraries=places");$.getScript("//maps.googleapis.com/maps/api/js?v=3&"+
b+"&sensor=false&callback=maps_loaded&language="+a+e)}add_maps_loaded_callback(c)};var D=function(a,b){return t(function(c,d){c?(b&&$("#geocode_no_postal_code").show(),a(c)):d==google.maps.GeocoderStatus.ZERO_RESULTS&&!b&&document.getElementById("GEOCODE_TYPE_SITE").checked?B(a,!0):(alert(u(d)),a(null))})},A=function(a){var b=document.getElementById("EntryForm"),c=[];if(!b.SITE_STREET_NUMBER)return null;var d=[b.SITE_STREET_NUMBER.value,b.SITE_STREET.value,b.SITE_STREET_TYPE.value,b.SITE_STREET_DIR.value].join(" "),
...
b.push(e):b.push("Canada");return b.join(", ")},z=null,F=function(a,b,c){z=a;c=D(b,c);(z=a)?d.geocode({address:a},c):(k(),m("",""));a?$("#geocode_no_postal_code").hide():b(null)},B=function(a,b){var c=A(b);F(c,a,b)},E=function(a){var b=v();F(b,a)};window.handle_geocode_entryform_feedback=function(a,b){"undefined"!=typeof a&&null!==a&&"undefined"!=typeof b&&null!==b&&(f=z,r(google.maps.LatLng(Globalize.parseFloat(a),Globalize.parseFloat(b))))};var w=function(a){r(a)},J=function(b){H(!1);$("#GEOCODE_TYPE_SITE_REFRESH,#GEOCODE_TYPE_INTERSECTION_REFRESH").hide();
e||b||B(function(b){b?r(b):(g=!1,b=a.getCenter(),b=b.toUrlValue().split(","),m.apply(null,b),q.apply(null,b),z=f=null)})};window.do_geocode_type_manual=J;var H=function(a){var b=document.getElementById("map_refresh_ui_area");b&&(document.getElementById("LONGITUDE").readOnly=a,(document.getElementById("LATITUDE").readOnly=a)?$(b).hide():$(b).show())};window.entryform_maps_loaded=function(){draggable=!0;s();var a=$("#GEOCODE_TYPE_INTERSECTION_REFRESH"),b=$("#GEOCODE_TYPE_SITE_REFRESH");$("#GEOCODE_TYPE_SITE").click(function(){a.hide();
b.show();H(!0);B(r)});$("#GEOCODE_TYPE_INTERSECTION").click(function(){a.show();b.hide();H(!0);E(r)});$("#GEOCODE_TYPE_MANUAL").click(function(){J(!1)});$("#GEOCODE_TYPE_BLANK").click(function(){$("#GEOCODE_TYPE_SITE_REFRESH,#GEOCODE_TYPE_INTERSECTION_REFRESH").hide();H(!0);k();l();g=!0;$("#geocode_no_postal_code").hide();m("","");f=z=null});b.click(function(){B(r)});a.click(function(){E(r)});var d=document.EntryForm,e=document.getElementById("map_refresh");e&&$(e).click(function(){q(Globalize.parseFloat(d.LATITUDE.value),
Globalize.parseFloat(d.LONGITUDE.value))});d.SITE_STREET_NUMBER?document.getElementById("GEOCODE_TYPE_SITE").checked&&(B(w),b.show()):(d.GEOCODE_TYPE_SITE.disabled=!0,b.hide());d.INTERSECTION?document.getElementById("GEOCODE_TYPE_INTERSECTION").checked&&(E(w),a.show()):(d.GEOCODE_TYPE_INTERSECTION.disabled=!0,b.hide());H(!d.GEOCODE_TYPE_MANUAL.checked);$(d).submit(function(a){var b=null,d=null;document.getElementById("GEOCODE_TYPE_SITE").checked?(b=A(),d=pageconstants.txt_geocode_address_changed):
...
k(d,e,f,"")});c(document).on("click",".FieldHistoryJump",function(a){a=c(a.currentTarget).data("fieldname");(a=document.getElementById("FIELD_"+a))&&a.scrollIntoView(!0)});c(document).on("click",".HistoryFieldsToggle",function(a){c(a.currentTarget).parent().children("ul").toggle("fast")});var q=function(){c(".HistoryFieldsToggle").parent().children("ul").hide()};c(".HistorySummary").click(function(){var b=c(this).data("cioclang"),d=c(this).data("ciocid");c("#revision_history").html("Loading...").load(a.revhistory_url.replace("[ID]",
d).replace("[LANG]",b),q).dialog("open")});c("#revision_history").dialog({autoOpen:!1,width:330,height:280,position:["right","top"],resizable:!1,dialogClass:"RevHistory"});c("#field_history").dialog({autoOpen:!1,width:620,height:280,position:["right","bottom"]});c(".RevHistory.ui-dialog").css({position:"fixed"})}})();
...
b("#"+e+"_error").hide("slow",function(){b(this).remove()})},q=null,n=null;(function(a){b.isArray(a)?(n=function(c,e){var f=new RegExp(b.ui.autocomplete.escapeRegex(string_ci_ai(c.term)));e(b.grep(a,function(a){return f.test(string_ci_ai(a[d.match_prop]||a))}))},q=function(c,e){var f=string_ci_ai(c),g=b.grep(a,function(a){return string_ci_ai(string_ci_ai(a[d.match_prop]||a))===f});if(1===g.length)return e(g[0]),!0;e()}):"string"===typeof a?(n=create_caching_source_fn(b,a,k,d.match_prop),q=function(a,
c,e){var f=string_ci_ai(a);if(k.content){var g=b.grep(k.content,function(a){return string_ci_ai(a[d.match_prop])===f});if(1===g.length){c(g[0]);return}}e||string_ci_ai(k.term||"")===f?c():n({term:f},function(b){q(a,c,!0)})}):(n=a,q=d.look_for_fn)})(g);f.on("click","#add_"+e,function(a){a=b("#NEW_"+e);var c=a.data("chkid"),f=a.data("display"),g=a.data("label"),h=a[0].value;if(c&&f&&f==h)return l(c,f,g),m(),!1;q(a[0].value,function(a){a?(l(a.chkid,a.value,a.label),m()):0===b("#"+e+"_error").length&&
...
m.test(a)});var q=null;c.validator.addMethod("url",function(a,b){q||(q=/^((\d{1,3}(\.\d{1,3}){3})|([\w_\-]+(\.[\w\._\-]+)*)(:[0-9]+)?((\/|\?)[^\s]*)?)$/);return this.optional(b)||q.test(a)});var n=null;c.validator.addMethod("protourl",function(a,b){n||(n=/^(https?:\/\/)?((\d{1,3}(\.\d{1,3}){3})|([\w_\-]+(\.[\w\._\-]+)*)(:[0-9]+)?((\/|\?)[^\s]*)?)$/);return this.optional(b)||n.test(a)});var r=null;c.validator.addMethod("posint",function(a,b){r||(r=/^\d+$/);return this.optional(b)||r.test(a)});var u=
null;c.validator.addMethod("posdbl",function(a,b){if(!u){var c="\\.";"fr-CA"===l&&(c=",");u=new RegExp("^((\\d+)|(\\d*"+c+"\\d+))$")}return this.optional(b)||u.test(a)});var t=null;c.validator.addMethod("record-num",function(a,b){t||(t=/^[A-Z]{3}[0-9]{4,5}$/);return this.optional(b)||t.test(a)});c.validator.addMethod("unique",function(a,b,d){if(!a)return!0;a=string_ci_ai(a);b=jQuery.validator.format("[name!='{0}'][unique='{1}']",b.name,d);var e=[];c(b).each(function(b,d){a==string_ci_ai(c(d).val())&&
...
break;case "FORMER_ORG":f=f.not("input:checkbox").not("[name^=FORMER_ORG_DATE]");break;case "FEES":f=f.not("input:text").add("#FEE_ASSISTANCE_FOR, #FEE_ASSISTANCE_FROM");break;case "VACANCY_INFO":f=f.filter("[name!=VUT_ID]")}(e=k(f))&&d.children("div.required-notice").hide();return e},"Field Required");var s=c('<div id="a_test"></div>').dialog({autoOpen:!1,title:d,closeOnEscape:!1,position:["right","bottom"],resizable:!1,dialogClass:"ValidationErrors"}),p=c("#validation_error_box");c(document).on("click",
...
"require-group":"Ce champ est requis.",unique:"Une valeur unique est requise."}):jQuery.extend(jQuery.validator.messages,{protourl:"Please enter a valid URL.",posint:"Please enter a positive number.",posdbl:"Please enter a positive number.","record-num":"Please enter a valid record number.","require-group":"Field Required.",unique:"A unique value is required."});return e};window.init_record_type_form=function(a,b,d){var l=null,k=null,m={},q="ORG_LEVEL_1 ORG_LEVEL_2 ORG_LEVEL_3 ORG_LEVEL_4 ORG_LEVEL_5 LOCATION_NAME SERVICE_NAME_LEVEL_1 SERVICE_NAME_LEVEL_2".split(" "),
n=function(){c("#RecordTypeName").html(k);c.each(q,function(a){var b=d[a],e=c("#"+a);e.length&&(e[0].value=b)&&(c("#"+a+"_DISPLAY").text(b),c("#HIDDEN_"+e).prop("value",b))});c("#RECORD_TYPE").prop("value",l[0].value);e()},r=function(){var d=l[0].value;l.data("hasform")||(d=null);l=c(this).find("option:selected");var h=l[0].value;l.data("hasform")||(h=null);h!==d?(m[d]=c("#copyFieldsForm").contents().detach(),m[h]?(c("#copyFieldsForm").append(m[h]),c("#RECORD_TYPE").prop("value",l[0].value)):c("#copyFieldsForm").load(b+
" #copyFieldsInner",{NUM:a,RT:h||l[0].value},n)):e()};jQuery(function(){k=c("#RecordTypeName").html();var a=c("#RECORD_TYPE");c(document).on("change","#RECORD_TYPE",r);l=a.find("option:selected");e()})};window.init_validate_duplicate_org_names=function(a){var b=c.extend({selector:"#EntryForm",fields:"#ORG_LEVEL_1,#ORG_LEVEL_2,#ORG_LEVEL_3,#ORG_LEVEL_4,#ORG_LEVEL_5,#LOCATION_NAME,#SERVICE_NAME_LEVEL_1,#SERVICE_NAME_LEVEL_2,#OLS_SELECT input,#ORG_NUM",only_warn:!0,num:null,org_levels:[],url:null},a),
d=[],e=null!==b.num,k=[],m=c(b.selector).submit(function(a){var g,r,u=!1,t=c(b.fields).serializeArray();b.num&&t.push({name:"NUM",value:b.num});if(t.length!==d.length)u=!0;else for(g=0;g<t.length;g++)if(r=t[g],r.name!==d[g].name||r.value!==d[g].value){u=!0;break}if(!u&&e)return!0;var s=function(){b.only_warn&&confirm(b.confirm_string)?(e=!0,c("#duplicate_name_error_box").hide(),m.submit()):(c("#SUBMIT_BUTTON").prop("disabled",!1),c("#duplicate_name_error_box").show())};a.stopPropagation();a.preventDefault();
if(!u)return s(),!1;c.ajax({url:b.url,dataType:"json",method:"get",data:t,success:function(a){e=!0;k=[];for(var b=0;b<a.length;b++)e&=0===a[b].count,0!==a[b].count&&k.push(a[b].type);d=t;e?(c("#duplicate_name_error_box").hide(),m.submit()):s()}});return!1})}})();
...
(function(){window.init_entryform_notes=function(c,a,b){var d=jQuery;c.each(function(){var c=this,g=d(c),f=g.parent(),h=1,l=g.find(".EntryFormNotesUpdateIds")[0];if(l){var k=g.find(".EntryFormNotesDeleteIds")[0],m=g.find(".EntryFormNotesCancelIds")[0],q=g.find(".EntryFormNotesRestoreIds")[0],n=[],r=[],u=[],t={},s=[],p=function(a,b){n.push(a.id);l.value=n.join(",");var c=g.find(".EntryFormItemBox").length+1;template=g.data("addTmpl");new_item=d(template.replace(/\[COUNT\]/g,c).replace(/\[ID\]/g,a.id).replace(/\[MODIFIED_DATE\]/g,
...
g.append(new_item)};f.find(".EntryFormItemAdd").click(function(){var a="NEW"+h++;p({id:a},!0)});var x=function(a){var b=a.id.split("_");a=d(a);var c=a.parents(".EntryFormNotesItem");c.find(".EntryFormItemContent").css("text-decoration","line-through");r.push(b[b.length-2]);k.value=r.join(",");c.data("actionToRestore","delete");a.parent().hide().prev().show()},D=function(a,b){var c=a.id.split("_"),e=d(a),f=e.parents(".EntryFormNotesItem"),h=f.find(".EntryFormItemContent"),k=a.id.lastIndexOf("_"),k=
a.id.substring(0,k)+"_CANCEL_REASON",c=c[c.length-2];h.prepend(b.data("cancelTemplate"));u.push(c);m.value=u.join(",");t[c]=b.data("cancelType");g.append(d("<input>").prop({type:"hidden",id:k,name:k,value:b.data("cancelType")}));f.data("actionToRestore","cancel");e.parent().hide().prev().show()},A={update:function(a){a=d(a).parents(".EntryFormNotesItem");var b=a.find(".EntryFormItemContent");p(b.data("formValues"));a.hide()},"delete":x,cancel:D},v=f.find(".EntryFormItemActionMenu").menu({select:function(a,
b){d(this).hide();A[b.item.data("action")](v.data("activeButton"),b.item)}}).hide().css({position:"absolute",zIndex:1});f.on("click",".EntryFormItemAction",function(a){v.data("activeButton",this);if(v.is(":visible"))return v.hide(),!1;v.menu("blur").show();v.position({my:"right top",at:"right bottom",of:this});d(document).one("click",function(){v.hide()});return!1});f.find(".EntryFormItemViewHidden").click(function(c){c=d(this);var e=c.next();e.is(":visible")?(c.text(a),e.hide()):(c.text(b),e.show())});
var z={"delete":function(a,b,c,e){e.css("text-decoration","none");r=d.grep(r,function(b){return b!==a});k.value=r.join(",");b.parent().hide().next().show()},cancel:function(a,b,c,e){c=b[0];var f=c.id.lastIndexOf("_");c=c.id.substring(0,f)+"_CANCEL_REASON";e.find(".EntryFormItemCancelledDetails").remove();u=d.grep(u,function(b){return b!==a});m.value=u.join(",");delete t[a];d("#"+c).remove();b.parent().hide().next().show()}};f.on("click",".EntryFormItemRestoreAction",function(a){a=this.id.split("_");
var b=d(this),c=b.parents(".EntryFormNotesItem"),e=c.find(".EntryFormItemContent");z[c.data("actionToRestore")](a[a.length-2],b,c,e)});var F=function(a){a=this.id.split("_");var b=d(this);b.parents(".EntryFormNotesItem").find(".EntryFormItemCancelledDetails").css("text-decoration","line-through");b.parent().hide().prev().show();s.push(a[a.length-2]);q.value=s.join(",")};f.on("click",".EntryFormItemRestoreCancel",F);f.on("click",".EntryFormItemDontRestoreCancel",function(a){var b=this.id.split("_");
a=d(this);a.parents(".EntryFormNotesItem").find(".EntryFormItemCancelledDetails").css("text-decoration","none");a.parent().hide().next().show();b=b[b.length-2];s=d.grep(s,function(a){return a!==b});q.value=s.join(",")});cache_register_onbeforeunload(function(a){a[c.id+"_updates"]=n;a[c.id+"_deletes"]=r;a[c.id+"_restores"]=s;a[c.id+"_cancels"]=u;a[c.id+"_cancel_reason"]=t});cache_register_onbeforerestorevalues(function(a){var b=c.id.substring(0,c.id.lastIndexOf("_"))+"_";a[c.id+"_updates"]&&d.each(a[c.id+
"_updates"],function(a,c){if(0===c.indexOf("NEW"))h++,p({id:c},!0);else{var e=d("#"+b+c+"_DISPLAY");p(e.data("formValues"));d("#"+b+c+"_CONTAINER").hide()}});a[c.id+"_deletes"]&&d.each(a[c.id+"_deletes"],function(a,c){x(document.getElementById(b+c+"_ACTION"))});a[c.id+"_restores"]&&(d.each(a[c.id+"_restores"],function(a,c){F.call(document.getElementById(b+c+"_RESTORECANCEL"))}),f.find(".EntryFormItemViewHidden").click());if(a[c.id+"_cancels"]){var g=a[c.id+"_cancel_reason"];d.each(a[c.id+"_cancels"],
function(a,c){D(document.getElementById(b+c+"_ACTION"),v.find("li[data-cancel-type='"+g[c]+"']"))})}})}})}})();
...
b[d].value;c(a)})},minLength:1===e.id.slice(-1)?5:3}).keypress(function(b){13===b.keyCode&&(b.preventDefault(),a(e).autocomplete("close"))})}window.init_entryform_items=function(a,b,c){var e=jQuery;a.each(function(){var a=null,f=this,h=e(f),l=1,k=h.find(".EntryFormItemContainerIds")[0];if(k){var m=h.data("maxAdd");m&&(m=parseInt(m,10));var q=[];k.value&&(q=e.map(k.value.split(","),function(a){return 0===a.indexOf("NEW")?null:a}));var n={},r=function(){h.find(".EntryFormItemBox").each(function(a){e(this).find(".EntryFormItemCount").text(a+
1)})},u=function(a){if(m){var b=h.find(".EntryFormItemContent:hidden").parent().find("button.EntryFormItemDelete").prop("disabled",!a);p.prop("disabled",!a);a?(b.removeClass("ui-state-disabled"),p.removeClass("ui-state-disabled")):(b.addClass("ui-state-disabled"),p.addClass("ui-state-disabled"))}},t=function(){var a=0,b;for(b in n)a++;return q.length-a},s=function(b){var c=0;if(m&&!b&&(c=t(),c>=m)){alert("over");return}var d=h.data("addTmpl");q.push("NEW"+l++);k.value=q.join(",");d=e(d.replace(/\[COUNT\]/g,
q.length).replace(/\[ID\]/g,q[q.length-1]));d.find(".DatePicker").autodatepicker();d.find(".Province").combobox({source:window.cioc_province_source});entryform.service_titles&&d.find(".ServiceTitleField").combobox({source:entryform.service_titles});h.append(d);a&&(a.sortable("refresh"),r());m&&!b&&c+1===m&&u(!1)},p=h.parent().find(".EntryFormItemAdd").click(function(){s(!1)});h.on("click","button.EntryFormItemDelete",function(){var a=this,f=e(this).parents(".EntryFormItemBox").find(".EntryFormItemContent"),
g=this.id.split("_"),g=g[g.length-2];if(f.is(":visible"))f.hide("slow",function(){n[g]=get_form_values(f);e(a).text(c);f.find("input,select,textarea").each(function(){"input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type?"select"===this.nodeName.toLowerCase()?e(this).find("option").each(function(){this.selected=!1}):this.value="":this.checked=!1});u(!0)});else{var h=0;if(m&&(h=t(),h>=m)){alert("over");return}var k=n[g];k&&(delete n[g],restore_form_values(f,k),f.show("slow",
function(){e(a).text(b)}),m&&h+1===m&&u(!1))}});h.hasClass("sortable")&&(a=h.sortable({items:".EntryFormItemBox"}),a.bind("sortstart",function(a,b){b.helper.bgiframe();h.addClass("sorting")}),a.bind("sortstop",function(){var b=a.sortable("toArray");q=e.map(b,function(a){a=a.split("_");return a[a.length-2]});k.value=q.join(",");setTimeout(function(){h.removeClass("sorting");r()},1)}));cache_register_onbeforeunload(function(b){b[f.id+"_ids"]=q;b[f.id+"_deletes"]=n;a&&(b[f.id+"_order"]=a.sortable("toArray"))});
cache_register_onbeforerestorevalues(function(b){b[f.id+"_ids"]&&e.each(b[f.id+"_ids"],function(a,b){0===b.indexOf("NEW")&&s(!0)});b[f.id+"_deletes"]&&(n=b[f.id+"_deletes"],h.find(".EntryFormItemContent").each(function(){var a=this.id.split("_"),a=a[a.length-2];n[a]&&e(this).hide().parent().find("button.EntryFormItemDelete").text(c)}));m&&t()>=m&&u(!1);a&&(b=b[f.id+"_order"])&&(b.reverse(),e.each(b,function(a,b){e("#"+b).detach().prependTo(h)}),a.sortable("refresh"),r())})}})};window.init_orglevels=
...
window.init_org_num=function(a){a("#FIELD_ORG_NUM").next().on("click",".suggested-num",function(){a("#ORG_NUM").val(this.value).trigger("change");return!1})};window.init_locations_services=function(a,b){var c=function(c,d,f){var h='<li><label><input type="checkbox" name="[FIELD]" value="[VALUE]" id="[FIELD]_[VALUE]" checked> [VALUE]</label></li>'.replace(/\[FIELD\]/g,d),l=c.siblings(".locations-services-new-container"),k=l.find(".locations-services-new"),m=l.find(".locations-services-add"),q=c.siblings(".locations-services-list-suggestions"),
n=a(f);f=function(a){a[d+"_STATE"]=c.html()};var r=function(a){(a=a[d+"_STATE"])&&c.html(a)},u=function(b){var f=a("#"+d+"_"+b);f.length?f[0].checked=!0:(b=h.replace(/\[VALUE\]/g,b),c.append(a(b)))};c.length&&(cache_register_onbeforeunload(f),cache_register_onbeforerestorevalues(r));l.on("click",".locations-services-add",function(){var d=a.trim(k[0].value);if(d){if(!/^[A-Z]{3}[0-9]{4,5}$/.test(d))return c.siblings(".locations-services-error").length||a("<p>").hide().addClass("Alert").addClass("locations-services-error").append(document.createTextNode(b)).insertBefore(l).show("slow"),
!1;u(d);c.siblings(".locations-services-error").hide("slow",function(){a(this).remove()});k[0].value=""}return!1}).on("keypress",".locations-services-new",function(a){13===a.keyCode&&(a.preventDefault(),m.trigger("click"))});q.on("click",".locations-services-suggestion",function(a){a.preventDefault();u(this.value);return!1});if(n.length){var t=c.parents("tr").first(),s=function(){var b=a(this),c;this.checked?(t.show(),b.data("maybeRequired")&&(b.is(".ols-type-TOPIC,.ols-type-SERVICE")?(c=b.is(".ols-type-TOPIC")?
