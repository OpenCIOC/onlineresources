...
v){v.dpDiv.addClass("NoYearDatePicker")},onClose:function(y,v){v.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});q.dateFormat=h;l.datepicker(b.extend({},b.datepicker.regional[p],q)).prop("autocomplete","off")},d=function(l){b.getScript("https://ajax.googleapis.com/ajax/libs/jqueryui/"+b.ui.version+"/i18n/jquery.ui.datepicker-"+l+".min.js",function(){m[l]=!0;b.each(e[l],function(){c.call(this)});delete e[l]})};b.datepicker.regional["en-CA"]=b.extend({},b.datepicker.regional[""]);b.fn.extend({autodatepicker:function(){return this.each(function(){var l=
...
u+"&sensor=false&callback=maps_loaded&region=CA&language="+k+t)}add_maps_loaded_callback(C)};var J=function(k,u){return A(function(C,B){C?(u&&$("#geocode_no_postal_code").show(),k(C)):B==google.maps.GeocoderStatus.ZERO_RESULTS&&!u&&document.getElementById("GEOCODE_TYPE_SITE").checked?F(k,!0):(alert(z(B)),k(null))})},W=function(k){var u=document.getElementById("EntryForm"),C=[];if(!u.SITE_STREET_NUMBER)return null;var B=[u.SITE_STREET_NUMBER.value,u.SITE_STREET.value,u.SITE_STREET_TYPE.value,u.SITE_STREET_DIR.value].join(" ");
