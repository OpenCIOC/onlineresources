...
ClusterIcon.prototype.onAdd=function(){var a=this,b,c;this.div_=document.createElement("div");this.div_.className=this.className_;this.visible_&&this.show();this.getPanes().overlayMouseTarget.appendChild(this.div_);this.getMap().getDiv().addEventListener("bounds_changed",function(){c=b});this.div_.addEventListener("mousedown",function(){b=!0;c=!1});this.div_.addEventListener("click",function(d){b=!1;if(!c){var e=a.cluster_.getMarkerClusterer();google.maps.event.trigger(e,"click",a.cluster_);google.maps.event.trigger(e,
"clusterclick",a.cluster_);if(e.getZoomOnClick()){var f=e.getMaxZoom();var g=a.cluster_.getBounds();e.getMap().fitBounds(g);setTimeout(function(){e.getMap().fitBounds(g);null!==f&&e.getMap().getZoom()>f&&e.getMap().setZoom(f+1)},100)}d.cancelBubble=!0;d.stopPropagation&&d.stopPropagation()}});this.div_.addEventListener("mouseover",function(){var d=a.cluster_.getMarkerClusterer();google.maps.event.trigger(d,"mouseover",a.cluster_)});this.div_.addEventListener("mouseout",function(){var d=a.cluster_.getMarkerClusterer();
google.maps.event.trigger(d,"mouseout",a.cluster_)})};ClusterIcon.prototype.onRemove=function(){this.div_&&this.div_.parentNode&&(this.hide(),google.maps.event.clearInstanceListeners(this.div_),this.div_.parentNode.removeChild(this.div_),this.div_=null)};ClusterIcon.prototype.draw=function(){if(this.visible_){var a=this.getPosFromLatLng_(this.center_);this.div_.style.top=a.y+"px";this.div_.style.left=a.x+"px"}};
...
this.clusterClass_=c.clusterClass||"cluster";-1!==navigator.userAgent.toLowerCase().indexOf("msie")&&(this.batchSize_=this.batchSizeIE_);this.setupStyles_();this.addMarkers(b,!0);this.setMap(a)}
...
MarkerClusterer.prototype.resetViewport_=function(a){var b;for(b=0;b<this.clusters_.length;b++)this.clusters_[b].remove();this.clusters_=[];for(b=0;b<this.markers_.length;b++){var c=this.markers_[b];c.isAdded=!1;a&&c.setMap(null)}};MarkerClusterer.prototype.pi_over_180=Math.PI/180;MarkerClusterer.prototype.pi_over_360=Math.PI/360;MarkerClusterer.prototype.distanceBetweenPoints_=function(a,b){var c=a.lat(),d=b.lat();a=(b.lng()-a.lng())*Math.cos((c+d)/2);c=d-c;return 6371*Math.sqrt(a*a+c*c)};
MarkerClusterer.prototype.isMarkerInBounds_=function(a,b){return b.contains(a.getPosition())};MarkerClusterer.prototype.addToClosestCluster_=function(a){var b,c,d=4E4,e=null;for(b=0;b<this.clusters_.length;b++){var f=this.clusters_[b];if(c=f.getCenter())c=this.distanceBetweenPoints_(c,a.getPosition()),c<d&&(d=c,e=f)}e&&e.isMarkerInClusterBounds(a)?e.addMarker(a):(f=new Cluster(this),f.addMarker(a),this.clusters_.push(f))};
...
MarkerClusterer.prototype.extend=function(a,b){return function(c){for(var d in c.prototype)this.prototype[d]=c.prototype[d];return this}.apply(a,[b])};MarkerClusterer.CALCULATOR=function(a,b){for(var c=0,d=a=a.length.toString();0!==d;)d=parseInt(d/10,10),c++;c=Math.min(c,b);return{text:a,index:c,title:""}};MarkerClusterer.BATCH_SIZE=2E3;MarkerClusterer.BATCH_SIZE_IE=500;MarkerClusterer.IMAGE_PATH="//google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclustererplus/images/m";
