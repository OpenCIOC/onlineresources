...
C){C.dpDiv.addClass("NoYearDatePicker")},onClose:function(A,C){C.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});u.dateFormat=p;z.datepicker(h.extend({},h.datepicker.regional[w],u)).prop("autocomplete","off")},x=function(z){h.getScript("https://ajax.googleapis.com/ajax/libs/jqueryui/"+h.ui.version+"/i18n/jquery.ui.datepicker-"+z+".min.js",function(){l[z]=!0;h.each(c[z],function(){v.call(this)});delete c[z]})};h.datepicker.regional["en-CA"]=h.extend({},h.datepicker.regional[""]);h.fn.extend({autodatepicker:function(){return this.each(function(){var z=
