...
*/
window.CIOC={};
(function(a,b){b.do_drop_down_navigation=function(){for(var e=a.getElementById("ActionList").options,r=0;r<e.length;r++)if(e[r].selected){var n=e[r].getAttribute("href");n&&("undefined"!=typeof e[r].attributes.newwindow?b.open(n):b.location.href=n);break}};jQuery(function(e){e("[data-toggle=dialog]").each(function(){var r=e(this),n=e(r.data("target")),z={autoOpen:!1,title:n.data("title"),modal:n.data("modal")};n.dialog(z);r.click(function(){n.dialog("isOpen")?n.dialog("close"):n.dialog("open")})})})})(document,window);
...
(function(){var a=jQuery,b={},e=function(w){null!==w&&"undefined"!==typeof w?a("#myListCount").text(w):(w=a("#myListCount").text())&&(w=parseInt(w,10));w?b.myListLink.show():b.myListLink.hide()},r=function(w){a.each(w,function(H,q){a("#added_to_list_"+q).show();a("#add_to_list_"+q).hide()})},n=function(w){return function(H){H.fail?alert(H.errinfo):(H.ids?e(a.grep(H.ids,B[b.domain]).length):H.count?e(H.count):e(0),r([w]))}},z=function(w){w=a(w.currentTarget).data("id");a.ajax({success:n(w),dataType:"json",
error:function(){alert("Error")},data:{id:w},type:"POST",url:b.current_list_url})},P=function(w){return function(H){if(H.fail)alert(H.errinfo);else{H=!0;if(w){var q=a("#results_table #remove_from_list_"+w);q.length?q.parent().parent().remove():(H=!1,q=a("#results_container #remove_from_list_"+w),q.parents(".dlist-result").remove())}(H?1!==a("#results_table tr").length:0!==a("#results_container .dlist-result").length)&&w||(a("#records_ui").hide(),a("#no_records_message").show())}}},K=function(w){w=
a(w.currentTarget).data("id");a.ajax({success:P(w),dataType:"json",error:function(){alert("Error")},data:{ID:w,RemoveItem:b.domain},type:"POST",url:b.current_list_url})},T=function(w){a.ajax({success:P(),dataType:"json",error:function(){alert("Error")},data:{ID:"all",RemoveItem:b.domain},type:"POST",url:b.current_list_url})},B={CIC:function(w){return/^[A-Za-z]{3}[0-9]{4,5}$/.test(w)},VOL:function(w){return/^[1-9][0-9]*$/.test(w)}},O=function(w){if(w.fail)R();else if(w.inrequest){var H=a.grep(w.ids,
...
x()};b.list_view_mode||b.has_session?w():a.ajax({dataType:"json",error:null,url:b.list_update_url,data:{SessionTest:"on"},type:"POST",success:function(H){H.has_session&&w()}})},x=function(){a(".HideListUI").delegate(".add_to_list","click",z).delegate(".remove_from_list","click",K).removeClass("HideListUI");a("#remove_all_from_list").click(T);a.browser.msie&&"8.0">a.browser.msie&&a(".ListUI").removeClass("FixIE")};window.init_list_adder=function(w){b=w;b.myListLink=a("#myListLink").parent(":hidden").add("#myListLink");
w.in_request?a.ajax({success:O,dataType:"json",error:null,type:"POST",url:w.in_request}):R()}})();this.JSON||(this.JSON={});
(function(){function a(B){return 10>B?"0"+B:B}function b(B){n.lastIndex=0;return n.test(B)?'"'+B.replace(n,function(O){var R=K[O];return"string"===typeof R?R:"\\u"+("0000"+O.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+B+'"'}function e(B,O){var R=z,x=O[B];x&&"object"===typeof x&&"function"===typeof x.toJSON&&(x=x.toJSON(B));"function"===typeof T&&(x=T.call(O,B,x));switch(typeof x){case "string":return b(x);case "number":return isFinite(x)?String(x):"null";case "boolean":case "null":return String(x);
case "object":if(!x)return"null";z+=P;var w=[];if("[object Array]"===Object.prototype.toString.apply(x)){var H=x.length;for(B=0;B<H;B+=1)w[B]=e(B,x)||"null";O=0===w.length?"[]":z?"[\n"+z+w.join(",\n"+z)+"\n"+R+"]":"["+w.join(",")+"]";z=R;return O}if(T&&"object"===typeof T)for(H=T.length,B=0;B<H;B+=1){var q=T[B];"string"===typeof q&&(O=e(q,x))&&w.push(b(q)+(z?": ":":")+O)}else for(q in x)Object.hasOwnProperty.call(x,q)&&(O=e(q,x))&&w.push(b(q)+(z?": ":":")+O);O=0===w.length?"{}":z?"{\n"+z+w.join(",\n"+
...
n=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,z,P,K={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},T;"function"!==typeof JSON.stringify&&(JSON.stringify=function(B,O,R){var x;P=z="";if("number"===typeof R)for(x=0;x<R;x+=1)P+=" ";else"string"===typeof R&&(P=R);if((T=O)&&"function"!==typeof O&&("object"!==typeof O||"number"!==typeof O.length))throw Error("JSON.stringify");return e("",{"":B})});
"function"!==typeof JSON.parse&&(JSON.parse=function(B,O){function R(x,w){var H,q=x[w];if(q&&"object"===typeof q)for(H in q)if(Object.hasOwnProperty.call(q,H)){var k=R(q,H);void 0!==k?q[H]=k:delete q[H]}return O.call(x,w,q)}B=String(B);r.lastIndex=0;r.test(B)&&(B=B.replace(r,function(x){return"\\u"+("0000"+x.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(B.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
...
b[this.name];"undefined"!=typeof n&&null!==n&&("input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type?"select"===this.nodeName.toLowerCase()?e(this).find("option").each(function(z){this.selected=1<n.length?0<=e.inArray(this.value,n):0===n.length?!1:this.value===n[0]}):this.value=n.length?n[0]:"":this.checked=1<n.length?0<=e.inArray(this.value,n):0===n.length?!1:this.value===n[0])}})};window.init_cached_state=function(a){var b=jQuery;a=a||"#EntryForm";onbeforeunload_fns=
[];onbeforerestorevalues_fns=[];var e=function(){var r={form_values:get_form_values(a)};b.each(onbeforeunload_fns,function(n,z){z(r)});document.getElementById("cache_form_values").value=JSON.stringify(r)};document.addEventListener("visibilitychange",function(){"hidden"==document.visibilityState&&e()});document.addEventListener("freeze",e);window.addEventListener("pagehide",e);window.cache_register_onbeforeunload=function(r){onbeforeunload_fns.push(r)};window.cache_register_onbeforerestorevalues=function(r){onbeforerestorevalues_fns.push(r)};
window.restore_cached_state=function(){b(window).on("pageshow",function(r){if(!r.originalEvent.persisted&&(r=document.getElementById("cache_form_values"))&&r.value){var n=JSON.parse(r.value);b.each(onbeforerestorevalues_fns,function(z,P){P(n)});restore_form_values(a,n.form_values)}})}}})();
(function(){var a=jQuery,b={"en-CA":"d M yy",de:"dd.mm.yy",fr:"d M yy",it:"d M yy",nl:"d M yy",no:"d M yy",pt:"d-mm-yy",sv:"d M yy",hu:"M d. yy",ro:"d M yy",hr:"d M yy",sl:"d M yy",bg:"d MM yy",ru:"d M yy",tr:"d M yy",lv:"d M yy",lt:"d M yy",ko:"yy/mm/dd","zh-CN":"yy/mm/dd",th:"d M yy"},e={"en-CA":!0,"":!0},r={},n={"fr-CA":"fr","es-MX":"es"},z=function(){var K=a(this),T=K.data("culture"),B=b[T]||a.datepicker.regional[T].dateFormat,O={};K.hasClass("NoYear")&&(B=B.replace(/[\- .\/]*yy[\/]?/,""),O={beforeShow:function(R,
x){x.dpDiv.addClass("NoYearDatePicker")},onClose:function(R,x){x.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});O.dateFormat=B;K.datepicker(a.extend({},a.datepicker.regional[T],O)).prop("autocomplete","off")},P=function(K){a.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+a.ui.version+"/i18n/jquery.ui.datepicker-"+K+".min.js",function(){e[K]=!0;a.each(r[K],function(){z.call(this)});delete r[K]})};a.datepicker.regional["en-CA"]=a.extend({},a.datepicker.regional[""]);a.fn.extend({autodatepicker:function(){return this.each(function(){var K=
a(this);var T=K.parents("[lang]").first().prop("lang")||"en-CA";T=n[T]||T;K.data("culture",T);e[T]?z.call(this):(K=r[T],K||(K=r[T]=[],P(T)),K.push(this))})}});jQuery(function(){a("input.DatePicker").autodatepicker()})})();function ClusterIcon(a,b){a.getMarkerClusterer().extend(ClusterIcon,google.maps.OverlayView);this.cluster_=a;this.className_=a.getMarkerClusterer().getClusterClass();this.styles_=b;this.sums_=this.div_=this.center_=null;this.visible_=!1;this.setMap(a.getMap())}
...
"clusterclick",a.cluster_);if(n.getZoomOnClick()){var z=n.getMaxZoom();var P=a.cluster_.getBounds();n.getMap().fitBounds(P);setTimeout(function(){n.getMap().fitBounds(P);null!==z&&n.getMap().getZoom()>z&&n.getMap().setZoom(z+1)},100)}r.cancelBubble=!0;r.stopPropagation&&r.stopPropagation()}});this.div_.addEventListener("mouseover",function(){var r=a.cluster_.getMarkerClusterer();google.maps.event.trigger(r,"mouseover",a.cluster_)});this.div_.addEventListener("mouseout",function(){var r=a.cluster_.getMarkerClusterer();
...
MarkerClusterer.prototype.isMarkerInBounds_=function(a,b){return b.contains(a.getPosition())};MarkerClusterer.prototype.addToClosestCluster_=function(a){var b,e,r=4E4,n=null;for(b=0;b<this.clusters_.length;b++){var z=this.clusters_[b];if(e=z.getCenter())e=this.distanceBetweenPoints_(e,a.getPosition()),e<r&&(r=e,n=z)}n&&n.isMarkerInClusterBounds(a)?n.addMarker(a):(z=new Cluster(this),z.addMarker(a),this.clusters_.push(z))};
...
n.cultures["default"].calendar=n.cultures["default"].calendars.standard;n.cultures.en=n.cultures["default"];n.cultureSelector="en";var z=/^0x[a-f0-9]+$/i;var P=/^[+\-]?infinity$/i;var K=/^[+\-]?\d*\.?\d*(e[+\-]?\d+)?$/;var T=/^\s+|\s+$/g;var B=function(c,d){if(c.indexOf)return c.indexOf(d);for(var h=0,g=c.length;h<g;h++)if(c[h]===d)return h;return-1};var O=function(c,d){return c.substr(c.length-d.length)===d};var R=function(){var c,d,h,g=arguments[0]||{},t=1,y=arguments.length,A=!1;"boolean"===typeof g&&
(A=g,g=arguments[1]||{},t=2);for("object"===typeof g||w(g)||(g={});t<y;t++)if(null!=(c=arguments[t]))for(d in c){var l=g[d];var E=c[d];g!==E&&(A&&E&&(H(E)||(h=x(E)))?(h?(h=!1,l=l&&x(l)?l:[]):l=l&&H(l)?l:{},g[d]=R(A,l,E)):E!==b&&(g[d]=E))}return g};var x=Array.isArray||function(c){return"[object Array]"===Object.prototype.toString.call(c)};var w=function(c){return"[object Function]"===Object.prototype.toString.call(c)};var H=function(c){return"[object Object]"===Object.prototype.toString.call(c)};
var q=function(c,d){return 0===c.indexOf(d)};var k=function(c){return(c+"").replace(T,"")};var N=function(c){return isNaN(c)?NaN:Math[0>c?"ceil":"floor"](c)};var C=function(c,d,h){var g;for(g=c.length;g<d;g+=1)c=h?"0"+c:c+"0";return c};var Q=function(c,d){for(var h=0,g=!1,t=0,y=c.length;t<y;t++){var A=c.charAt(t);switch(A){case "'":g?d.push("'"):h++;g=!1;break;case "\\":g&&d.push("\\");g=!g;break;default:d.push(A),g=!1}}return h};var W=function(c,d){d=d||"F";c=c.patterns;var h=d.length;if(1===h){c=
c[d];if(!c)throw"Invalid date format string '"+d+"'.";d=c}else 2===h&&"%"===d.charAt(0)&&(d=d.charAt(1));return d};var J=function(c,d,h){function g(fa,X){fa+="";return 1<X&&fa.length<X?(fa=S[X-2]+fa,fa.substr(fa.length-X,X)):fa}function t(fa,X){if(ia)return ia[X];switch(X){case 0:return fa.getFullYear();case 1:return fa.getMonth();case 2:return fa.getDate();default:throw"Invalid part value "+X;}}var y=h.calendar,A=y.convert;if(!d||!d.length||"i"===d){if(h&&h.name.length)if(A)h=J(c,y.patterns.F,h);
else{d=new Date(c.getTime());var l=p(c,y.eras);d.setFullYear(u(c,y,l));h=d.toLocaleString()}else h=c.toString();return h}var E=y.eras,M="s"===d;d=W(y,d);h=[];var S=["0","00","000"],aa=/([^d]|^)(d|dd)([^d]|$)/g,ba=0,ca=I(),ia;for(!M&&A&&(ia=A.fromGregorian(c));;){var U=ca.lastIndex;A=ca.exec(d);U=d.slice(U,A?A.index:d.length);ba+=Q(U,h);if(!A)break;if(ba%2)h.push(A[0]);else switch(U=A[0],A=U.length,U){case "ddd":case "dddd":h.push((3===A?y.days.namesAbbr:y.days.names)[c.getDay()]);break;case "d":case "dd":l=
!0;h.push(g(t(c,2),A));break;case "MMM":case "MMMM":U=t(c,1);var Z=h,pa=Z.push,oa;if(oa=y.monthsGenitive){if(!l&&!ja){l=aa.test(d);var ja=!0}oa=l}pa.call(Z,oa?y.monthsGenitive[3===A?"namesAbbr":"names"][U]:y.months[3===A?"namesAbbr":"names"][U]);break;case "M":case "MM":h.push(g(t(c,1)+1,A));break;case "y":case "yy":case "yyyy":U=ia?ia[0]:u(c,y,p(c,E),M);4>A&&(U%=100);h.push(g(U,A));break;case "h":case "hh":U=c.getHours()%12;0===U&&(U=12);h.push(g(U,A));break;case "H":case "HH":h.push(g(c.getHours(),
A));break;case "m":case "mm":h.push(g(c.getMinutes(),A));break;case "s":case "ss":h.push(g(c.getSeconds(),A));break;case "t":case "tt":U=12>c.getHours()?y.AM?y.AM[0]:" ":y.PM?y.PM[0]:" ";h.push(1===A?U.charAt(0):U);break;case "f":case "ff":case "fff":h.push(g(c.getMilliseconds(),3).substr(0,A));break;case "z":case "zz":U=c.getTimezoneOffset()/60;h.push((0>=U?"+":"-")+g(Math.floor(Math.abs(U)),A));break;case "zzz":U=c.getTimezoneOffset()/60;h.push((0>=U?"+":"-")+g(Math.floor(Math.abs(U)),2)+":"+g(Math.abs(c.getTimezoneOffset()%
60),2));break;case "g":case "gg":y.eras&&h.push(y.eras[p(c,E)].name);break;case "/":h.push(y["/"]);break;default:throw"Invalid date format pattern '"+U+"'.";}}return h.join("")};(function(){var c=function(d,h,g){var t=g.groupSizes,y=t[0],A=1,l=Math.pow(10,h);l=Math.round(d*l)/l;isFinite(l)||(l=d);d=l;l=(d+"").split(/e/i);var E=1<l.length?parseInt(l[1],10):0;d=l[0];l=d.split(".");d=l[0];l=1<l.length?l[1]:"";0<E?(l=C(l,E,!1),d+=l.slice(0,E),l=l.substr(E)):0>E&&(E=-E,d=C(d,E+1,!0),l=d.slice(-E,d.length)+
l,d=d.slice(0,-E));l=0<h?g["."]+(l.length>h?l.slice(0,h):C(l,h)):"";h=d.length-1;g=g[","];for(E="";0<=h;){if(0===y||y>h)return d.slice(0,h+1)+(E.length?g+E+l:l);E=d.slice(h-y+1,h+1)+(E.length?g+E:"");h-=y;A<t.length&&(y=t[A],A++)}return d.slice(0,h+1)+g+E+l};e=function(d,h,g){if(!isFinite(d))return Infinity===d?g.numberFormat.positiveInfinity:-Infinity===d?g.numberFormat.negativeInfinity:g.numberFormat.NaN;if(!h||"i"===h)return g.name.length?d.toLocaleString():d.toString();h=h||"D";g=g.numberFormat;
var t=Math.abs(d),y=-1;1<h.length&&(y=parseInt(h.slice(1),10));var A=h.charAt(0).toUpperCase();switch(A){case "D":h="n";t=N(t);-1!==y&&(t=C(""+t,y,!0));0>d&&(t="-"+t);break;case "N":var l=g;case "C":l=l||g.currency;case "P":l=l||g.percent;h=0>d?l.pattern[0]:l.pattern[1]||"n";-1===y&&(y=l.decimals);t=c(t*("P"===A?100:1),y,l);break;default:throw"Bad number format specifier: "+A;}d=/n|\$|-|%/g;for(l="";;){y=d.lastIndex;A=d.exec(h);l+=h.slice(y,A?A.index:h.length);if(!A)break;switch(A[0]){case "n":l+=
...
E){var M=new Date,S=p(M);M=u(M,l,S);l=l.twoDigitYearMax;l="string"===typeof l?(new Date).getFullYear()%100+parseInt(l,10):l;E+=M-M%100;E>l&&(E-=100)}return E};var d=function(l,E,M){var S=l.days,aa=l._upperDays;aa||(l._upperDays=aa=[A(S.names),A(S.namesAbbr),A(S.namesShort)]);E=y(E);M?(l=B(aa[1],E),-1===l&&(l=B(aa[2],E))):l=B(aa[0],E);return l};var h=function(l,E,M){var S=l.months,aa=l.monthsGenitive||l.months,ba=l._upperMonths,ca=l._upperMonthsGen;ba||(l._upperMonths=ba=[A(S.names),A(S.namesAbbr)],
l._upperMonthsGen=ca=[A(aa.names),A(aa.namesAbbr)]);E=y(E);l=B(M?ba[1]:ba[0],E);0>l&&(l=B(M?ca[1]:ca[0],E));return l};var g=function(l,E){var M=l._parseRegExp;if(M){var S=M[E];if(S)return S}else l._parseRegExp=M={};l=W(l,E).replace(/([\^\$\.\*\+\?\|\[\]\(\)\{\}])/g,"\\\\$1");S=["^"];for(var aa=[],ba=0,ca=0,ia=I(),U;null!==(U=ia.exec(l));){var Z=l.slice(ba,U.index);ba=ia.lastIndex;ca+=Q(Z,S);if(ca%2)S.push(U[0]);else{Z=U[0];var pa=Z.length;switch(Z){case "dddd":case "ddd":case "MMMM":case "MMM":case "gg":case "g":Z=
...
this.cultures,g=c,t,y=g.length,A=[];for(t=0;t<y;t++){c=k(g[t]);c=c.split(";");var l=k(c[0]);1===c.length?c=1:(c=k(c[1]),0===c.indexOf("q=")?(c=c.substr(2),c=parseFloat(c),c=isNaN(c)?0:c):c=1);A.push({lang:l,pri:c})}A.sort(function(M,S){return M.pri<S.pri?1:M.pri>S.pri?-1:0});for(t=0;t<y;t++)if(l=A[t].lang,d=h[l])return d;for(t=0;t<y;t++){l=A[t].lang;do{g=l.lastIndexOf("-");if(-1===g)break;l=l.substr(0,g);if(d=h[l])return d}while(1)}for(t=0;t<y;t++){l=A[t].lang;for(var E in h)if(g=h[E],g.language==
l)return g}}else if("object"===typeof c)return c;return d||null};n.format=function(c,d,h){h=this.findClosestCulture(h);c instanceof Date?c=J(c,d,h):"number"===typeof c&&(c=e(c,d,h));return c};n.localize=function(c,d){return this.findClosestCulture(d).messages[c]||this.cultures["default"].messages[c]};n.parseDate=function(c,d,h){h=this.findClosestCulture(h);var g;if(d){if("string"===typeof d&&(d=[d]),d.length){var t=0;for(var y=d.length;t<y;t++){var A=d[t];if(A&&(g=r(c,A,h)))break}}}else for(t in d=
h.calendar.patterns,d)if(g=r(c,d[t],h))break;return g||null};n.parseInt=function(c,d,h){return N(n.parseFloat(c,d,h))};n.parseFloat=function(c,d,h){"number"!==typeof d&&(h=d,d=10);var g=this.findClosestCulture(h);h=NaN;var t=g.numberFormat;-1<c.indexOf(g.numberFormat.currency.symbol)&&(c=c.replace(g.numberFormat.currency.symbol,""),c=c.replace(g.numberFormat.currency["."],g.numberFormat["."]));c=k(c);if(P.test(c))h=parseFloat(c);else if(!d&&z.test(c))h=parseInt(c,16);else{g=F(c,t,t.pattern[0]);d=
g[0];g=g[1];""===d&&"(n)"!==t.pattern[0]&&(g=F(c,t,"(n)"),d=g[0],g=g[1]);""===d&&"-n"!==t.pattern[0]&&(g=F(c,t,"-n"),d=g[0],g=g[1]);d=d||"+";c=g.indexOf("e");0>c&&(c=g.indexOf("E"));if(0>c){var y=g;c=null}else y=g.substr(0,c),c=g.substr(c+1);var A=t["."],l=y.indexOf(A);0>l?(g=y,y=null):(g=y.substr(0,l),y=y.substr(l+A.length));A=t[","];g=g.split(A).join("");l=A.replace(/\u00A0/g," ");A!==l&&(g=g.split(l).join(""));d+=g;null!==y&&(d+="."+y);null!==c&&(t=F(c,t,"-n"),d+="e"+(t[0]||"+")+t[1]);K.test(d)&&
...
(function(a,b){function e(p){return"string"===typeof p}function r(p){var u=T.call(arguments,1);return function(){return p.apply(this,u.concat(T.call(arguments)))}}function n(p,u,F,c,d){if(c!==K){u=F.match(p?/^([^#]*)#?(.*)$/:/^([^#?]*)\??([^#]*)(#?.*)/);F=u[3]||"";if(2===d&&e(c))c=c.replace(p?Q:C,"");else{var h=x(u[2]);c=e(c)?x[p?"fragment":"querystring"](c):c;c=2===d?c:1===d?a.extend({},c,h):a.extend({},h,c);c=O(c);p&&(c=c.replace(W,B))}p=u[1]+(p?"#":c||!u[1]?"?":"")+c+F}else p=u(F!==K?F:b.location.href);
return p}function z(p,u,F){u===K||"boolean"===typeof u?(F=u,u=O[p?"fragment":"querystring"]()):u=e(u)?u.replace(p?Q:C,""):u;return x(u,F)}function P(p,u,F,c){e(F)||"object"===typeof F||(c=F,F=u,u=K);return this.each(function(){var d=a(this),h=u||I()[(this.nodeName||"").toLowerCase()]||"",g=h&&d.attr(h)||"";d.attr(h,O[p](g,F,c))})}"$:nomunge";var K,T=Array.prototype.slice,B=decodeURIComponent,O=a.param,R,x,w,H=a.bbq=a.bbq||{},q,k,N=a.event.special,C=/^.*\?|#.*$/g,Q=/^.*#/,W,J={};O.querystring=r(n,
0,function(p){return p.replace(/(?:^[^?#]*\?([^#]*).*$)?.*/,"$1")});O.fragment=R=r(n,1,function(p){return p.replace(/^[^#]*#?(.*)$/,"$1")});R.noEscape=function(p){p=a.map((p||"").split(""),encodeURIComponent);W=new RegExp(p.join("|"),"g")};R.noEscape(",/");a.deparam=x=function(p,u){var F={},c={"true":!0,"false":!1,"null":null};a.each(p.replace(/\+/g," ").split("&"),function(d,h){var g=h.split("=");d=B(g[0]);h=F;var t=0,y=d.split("]["),A=y.length-1;/\[/.test(y[0])&&/\]$/.test(y[A])?(y[A]=y[A].replace(/\]$/,
""),y=y.shift().split("[").concat(y),A=y.length-1):A=0;if(2===g.length)if(g=B(g[1]),u&&(g=g&&!isNaN(g)?+g:"undefined"===g?K:c[g]!==K?c[g]:g),A)for(;t<=A;t++)d=""===y[t]?h.length:y[t],h=h[d]=t<A?h[d]||(y[t+1]&&isNaN(y[t+1])?{}:[]):g;else a.isArray(F[d])?F[d].push(g):F[d]=F[d]!==K?[F[d],g]:g;else d&&(F[d]=u?K:"")});return F};x.querystring=r(z,0);x.fragment=w=r(z,1);a.elemUrlAttr||(a.elemUrlAttr=function(p){return a.extend(J,p)})({a:"href",base:"href",iframe:"src",img:"src",input:"src",form:"action",
link:"href",script:"src"});var I=a.elemUrlAttr;a.fn.querystring=r(P,"querystring");a.fn.fragment=r(P,"fragment");H.pushState=q=function(p,u){e(p)&&/^#/.test(p)&&u===K&&(u=2);var F=p!==K;p=R(b.location.href,F?p:{},F?u:2);b.location.href=p+(/#/.test(p)?"":"#")};H.getState=k=function(p,u){return p===K||"boolean"===typeof p?w(p):w(u)[p]};H.removeState=function(p){var u={};p!==K&&(u=k(),a.each(a.isArray(p)?p:arguments,function(F,c){delete u[c]}));q(u,2)};N.hashchange=a.extend(N.hashchange,{add:function(p){function u(c){var d=
...
(function(a,b,e){function r(B){B=B||b.location.href;return B.replace(/^[^#]*#?(.*)$/,"$1")}"$:nomunge";var n=a.event.special,z=document.documentMode,P=a.browser.msie&&(z===e||8>z),K="onhashchange"in b&&!P;a.hashchangeDelay=100;n.hashchange=a.extend(n.hashchange,{setup:function(){if(K)return!1;a(T.start)},teardown:function(){if(K)return!1;a(T.stop)}});var T=function(){function B(){w=H=function(q){return q};P&&(x=a('<iframe src="javascript:0"/>').hide().insertAfter("body")[0].contentWindow,H=function(){return r(x.document.location.href)},
w=function(q,k){q!==k&&(k=x.document,k.open().close(),k.location.hash="#"+q)},w(r()))}var O={},R,x,w,H;O.start=function(){if(!R){var q=r();w||B();(function N(){var C=r(),Q=H(q);C!==q?(w(q=C,Q),a(b).trigger("hashchange")):Q!==q&&(b.location.href=b.location.href.replace(/#.*/,"")+"#"+Q);R=setTimeout(N,a.hashchangeDelay)})()}};O.stop=function(){x||(R&&clearTimeout(R),R=0)};return O}()})(jQuery,this);
(function(a,b){"$:nomunge";var e=a.jQuery||a.Cowboy||(a.Cowboy={}),r;e.throttle=r=function(n,z,P,K){function T(){function R(){O=+new Date;P.apply(w,q)}function x(){B=b}var w=this,H=+new Date-O,q=arguments;K&&!B&&R();B&&clearTimeout(B);K===b&&H>n?R():!0!==z&&(B=setTimeout(K?x:R,K===b?n-H:n))}var B,O=0;"boolean"!==typeof z&&(K=P,P=z,z=b);e.guid&&(T.guid=P.guid=P.guid||e.guid++);return T};e.debounce=function(n,z,P){return P===b?r(n,z,!1):r(n,P,!1!==z)}})(this);
...
g.marginTop=0):!k.centerY&&N&&(h=k.css&&k.css.top?parseInt(k.css.top,10):0,g.setExpression("top","((document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "+h+') + "px"'))})}C&&(k.theme?I.find(".ui-widget-content").append(C):I.append(C),(C.jquery||C.nodeType)&&b(C).show());(O||k.forceIframe)&&k.showOverlay&&p.show();k.fadeIn?(Q=k.onBlock?k.onBlock:B,p=k.showOverlay&&!C?Q:B,Q=C?Q:B,k.showOverlay&&J._fadeIn(k.fadeIn,p),C&&I._fadeIn(k.fadeIn,Q)):(k.showOverlay&&
J.show(),C&&I.show(),k.onBlock&&k.onBlock.bind(I)());z(1,q,k);N?(w=I[0],H=b(k.focusableElements,w),k.focusInput&&setTimeout(K,20)):T(I[0],k.centerX,k.centerY);k.timeout&&(C=setTimeout(function(){N?b.unblockUI(k):b(q).unblock(k)},k.timeout),b(q).data("blockUI.timeout",C))}}function r(q,k){var N=q==window,C=b(q),Q=C.data("blockUI.history"),W=C.data("blockUI.timeout");W&&(clearTimeout(W),C.removeData("blockUI.timeout"));k=b.extend({},b.blockUI.defaults,k||{});z(0,q,k);null===k.onUnblock&&(k.onUnblock=
...
k&&k.el&&(k.el.style.display=k.display,k.el.style.position=k.position,k.el.style.cursor="default",k.parent&&k.parent.appendChild(k.el),Q.removeData("blockUI.history"));Q.data("blockUI.static")&&Q.css("position","static");if("function"==typeof N.onUnblock)N.onUnblock(C,N);q=b(document.body);k=q.width();N=q[0].style.width;q.width(k-1).width(k);q[0].style.width=N}}function z(q,k,N){var C=k==window;k=b(k);if(q||(!C||w)&&(C||k.data("blockUI.isBlocked")))k.data("blockUI.isBlocked",q),C&&N.bindEvents&&(!q||
N.showOverlay)&&(q?b(document).bind("mousedown mouseup keydown keypress keyup touchstart touchend touchmove",N,P):b(document).unbind("mousedown mouseup keydown keypress keyup touchstart touchend touchmove",P))}function P(q){if("keydown"===q.type&&q.keyCode&&9==q.keyCode&&w&&q.data.constrainTabKey){var k=H,N=q.shiftKey&&q.target===k[0];if(!q.shiftKey&&q.target===k[k.length-1]||N)return setTimeout(function(){K(N)},10),!1}k=q.data;var C=b(q.target);if(C.hasClass("blockOverlay")&&k.onOverlayClick)k.onOverlayClick(q);
return 0<C.parents("div."+k.blockMsgClass).length?!0:0===C.parents().children().filter("div.blockUI").length}function K(q){H&&(q=H[!0===q?H.length-1:0])&&q.focus()}function T(q,k,N){var C=q.parentNode,Q=q.style,W=(C.offsetWidth-q.offsetWidth)/2-(parseInt(b.css(C,"borderLeftWidth"),10)||0);q=(C.offsetHeight-q.offsetHeight)/2-(parseInt(b.css(C,"borderTopWidth"),10)||0);k&&(Q.left=0<W?W+"px":"0");N&&(Q.top=0<q?q+"px":"0")}b.fn._fadeIn=b.fn.fadeIn;var B=b.noop||function(){},O=/MSIE/.test(navigator.userAgent),
...
(function(a,b,e){var r=Array.prototype.slice;jQuery.widget.extend=function(f){for(var m=r.call(arguments,1),v=0,D=m.length,G,L;v<D;v++)for(G in m[v])L=m[v][G],m[v].hasOwnProperty(G)&&void 0!==L&&(a.isPlainObject(L)&&a.isPlainObject(f[G])?f[G]=a.widget.extend({},f[G],L):f[G]=L);return f};var n=function(){};n.prototype.initialize=function(f){var m=this,v=a("<div>").css({fontFamily:"Arial,sans-serif",fontSize:"medium"});this.legendButton=this.makeButton_(P.txt_legend).appendTo(v).hide().click(function(){m.legendPopup.is(":hidden")?
m.legendPopup.show():m.legendPopup.hide()});this.legendPopup=a("<div>").addClass("MapLegendContainer").hide().appendTo(this.legendButton);var D=this.makeButton_(P.txt_to_bottom).appendTo(v).click(function(){var L=f.getCenter();d("Bottom");D.hide();G.show();f.panTo(L)}),G=this.makeButton_(P.txt_to_side).appendTo(v).click(function(){var L=f.getCenter();d("Side");G.hide();D.show();f.panTo(L)});this.makeButton_(P.txt_close).appendTo(v).click(function(){var L=a.param.fragment();if("/SHOWMAP"===L)a.bbq.pushState("#");
...
var z,P,K,T,B=null,O=function(f){var m=a("#results-column");m.length&&(B||(B=m[0].className),f?(a("#subjects_column").hide(),a("#show_subjects_display").show(),m[0].className="col-xs-12"):(a("#subjects_column").show(),a("#show_subjects_display").hide(),m[0].className=B))},R=function(){O(!0);return!1};b.do_hide_subjects=R;b.do_show_subjects=function(f){f.preventDefault();O(!1);return!1};var x=null,w=null,H="Side",q=[0,0],k=null,N=null,C={},Q=null,W=null,J=null,I=null,p=null,u=null,F=null,c=function(){var f=
...
a("#check_all_in_viewport").hide(),a("#subjects_column").length&&a("#show_subjects_display").show(),a("#map_my_results_ui").show(),J.hide(),X())},g=function(){return'<div id="map_popup" class="MapPopup">'},t=null,y=null,A=null,l=null,E=null,M=function(){ka=t=null;na();A&&(google.maps.event.removeListener(A),A=null)},S=function(){y&&(y.close(),M())},aa=function(f,m,v){S();y=new google.maps.InfoWindow({content:f,position:m,maxWidth:I.innerWidth()-150,pixelOffset:v});A=google.maps.event.addListener(y,
"closeclick",M);y.open(x)},ba=function(f){var m;if(t===f&&y)S();else{if(9<f.getSize()&&x.getZoom()<x.mapTypes.get(x.getMapTypeId()).maxZoom)return!0;var v=f.getMarkers(),D=g()+"<ul>",G=[];for(m=0;m<v.length;m++){var L=v[m].num;var V=C[L];G.push(L);D+="<li style=\"list-style-image: url('"+z[V.mappin].image_small_circle+"');\"><b>"+V.orgname+'</b><br><a href="#/'+L+'">'+P.txt_more_info+"</a></li>"}aa(D+"</ul></div>",f.getCenter(),E);t=f;for(m=0;m<G.length;m++)L=G[m],Ca(L)}return!1},ca=!1,ia=function(){ca=
...
"px",width:""}),W.css({height:(D.height-m-v-N.height).toString()+"px",width:""}),console.log("bottom visible",m,Q.css("height"),W.css("height")));x&&!f&&google.maps.event.trigger(x,"resize");f||wa()},qa=null,da=null,ea={},ka=null,na=function(){a.each(ea,function(f,m){m.marker_icon&&(m.marker_icon.prop("src",z[C[f].mappin].image_small),m.marker_cell.removeClass("HighLight"))});ea={}},Ca=function(f){var m=a("#map_marker_icon_"+f+",#map_marker_icon_mobile_"+f),v=a("#map_column_"+f+",#map_column_mobile_"+
f);m&&(m.prop("src",z[C[f].mappin].image_small_dot),v.addClass("HighLight"));ea[f]={marker_icon:m,marker_cell:v};return m},Ma=function(){a.each(ea,function(f,m){if(!m.marker_icon){var v=a("#map_marker_icon_"+f+",#map_marker_icon_mobile_"+f),D=a("#map_column_"+f+",#map_column_mobile_"+f);v.prop("src",z[C[f].mappin].image_small_dot);D.addClass("HighLight");m.marker_icon=v;m.marker_cell=D}})},Da=function(f,m){f=f.getClusters();for(var v=0;v<f.length;v++)if(f[v].isMarkerInClusterBounds(m))return f[v];
return null},ta=null,va=function(f,m,v,D){if("undefined"===typeof v||null===v)v=!1;if(U)ta=a.makeArray(arguments);else{var G=C[f];if(G&&G.marker){if(ka===f&&y||D)if(v&&!D||S(),!D)return;var L=g()+"<b>"+G.orgname+'</b><br><a href="#/'+f+'">'+P.txt_more_info+"</a></div>";G=G.marker;var V=Da(w,G);V&&1<V.getSize()?(x.getBounds().contains(V.getCenter())||x.setCenter(V.getCenter()),aa(L,V.getCenter(),E)):aa(L,G.getPosition(),l);ka=f;L=Ca(f);L.length&&m&&(G=Q,L.filter(":visible")[0].scrollIntoView(!0),G.scrollTop(G.scrollTop()-
...
for(var m=e.RecordList,v=m.elements.length,D=0;D<v;D++){var G=m.elements[D];if("IDList"===G.name){var L=G.value;if(C&&x&&(L=C[L])&&L.icon&&f.contains(L.point)){G.checked=!0;continue}G.checked=!1}}return!1};var wa=a.throttle(200,function(){if(C&&x){var f=x.getBounds();if(f){var m=la.find("#results_table").hide();a.each(C,function(v,D){D.icon&&!ea[v]&&(v=D.last_in_bounds||!1,f.contains(D.point)?!1===v&&(D.icon.prop("src",z[D.mappin].image_small),D.icon.prop("title",z[D.mappin].category),D.last_in_bounds=
...
(function(){var a=function(){$(".agency-overview").each(function(){$(this).find(".related-row:visible").last().addClass("last-visible")})};window.initialize_listing_toggle=function(b,e,r,n){$(document).on("click",".show-toggle",function(){var z=$(this),P=z.parents(".related-records"),K=P.find(".details"),T=P.parents(".agency-overview");if(K.is(":visible"))K.slideUp(function(){z.text(b);T.find(".related-row").removeClass("last-visible").filter(":visible").last().addClass("last-visible")});else{var B=
T.find(".related-row").removeClass("last-visible");K.slideDown(function(){z.text(e);B.filter(":visible").last().addClass("last-visible")})}return!1}).on("click",".deleted-toggle",function(){var z=$(this),P=z.parents(".related-records"),K=P.find(".deleted-records"),T=P.parents(".agency-overview");if(K.is(":visible"))K.slideUp(function(){z.text(r);T.find(".related-row").removeClass("last-visible").filter(":visible").last().addClass("last-visible")});else{var B=T.find(".related-row").removeClass("last-visible");
K.slideDown(function(){z.text(n);B.filter(":visible").last().addClass("last-visible")})}return!1});a()};window.add_details_last_visible_class=a})();
