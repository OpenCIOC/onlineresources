...
ka.mappin===x&&L.push(ka.marker)}I?v.addMarkers(L):v.removeMarkers(L)})};var A,Q,K,T,B=null,O=function(f){var m=a("#results-column");m.length&&(B||(B=m[0].className),f?(a("#subjects_column").hide(),a("#show_subjects_display").show(),m[0].className="col-xs-12"):(a("#subjects_column").show(),a("#show_subjects_display").hide(),m[0].className=B))},R=function(){O(!0);return!1};b.do_hide_subjects=R;b.do_show_subjects=function(f){f.preventDefault();O(!1);return!1};var w=null,v=null,F="Side",q=[0,0],k=null,
