...
typeof d?(new Date).getFullYear()%100+parseInt(d,10):d;c+=b-b%100;c>d&&(c-=100)}return c};c=function(a,c,b){var d=a.days,e=a._upperDays;e||(a._upperDays=e=[f(d.names),f(d.namesAbbr),f(d.namesShort)]);c=g(c);b?(a=p(e[1],c),-1===a&&(a=p(e[2],c))):a=p(e[0],c);return a};b=function(a,c,b){var d=a.months,e=a.monthsGenitive||a.months,G=a._upperMonths,J=a._upperMonthsGen;G||(a._upperMonths=G=[f(d.names),f(d.namesAbbr)],a._upperMonthsGen=J=[f(e.names),f(e.namesAbbr)]);c=g(c);a=p(b?G[1]:G[0],c);0>a&&(a=p(b?
J[1]:J[0],c));return a};e=function(a,c){var b=a._parseRegExp;if(b){var d=b[c];if(d)return d}else a._parseRegExp=b={};for(var d=D(a,c).replace(/([\^\$\.\*\+\?\|\[\]\(\)\{\}])/g,"\\\\$1"),e=["^"],g=[],f=0,G=0,J=x(),y;null!==(y=J.exec(d));){var k=d.slice(f,y.index),f=J.lastIndex,G=G+n(k,e);if(G%2)e.push(y[0]);else{var k=y[0],H=k.length;switch(k){case "dddd":case "ddd":case "MMMM":case "MMM":case "gg":case "g":k="(\\D+)";break;case "tt":case "t":k="(\\D*)";break;case "yyyy":case "fff":case "ff":case "f":k=
...
f=function(a){for(var c=[],b=0,d=a.length;b<d;b++)c[b]=g(a[b]);return c};F=function(g,f,k){g=t(g);k=k.calendar;f=e(k,f);var h=(new RegExp(f.regExp)).exec(g);if(null===h)return null;var u=f.groups,n=f=g=null,l=null,s=null,r=0,p,x=0,D=0,w=0;p=null;for(var F=!1,q=0,K=u.length;q<K;q++){var z=h[q+1];if(z){var v=u[q],L=v.length,B=parseInt(z,10);switch(v){case "dd":case "d":l=B;if(d(l,1,31))return null;break;case "MMM":case "MMMM":n=b(k,z,3===L);if(d(n,0,11))return null;break;case "M":case "MM":n=B-1;if(d(n,
...
l=s&&(!a.support.boxModel||0<a("object,embed",r?null:b).length);if(B||l){r&&d.allowBodyStretch&&a.support.boxModel&&a("html,body").css("height","100%");if((B||!a.support.boxModel)&&!r){l=parseInt(a.css(b,"borderTopWidth"),10)||0;var z=parseInt(a.css(b,"borderLeftWidth"),10)||0,G=l?"(0 - "+l+")":0,J=z?"(0 - "+z+")":0}a.each(n,function(a,c){var b=c[0].style;b.position="absolute";if(2>a)r?b.setExpression("height","Math.max(document.body.scrollHeight, document.body.offsetHeight) - (jQuery.support.boxModel?0:"+
d.quirksmodeOffsetHack+') + "px"'):b.setExpression("height",'this.parentNode.offsetHeight + "px"'),r?b.setExpression("width",'jQuery.support.boxModel && document.documentElement.clientWidth || document.body.clientWidth + "px"'):b.setExpression("width",'this.parentNode.offsetWidth + "px"'),J&&b.setExpression("left",J),G&&b.setExpression("top",G);else if(d.centerY)r&&b.setExpression("top",'(document.documentElement.clientHeight || document.body.clientHeight) / 2 - (this.offsetHeight / 2) + (blah = document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "px"'),
...
null,n=null,D={},r=null,w=null,x=null,h=null,u=null,F=null,z=null,G=function(){var a=[t].concat(k).join(","),c;c=new Date;c.setTime(c.getTime()+31536E6);c="; expires="+c.toGMTString();b.cookie="cioc_map_position="+a+c+"; path=/"},J=function(b){if(t!==b){t=b;G();x.show();r[0].className="MapSearchShift MapSearchShift"+t;h[0].className="MapSearchResults MapSearchResults"+t;x[0].className="MapSearchResults MapSearchResults"+t;var d="Side"===t?parseInt(k[0],10):parseInt(k[1],10);"Side"===b?(a("#bottom-handle").hide(),
...
(I.find("#results_table").addClass("HideMapColumn"),a.browser.msie&&"8.0">a.browser.msie&&I.find(".MapColumn").removeClass("FixIE"),a("#check_all_in_viewport").hide(),a("#subjects_column").length&&a("#show_subjects_display").show(),a("#map_my_results_ui").show(),x.hide(),M())},y=function(){return'<div id="map_popup" class="MapPopup">'},S=null,K=null,L=null,m=null,T=null,ea=function(){N=S=null;va();L&&(google.maps.event.removeListener(L),L=null)},A=function(){K&&(K.close(),ea())},X=function(a,b,c){A();
K=new google.maps.InfoWindow({content:a,position:b,maxWidth:h.innerWidth()-150,pixelOffset:c});L=google.maps.event.addListener(K,"closeclick",ea);K.open(s)},ra=function(a){var b,c;if(S===a&&K)A();else{if(9<a.getSize()&&s.getZoom()<s.mapTypes.get(s.getMapTypeId()).maxZoom)return!0;var d=a.getMarkers(),e=y()+"<ul>",g=[];for(b=0;b<d.length;b++){c=d[b].num;var h=D[c];g.push(c);e+="<li style=\"list-style-image: url('"+f[h.mappin].image_small_circle+"');\"><b>"+h.orgname+'</b><br><a href="#/'+c+'">'+l.txt_more_info+
"</a></li>"}X(e+"</ul></div>",a.getCenter(),T);S=a;for(b=0;b<g.length;b++)c=g[b],ga(c)}return!1},U=!1,sa=function(){U=!0},fa=!1,ua=function(){fa=U=!1;if(V){var a=V;V=null;W.apply(null,a)}else if(N){var b=D[N],a=b.marker;(b=ha(C,b.marker))&&1<b.getSize()?K.setOptions({position:b.getCenter(),pixelOffset:T}):K.setOptions({position:a.getPosition(),pixelOffset:m})}else S&&U&&A()},ta=function(){M()};c.maps_loaded=function(){var b=[59.888937,-101.601562],b={center:new google.maps.LatLng(b[0],b[1]),zoom:2,
...
return null},V=null,W=function(b,c,d,e){if("undefined"===typeof d||null===d)d=!1;if(fa)V=a.makeArray(arguments);else{var f=D[b];if(f&&f.marker){if(N===b&&K||e)if(d&&!e||A(),!e)return;var g=y()+"<b>"+f.orgname+'</b><br><a href="#/'+b+'">'+l.txt_more_info+"</a></div>",f=f.marker,h=ha(C,f);h&&1<h.getSize()?(s.getBounds().contains(h.getCenter())||s.setCenter(h.getCenter()),X(g,h.getCenter(),T)):X(g,f.getPosition(),m);N=b;g=ga(b);g.length&&c&&(f=r,g.filter(":visible")[0].scrollIntoView(!0),f.scrollTop(f.scrollTop()-
5))}else N&&K&&A()}},ia=function(a){return function(b){W(b,a)}},za=function(b,c){a.ajax(c,{type:"get",data:{InlineResults:"on"},dataType:"text",success:function(a){ya(b,a)}});return!1},I=null,ja=null,Z=null,ka=null,la=null,Aa=function(){if(I){var c=a("#body_content");c.find("#results_table").length||c.replaceWith(I);var c=a("head")[0],d=b.getElementById("custom_style");d&&c.removeChild(d);ma(ka);na(la);Z&&c.appendChild(Z);b.title=ja;M();xa();setTimeout(function(){M();N?W(N,!0,!0,!0):r.scrollTop(0)},
10)}return!1},ma=function(a){var c=b.getElementById("basic_style");a!==c.href&&(c.href=a)},na=function(a){var c=b.getElementById("template_style");a!==c.href&&(c.href=a)},ya=function(c,d){for(var e=a("#body_content"),f=d.indexOf("<div "),g=a.trim(d.substr(0,f)),g=g.split("\n"),h={},k=0;k<g.length;k++){var u=g[k].replace(/\s+$/,"");if(u){var l=u.substr(0,u.indexOf("=")),u=u.substr(u.indexOf("=")+1);h[l]=u}}g=e.parent();e.is(I)?e.detach():e.remove();e=d.substr(f);g.html(e);e=a("head")[0];(f=b.getElementById("custom_style"))&&
...
t;g[0].className="MapSearchResults MapSearchResults"+t;f.append(d);d.show();M();I=d;ja=b.title;Z=b.getElementById("custom_style");ka=b.getElementById("basic_style").href;la=b.getElementById("template_style").href;O=!0}I.find("#map_my_results_ui").hide();if(null===s)return a.getScript("//maps.googleapis.com/maps/api/js?v=3&"+q+"&sensor=false&callback=maps_loaded&language="+p),!1;pa();a("#check_all_in_viewport").show();M();return!1};c.initialize_mapping=function(d){f=d.map_pins;l=d.translations;p=d.culture;
q=d.key_arg;Globalize.culture(d.culture);d.auto_start&&!(new String(c.location.hash)).replace(/^#/,"")&&history.replaceState(null,"",(new String(c.location)).replace(/#$/,"")+"#/SHOWMAP");a("#map_my_results_ui").show();a(c).bind("hashchange",Ba);var e=b.RecordList;e&&(e.onsubmit=function(){O&&x.is(":visible")?-1===e.action.indexOf("#/SHOWMAP")&&(e.action+="#/SHOWMAP"):-1!==e.action.indexOf("#/SHOWMAP")&&(e.action=e.action.substr(0,e.action.length-9))});a(c).trigger("hashchange")}})(jQuery,this,document);
