...
"input"==this.tagName&&(a=b(".cm-select"+c+":checked"));a=a.val();"L"==a||"S"==a?(b("#located-serving-community-wrap"+c).show(),b("#located-near-wrap"+c).hide()):(b("#located-serving-community-wrap"+c).hide(),b("#located-near-wrap"+c).show())};b("input.cm-select").on("change",a);b("select.cm-select").on("change",a);var c=b("input.cm-select:checked, select.cm-select");window.pageconstants&&window.pageconstants.maps_key_arg&&c.each(function(){b(".cmtype-located-near").show();var a=b(this).data("suffix"),
