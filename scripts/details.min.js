...
*/
window.CIOC={};
(function(c,e){e.do_drop_down_navigation=function(){for(var n=c.getElementById("ActionList").options,h=0;h<n.length;h++)if(n[h].selected){var a=n[h].getAttribute("href");a&&("undefined"!=typeof n[h].attributes.newwindow?e.open(a):e.location.href=a);break}};jQuery(function(n){n("[data-toggle=dialog]").each(function(){var h=n(this),a=n(h.data("target")),b={autoOpen:!1,title:a.data("title"),modal:a.data("modal")};a.dialog(b);h.click(function(){a.dialog("isOpen")?a.dialog("close"):a.dialog("open")})})})})(document,window);
function CheckAll(c,e){c||="IDList";var n=e;e||(n=document.RecordList);e=n.elements.length;for(var h=0;h<e;h++){var a=n.elements[h];a.name===c&&(a.checked=!0)}}function ClearAll(c,e){c||="IDList";var n=e;e||(n=document.RecordList);e=n.elements.length;for(var h=0;h<e;h++){var a=n.elements[h];a.name===c&&(a.checked=!1)}}function add_class(c,e){c&&!(new RegExp("\\b"+e+"\\b")).test(c.className)&&(c.className&&(e=" "+e),c.className+=e)}
function remove_class(c,e){if(c){for(var n=c.className.split(" "),h=[],a=0;a<n.length;a++){var b=n[a];b!==e&&h.push(b)}c.className=h.join(" ")}}function hide(c){add_class(c,"NotVisible")}function show(c){remove_class(c,"NotVisible")}function openWin(c,e){window.open(c,e,"toolbar=no,width=490,height=485,location=no,scrollBars=yes,resizable=no,titlebar=yes").focus()}
function openWinL(c,e){window.open(c,e,"toolbar=no,width=650,height=520,location=no,scrollBars=yes,resizable=no,titlebar=yes").focus()}function openWinXL(c,e){window.open(c,e,"toolbar=no,width=755,height=550,location=no,scrollBars=yes,resizable=no,titlebar=yes").focus()}jQuery(function(c){var e={sm:openWin,lg:openWinL,xl:openWinXL};c(document).on("click","a.poplink",function(){var n=c(this).data("popargs");(e[n.size||"sm"]||openWin)(this.href,n.name||"popwin");return!1})});
(function(){var c=jQuery,e={},n=function(q){null!==q&&"undefined"!==typeof q?c("#myListCount").text(q):(q=c("#myListCount").text())&&(q=parseInt(q,10));q?e.myListLink.show():e.myListLink.hide()},h=function(q){c.each(q,function(w,m){c("#added_to_list_"+m).show();c("#add_to_list_"+m).hide()})},a=function(q){return function(w){w.fail?alert(w.errinfo):(w.ids?n(c.grep(w.ids,g[e.domain]).length):w.count?n(w.count):n(0),h([q]))}},b=function(q){q=c(q.currentTarget).data("id");c.ajax({success:a(q),dataType:"json",
...
q.in_request?c.ajax({success:p,dataType:"json",error:null,type:"POST",url:q.in_request}):r()}})();this.JSON||(this.JSON={});
(function(){function c(g){return 10>g?"0"+g:g}function e(g){a.lastIndex=0;return a.test(g)?'"'+g.replace(a,function(p){var r=f[p];return"string"===typeof r?r:"\\u"+("0000"+p.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+g+'"'}function n(g,p){var r=b,t=p[g];t&&"object"===typeof t&&"function"===typeof t.toJSON&&(t=t.toJSON(g));"function"===typeof k&&(t=k.call(p,g,t));switch(typeof t){case "string":return e(t);case "number":return isFinite(t)?String(t):"null";case "boolean":case "null":return String(t);
case "object":if(!t)return"null";b+=d;var q=[];if("[object Array]"===Object.prototype.toString.apply(t)){var w=t.length;for(g=0;g<w;g+=1)q[g]=n(g,t)||"null";p=0===q.length?"[]":b?"[\n"+b+q.join(",\n"+b)+"\n"+r+"]":"["+q.join(",")+"]";b=r;return p}if(k&&"object"===typeof k)for(w=k.length,g=0;g<w;g+=1){var m=k[g];"string"===typeof m&&(p=n(m,t))&&q.push(e(m)+(b?": ":":")+p)}else for(m in t)Object.hasOwnProperty.call(t,m)&&(p=n(m,t))&&q.push(e(m)+(b?": ":":")+p);p=0===q.length?"{}":b?"{\n"+b+q.join(",\n"+
b)+"\n"+r+"}":"{"+q.join(",")+"}";b=r;return p}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(g){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+c(this.getUTCMonth()+1)+"-"+c(this.getUTCDate())+"T"+c(this.getUTCHours())+":"+c(this.getUTCMinutes())+":"+c(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(g){return this.valueOf()});var h=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
a=/[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,b,d,f={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},k;"function"!==typeof JSON.stringify&&(JSON.stringify=function(g,p,r){var t;d=b="";if("number"===typeof r)for(t=0;t<r;t+=1)d+=" ";else"string"===typeof r&&(d=r);if((k=p)&&"function"!==typeof p&&("object"!==typeof p||"number"!==typeof p.length))throw Error("JSON.stringify");return n("",{"":g})});
"function"!==typeof JSON.parse&&(JSON.parse=function(g,p){function r(t,q){var w,m=t[q];if(m&&"object"===typeof m)for(w in m)if(Object.hasOwnProperty.call(m,w)){var l=r(m,w);void 0!==l?m[w]=l:delete m[w]}return p.call(t,q,m)}g=String(g);h.lastIndex=0;h.test(g)&&(g=g.replace(h,function(t){return"\\u"+("0000"+t.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(g.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return g=eval("("+g+")"),"function"===typeof p?r({"":g},""):g;throw new SyntaxError("JSON.parse");})})();
(function(){window.get_form_values=function(c){var e={};jQuery(c).find("input,select,textarea").each(function(n){if(this.name)if(e[this.name]||(e[this.name]=[]),"select"===this.nodeName.toLowerCase()){var h=e[this.name];$(this).find("option").each(function(a){this.selected&&h.push(this.value)})}else("input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type||this.checked)&&e[this.name].push(this.value||"")});return e};window.restore_form_values=function(c,e){var n=jQuery;n(c).find("input,select,textarea").each(function(h){if(this.name){var a=
e[this.name];"undefined"!=typeof a&&null!==a&&("input"!==this.nodeName.toLowerCase()||"checkbox"!==this.type&&"radio"!==this.type?"select"===this.nodeName.toLowerCase()?n(this).find("option").each(function(b){this.selected=1<a.length?0<=n.inArray(this.value,a):0===a.length?!1:this.value===a[0]}):this.value=a.length?a[0]:"":this.checked=1<a.length?0<=n.inArray(this.value,a):0===a.length?!1:this.value===a[0])}})};window.init_cached_state=function(c){var e=jQuery;c=c||"#EntryForm";onbeforeunload_fns=
[];onbeforerestorevalues_fns=[];e(window).on("beforeunload",function(){var n={form_values:get_form_values(c)};e.each(onbeforeunload_fns,function(h,a){a(n)});document.getElementById("cache_form_values").value=JSON.stringify(n)});window.cache_register_onbeforeunload=function(n){onbeforeunload_fns.push(n)};window.cache_register_onbeforerestorevalues=function(n){onbeforerestorevalues_fns.push(n)};window.restore_cached_state=function(){var n=document.getElementById("cache_form_values");if(n&&n.value){var h=
JSON.parse(n.value);e.each(onbeforerestorevalues_fns,function(a,b){b(h)});restore_form_values(c,h.form_values)}}}})();
(function(){var c=jQuery,e={"en-CA":"d M yy",de:"dd.mm.yy",fr:"d M yy",it:"d M yy",nl:"d M yy",no:"d M yy",pt:"d-mm-yy",sv:"d M yy",hu:"M d. yy",ro:"d M yy",hr:"d M yy",sl:"d M yy",bg:"d MM yy",ru:"d M yy",tr:"d M yy",lv:"d M yy",lt:"d M yy",ko:"yy/mm/dd","zh-CN":"yy/mm/dd",th:"d M yy"},n={"en-CA":!0,"":!0},h={},a={"fr-CA":"fr","es-MX":"es"},b=function(){var f=c(this),k=f.data("culture"),g=e[k]||c.datepicker.regional[k].dateFormat,p={};f.hasClass("NoYear")&&(g=g.replace(/[\- .\/]*yy[\/]?/,""),p={beforeShow:function(r,
t){t.dpDiv.addClass("NoYearDatePicker")},onClose:function(r,t){t.dpDiv.removeClass("NoYearDatePicker")},changeYear:!1});p.dateFormat=g;f.datepicker(c.extend({},c.datepicker.regional[k],p)).prop("autocomplete","off")},d=function(f){c.getScript("//ajax.googleapis.com/ajax/libs/jqueryui/"+c.ui.version+"/i18n/jquery.ui.datepicker-"+f+".min.js",function(){n[f]=!0;c.each(h[f],function(){b.call(this)});delete h[f]})};c.datepicker.regional["en-CA"]=c.extend({},c.datepicker.regional[""]);c.fn.extend({autodatepicker:function(){return this.each(function(){var f=
c(this);var k=f.parents("[lang]").first().prop("lang")||"en-CA";k=a[k]||k;f.data("culture",k);n[k]?b.call(this):(f=h[k],f||(f=h[k]=[],d(k)),f.push(this))})}});jQuery(function(){c("input.DatePicker").autodatepicker()})})();
...
"false"!==this.attr("contenteditable");if(null!=d&&(!d.form&&f&&(d.form=this.closest("form")[0],d.name=this.attr("name")),null!=d.form)){if(a){f=c.data(d.form,"validator").settings;var k=f.rules;var g=c.validator.staticRules(d);switch(a){case "add":c.extend(g,c.validator.normalizeRule(b));delete g.messages;k[d.name]=g;b.messages&&(f.messages[d.name]=c.extend(f.messages[d.name],b.messages));break;case "remove":if(!b)return delete k[d.name],g;var p={};c.each(b.split(/\s/),function(r,t){p[t]=g[t];delete g[t]});
return p}}a=c.validator.normalizeRules(c.extend({},c.validator.classRules(d),c.validator.attributeRules(d),c.validator.dataRules(d),c.validator.staticRules(d)),d);a.required&&(b=a.required,delete a.required,a=c.extend({required:b},a));a.remote&&(b=a.remote,delete a.remote,a=c.extend(a,{remote:b}));return a}}});var e=function(a){return a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,"")};c.extend(c.expr.pseudos||c.expr[":"],{blank:function(a){return!e(""+c(a).val())},filled:function(a){a=c(a).val();
...
b.val();if("file"===d){if("C:\\fakepath\\"===a.substr(0,12))return a.substr(12);d=a.lastIndexOf("/");if(0<=d)return a.substr(d+1);d=a.lastIndexOf("\\");return 0<=d?a.substr(d+1):a}return"string"===typeof a?a.replace(/\r/g,""):a},check:function(a){a=this.validationTargetFor(this.clean(a));var b=c(a).rules(),d=c.map(b,function(t,q){return q}).length,f=!1,k=this.elementValue(a),g;this.abortRequest(a);if("function"===typeof b.normalizer)var p=b.normalizer;else"function"===typeof this.settings.normalizer&&
(p=this.settings.normalizer);p&&(k=p.call(a,k),delete b.normalizer);for(g in b){p={method:g,parameters:b[g]};try{var r=c.validator.methods[g].call(this,k,a,p.parameters);if("dependency-mismatch"===r&&1===d)f=!0;else{f=!1;if("pending"===r){this.toHide=this.toHide.not(this.errorsFor(a));return}if(!r)return this.formatAndAdd(a,p),!1}}catch(t){throw this.settings.debug&&window.console&&console.log("Exception occurred when checking element "+a.id+", check the '"+p.method+"' method.",t),t instanceof TypeError&&
(t.message+=".  Exception occurred when checking element "+a.id+", check the '"+p.method+"' method."),t;}}if(!f)return this.objectLength(b)&&this.successList.push(a),!0},customDataMessage:function(a,b){return c(a).data("msg"+b.charAt(0).toUpperCase()+b.substring(1).toLowerCase())||c(a).data("msg")},customMessage:function(a,b){return(a=this.settings.messages[a])&&(a.constructor===String?a:a[b])},findDefined:function(){for(var a=0;a<arguments.length;a++)if(void 0!==arguments[a])return arguments[a]},
...
showLabel:function(a,b){var d,f=this.errorsFor(a),k=this.idOrName(a),g=c(a).attr("aria-describedby");if(f.length)f.removeClass(this.settings.validClass).addClass(this.settings.errorClass),this.settings&&this.settings.escapeHtml?f.text(b||""):f.html(b||"");else{f=c("<"+this.settings.errorElement+">").attr("id",k+"-error").addClass(this.settings.errorClass);this.settings&&this.settings.escapeHtml?f.text(b||""):f.html(b||"");var p=f;this.settings.wrapper&&(p=f.hide().show().wrap("<"+this.settings.wrapper+
"/>").parent());this.labelContainer.length?this.labelContainer.append(p):this.settings.errorPlacement?this.settings.errorPlacement.call(this,p,c(a)):p.insertAfter(a);if(f.is("label"))f.attr("for",k);else if(0===f.parents("label[for='"+this.escapeCssMeta(k)+"']").length&&(p=f.attr("id"),g?g.match(new RegExp("\\b"+this.escapeCssMeta(p)+"\\b"))||(g+=" "+p):g=p,c(a).attr("aria-describedby",g),d=this.groups[a.name])){var r=this;c.each(r.groups,function(t,q){q===d&&c("[name='"+r.escapeCssMeta(t)+"']",r.currentForm).attr("aria-describedby",
...
Array.isArray(a)?a.length:this.getLength(a,b);return this.optional(b)||a>=d[0]&&a<=d[1]},min:function(a,b,d){return this.optional(b)||a>=d},max:function(a,b,d){return this.optional(b)||a<=d},range:function(a,b,d){return this.optional(b)||a>=d[0]&&a<=d[1]},step:function(a,b,d){var f=c(b).attr("type"),k="Step attribute on input type "+f+" is not supported.",g=["text","number","range"],p=new RegExp("\\b"+f+"\\b"),r=function(q){return(q=(""+q).match(/(?:\.(\d+))?$/))?q[1]?q[1].length:0:0},t=!0;if(f&&
!p.test(g.join()))throw Error(k);f=r(d);if(r(a)>f||0!==Math.round(a*Math.pow(10,f))%Math.round(d*Math.pow(10,f)))t=!1;return this.optional(b)||t},equalTo:function(a,b,d){d=c(d);if(this.settings.onfocusout&&d.not(".validate-equalTo-blur").length)d.addClass("validate-equalTo-blur").on("blur.validate-equalTo",function(){c(b).valid()});return a===d.val()},remote:function(a,b,d,f){if(this.optional(b))return"dependency-mismatch";f="string"===typeof f&&f||"remote";var k=this.previousValue(b,f);this.settings.messages[b.name]||
(this.settings.messages[b.name]={});k.originalMessage=k.originalMessage||this.settings.messages[b.name][f];this.settings.messages[b.name][f]=k.message;d="string"===typeof d&&{url:d}||d;var g=c.param(c.extend({data:a},d.data));if(k.old===g)return k.valid;k.old=g;var p=this;this.startRequest(b);g={};g[b.name]=a;c.ajax(c.extend(!0,{mode:"abort",port:this.elementAjaxPort(b),dataType:"json",data:g,context:p.currentForm,success:function(r){var t=!0===r||"true"===r;p.settings.messages[b.name][f]=k.originalMessage;
if(t){var q=p.formSubmitted;p.toHide=p.errorsFor(b);p.formSubmitted=q;p.successList.push(b);p.invalid[b.name]=!1;p.showErrors()}else q={},r=r||p.defaultMessage(b,{method:f,parameters:a}),q[b.name]=k.message=r,p.invalid[b.name]=!0,p.showErrors(q);k.valid=t;p.stopRequest(b,t)}},d));return"pending"}}});var n={};if(c.ajaxPrefilter)c.ajaxPrefilter(function(a,b,d){b=a.port;"abort"===a.mode&&(c.ajaxAbort(b),n[b]=d)});else{var h=c.ajax;c.ajax=function(a){var b=("port"in a?a:c.ajaxSettings).port;return"abort"===
("mode"in a?a:c.ajaxSettings).mode?(c.ajaxAbort(b),n[b]=h.apply(this,arguments),n[b]):h.apply(this,arguments)}}c.ajaxAbort=function(a){n[a]&&(n[a].abort(),delete n[a])};return c});
(function(c,e){"$:nomunge";var n=c.jQuery||c.Cowboy||(c.Cowboy={}),h;n.throttle=h=function(a,b,d,f){function k(){function r(){p=+new Date;d.apply(q,m)}function t(){g=e}var q=this,w=+new Date-p,m=arguments;f&&!g&&r();g&&clearTimeout(g);f===e&&w>a?r():!0!==b&&(g=setTimeout(f?t:r,f===e?a-w:a))}var g,p=0;"boolean"!==typeof b&&(f=d,d=b,b=e);n.guid&&(k.guid=d.guid=d.guid||n.guid++);return k};n.debounce=function(a,b,d){return d===e?h(a,b,!1):h(a,d,!1!==b)}})(this);
(function(){function c(e){function n(m,l){var x=m==window,u=l&&void 0!==l.message?l.message:void 0;l=e.extend({},e.blockUI.defaults,l||{});if(!l.ignoreIfBlocked||!e(m).data("blockUI.isBlocked")){l.overlayCSS=e.extend({},e.blockUI.defaults.overlayCSS,l.overlayCSS||{});var y=e.extend({},e.blockUI.defaults.css,l.css||{});l.onOverlayClick&&(l.overlayCSS.cursor="pointer");var B=e.extend({},e.blockUI.defaults.themedCSS,l.themedCSS||{});u=void 0===u?l.message:u;x&&q&&h(window,{fadeOut:0});if(u&&"string"!=
typeof u&&(u.parentNode||u.jquery)){var C=u.jquery?u[0]:u,A={};e(m).data("blockUI.history",A);A.el=C;A.parent=C.parentNode;A.display=C.style.display;A.position=C.style.position;A.parent&&A.parent.removeChild(C)}e(m).data("blockUI.onUnblock",l.onUnblock);A=l.baseZ;var v=p||l.forceIframe?e('<iframe class="blockUI" style="z-index:'+A++ +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'+l.iframeSrc+'"></iframe>'):e('<div class="blockUI" style="display:none"></div>');
...
G.marginTop=0):!l.centerY&&x&&(H=l.css&&l.css.top?parseInt(l.css.top,10):0,G.setExpression("top","((document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "+H+') + "px"'))})}u&&(l.theme?A.find(".ui-widget-content").append(u):A.append(u),(u.jquery||u.nodeType)&&e(u).show());(p||l.forceIframe)&&l.showOverlay&&v.show();l.fadeIn?(y=l.onBlock?l.onBlock:g,v=l.showOverlay&&!u?y:g,y=u?y:g,l.showOverlay&&C._fadeIn(l.fadeIn,v),u&&A._fadeIn(l.fadeIn,y)):(l.showOverlay&&
...
return 0<u.parents("div."+l.blockMsgClass).length?!0:0===u.parents().children().filter("div.blockUI").length}function f(m){w&&(m=w[!0===m?w.length-1:0])&&m.focus()}function k(m,l,x){var u=m.parentNode,y=m.style,B=(u.offsetWidth-m.offsetWidth)/2-(parseInt(e.css(u,"borderLeftWidth"),10)||0);m=(u.offsetHeight-m.offsetHeight)/2-(parseInt(e.css(u,"borderTopWidth"),10)||0);l&&(y.left=0<B?B+"px":"0");x&&(y.top=0<m?m+"px":"0")}e.fn._fadeIn=e.fn.fadeIn;var g=e.noop||function(){},p=/MSIE/.test(navigator.userAgent),
r=/MSIE 6.0/.test(navigator.userAgent)&&!/MSIE 8.0/.test(navigator.userAgent),t=e.isFunction(document.createElement("div").style.setExpression);e.blockUI=function(m){n(window,m)};e.unblockUI=function(m){h(window,m)};e.growlUI=function(m,l,x,u){var y=e('<div class="growlUI"></div>');m&&y.append("<h1>"+m+"</h1>");l&&y.append("<h2>"+l+"</h2>");void 0===x&&(x=3E3);var B=function(C){C=C||{};e.blockUI({message:y,fadeIn:"undefined"!==typeof C.fadeIn?C.fadeIn:700,fadeOut:"undefined"!==typeof C.fadeOut?C.fadeOut:
...
return this.each(function(){"static"==e.css(this,"position")&&(this.style.position="relative",e(this).data("blockUI.static",!0));this.style.zoom=1;n(this,m)})};e.fn.unblock=function(m){return this[0]===window?(e.unblockUI(m),this):this.each(function(){h(this,m)})};e.blockUI.version=2.7;e.blockUI.defaults={message:"<h1>Please wait...</h1>",title:null,draggable:!0,theme:!1,css:{padding:0,margin:0,width:"30%",top:"40%",left:"35%",textAlign:"center",color:"#000",border:"3px solid #aaa",backgroundColor:"#fff",
...
"u");return h=h.replace(RegExp("[\u00fd\u00ff]","g"),"y")};window.string_ci_ai=c;window.slugify=function(h){h=c(h);h=h.replace(/-/g," ").replace(/[^a-z0-9\s]/g,"");h=h.trim();return h.replace(/\s+/g,"-")};var e=function(h,a,b,d,f){b=b||"value";d=d||"";f=f||"";return function(k,g){if(a.term&&(new RegExp(d+h.ui.autocomplete.escapeRegex(a.term)+f,"i")).test(k.term)&&a.content&&13>a.content.length){var p=new RegExp(d+h.ui.autocomplete.escapeRegex(k.term)+f,"i");g(h.grep(a.content,function(r){return p.test(c(r[b]))}));
return!0}return!1}};window.default_cache_search_fn=e;var n=function(h,a,b,d,f){b=b||{};f=f||e(h,b,d||"value");return function(k,g,p){k.term=c(k.term);b.term===k.term&&b.content?g(b.content):f(k,g)||h.ajax({url:p||a,dataType:"json",data:k,cache:!1,success:function(r){b.term=k.term;b.content=r;g(r)}})}};window.create_caching_source_fn=n;window.init_community_autocomplete=function(h,a,b,d,f){var k={};f&&=h(f);f&&!f.length&&(f=null);var g=h("#"+a).autocomplete({focus:function(p,r){return!1},select:function(p,
r){g.data({chkid:r.item.chkid,display:r.item.value})},source:n(h,b,k),minLength:d}).keypress(function(p){"13"==p.keyCode&&(p.preventDefault(),g.autocomplete("close"))});f&&(g.parents("form").on("submit",function(){var p=g.val();if(g.data("display")===p)f.val(g.data("chkid"));else{if(k.content){var r=c(p);p=h.grep(k.content,function(t){return c(t.value)===r});if(1===p.length){f.val(p[0].chkid);g.data({chkid:p[0].chkid,display:p[0].value}).val(p[0].value);return}}f.val("")}}),cache_register_onbeforerestorevalues(function(p){g.length&&
(p=p["autocomplete_data_"+g[0].id])&&g.data(p)}),cache_register_onbeforeunload(function(p){if(g.length){var r=g.data();r.display&&r.chkid&&(p["autocomplete_data_"+g[0].id]={display:r.display,chkid:r.chkid})}}))}})();
(function(){window.entryform=window.entryform||{};window.create_checklist_onbefore_fns=function(n,h,a,b){cache_register_onbeforeunload(function(d){d[h+"_added"]=a});cache_register_onbeforerestorevalues(function(d){(d=d[h+"_added"])&&n.each(d,function(f,k){b(k.chkid,k.display,"")})})};window.basic_chk_add_html=function(n,h){return function(a,b){a=n("<tr>").append(n("<td>").append(n("<input>").prop({id:h+"_ID_"+a,type:"checkbox",checked:!0,defaultChecked:!0,name:h+"_ID",value:a})).append(document.createTextNode(" "+
b))).append(n("<td>").append(n("<input>").prop({id:h+"_NOTES_"+a,name:h+"_NOTES_"+a,size:entryform.chk_notes_size,maxlength:entryform.chk_notes_maxlen})));n("#"+h+"_existing_add_table").append(a);return a.find('input[type="checkbox"]')[0]}};var c={},e=function(n){$("#NEW_"+n).autocomplete(c[n])};window.init_autocomplete_checklist=function(n,h){var a=h.field;if(!c[a]){var b=h.source;h.minLength=h.minLength||1;h.delay=h.delay||300;h.add_new_html=h.add_new_html||basic_chk_add_html(n,a);h.match_prop=
h.match_prop||"value";h.txt_not_found=h.txt_not_found||"Not Found";var d=n(h.delegate_root||document),f=h.added_values||[],k=function(q,w,m){var l=document.getElementById(a+"_ID_"+q);l?(l.checked=!0,h.after_add_new_value&&h.after_add_new_value.call(l)):(f.push({chkid:q,display:w,label:m}),q=h.add_new_html(q,w,m),h.after_add_new_value&&h.after_add_new_value.call(q))};create_checklist_onbefore_fns(n,a,f,k);var g={},p=function(q){n("#NEW_"+a).data({chkid:"",display:"",label:""}).prop("value","").focus();
n("#"+a+"_error").hide("slow",function(){n(this).remove()})},r=null,t=null;(function(q){n.isArray(q)?(t=function(w,m){var l=new RegExp(n.ui.autocomplete.escapeRegex(string_ci_ai(w.term)));m(n.grep(q,function(x){return l.test(string_ci_ai(x[h.match_prop]||x))}))},r=function(w,m){var l=string_ci_ai(w);w=n.grep(q,function(x){return string_ci_ai(string_ci_ai(x[h.match_prop]||x))===l});if(1===w.length)return m(w[0]),!0;m()}):"string"===typeof q?(t=create_caching_source_fn(n,q,g,h.match_prop),r=function(w,
m,l){var x=string_ci_ai(w);if(g.content){var u=n.grep(g.content,function(y){return string_ci_ai(y[h.match_prop])===x});if(1===u.length){m(u[0]);return}}l||string_ci_ai(g.term||"")===x?m():t({term:x},function(y){r(w,m,!0)})}):(t=q,r=h.look_for_fn)})(b);d.on("click","#add_"+a,function(q){q=n("#NEW_"+a);var w=q.data("chkid"),m=q.data("display"),l=q.data("label"),x=q[0].value;if(w&&m&&m==x)return k(w,m,l),p(),!1;r(q[0].value,function(u){u?(k(u.chkid,u.value,u.label),p()):0===n("#"+a+"_error").length&&
(n("#"+a+"_new_input_table").before(n("<p>").hide().addClass("Alert").prop("id",a+"_error").append(document.createTextNode(h.txt_not_found))),n("#"+a+"_error").show("slow"))});return!1});c[a]={focus:function(q,w){return!1},source:t,minLength:h.minLength,delay:h.delay,select:function(q,w){n("#NEW_"+a).data({chkid:w.item.chkid,display:w.item.value,label:w.item.label})}};d.on("keypress","#NEW_"+a,function(q){"13"==q.keyCode&&(q.preventDefault(),n("#NEW_"+a).autocomplete("close"),n("#add_"+a).trigger("click"))})}e(a)};
window.init_languages=function(n,h){var a=null,b=null,d=n("#LN_existing_add_table"),f=function(){var k=n(this).parents(".language-entry").find(".language-details-notes");this.checked?k.slideDown():k.slideUp()};init_autocomplete_checklist(n,{field:"LN",source:entryform.languages_source,txt_not_found:h,after_add_new_value:f,add_new_html:function(k,g){null===a&&(a=n("#add_LN"),b=a.data("newTemplate"));k=b.replace(/LANGNAMELANGNAME/g,g).replace(/IDIDID/g,k);d.append(k)}});d.on("change",".language-primary",
f).uitooltip({items:"[data-help-text]",content:function(){return'<div class="language-help-text">'+n(this).data("helpText")+"</div>"},position:{my:"center bottom-20",at:"center top",using:function(k,g){n(this).css(k);n("<div>").addClass("arrow").addClass(g.vertical).addClass(g.horizontal).appendTo(this)}}});window.languages_check_state=f}})();
(function(){jQuery.fn.autoShorten=function(b,d,f){return this.each(function(){b=b||350;d=d||"[read more]";f=f||"[less]";var k=$(this),g=k.html();if(g.length>b){var p=g.substring(0,b).split(" ");p=$("<div>").html(p.slice(0,p.length-1).join(" ")+" ").append('<span class="ellipse-toggle SimulateLink">&hellip; '+d+"</span>").html();$(this).data("replacementText",g+' <span class="ellipse-toggle SimulateLink">'+f+"</span>").html(p).on("click","span.ellipse-toggle",function(){var r=k.html();k.html(k.data("replacementText"));
k.data("replacementText",r)})}})};var c=function(b,d,f){f=f||d+"_ID";return function(k,g){var p=b("#add_"+d).parent(),r=p.parent(),t=r.prev("tr");p=parseInt(p.prop("colspan"),10);var q=t.find("td").length;t.length&&p!==q||(t=b("<tr>").insertBefore(r));t.append(b("<td>").append(b("<label>").text(" "+g).prepend(b('<input type="checkbox" checked>').prop({id:d+"_ID_"+k,value:k,name:f}))))}},e=function(b,d){init_autocomplete_checklist($,{source:b,field:"reminder_user",add_new_html:c($,"reminder_user"),
txt_not_found:d})},n=function(){$(document).on("click","#add_reminder_agency",function(b){b.preventDefault();b=$("#NEW_reminder_agency");var d=c($,"reminder_agency"),f=b[0].value;if(f){var k=$("#reminder_agency_ID_"+f);k.length?k.prop("checked",!0):d(f,f);b.find("option").first().prop({selected:!0})}return!1});$.each(["NUM","VNUM"],function(b,d){$(document).on("click","#add_"+d,function(f){f.preventDefault();f=$("#NEW_"+d);var k=c($,d,d),g=f[0].value;if(g){var p=$("#"+d+"_ID_"+g);p.length?p.prop("checked",
...
(function(){var c=null;window.initialize_record_maps=function(e,n){c=$("div#map_canvas");if(c.length){e="https://www.google.com/maps/embed/v1/place?"+e;var h=c.attr("latitude")+","+c.attr("longitude");e=e+"&"+$.param({center:h,zoom:13,q:h,maptype:"roadmap",language:n});c.show();c.append($("<iframe>").prop({src:e,frameborder:0}).css({border:0,height:"100%",width:"100%"}))}}})();
(function(){var c={},e=jQuery,n=null,h={},a={},b="",d=function(){var v=e(this);v.uibutton({icons:{primary:v.data("icon")},text:!1})},f=function(v){n=n.map(function(){return 0<=v.indexOf(e(this).data("vutId"))?this:null});n.each(function(){var z=e(this),D=z.data("vutId");z.data("uiAdded")||(z.data("uiAdded",!0),e('<span class="vacancy-ui vacancy-buttonset"><button class="vacancy-edit" id="vacancy-edit-'+D+'" data-vut-id="'+D+'" title="'+c.edit_txt+'" data-icon="ui-icon-pencil">'+c.edit_txt+'</button><button class="vacancy-history" data-icon="ui-icon-note" data-vut-id="'+
...
p=function(v,z,D,F){return function(E){D.unblock();E.updates&&g(E.updates);k(F,(E.success?"alert-highlight":"alert-error")+" vacancy-notification",E.msg)}},r=function(v,z,D,F){return function(E,H){D.unblock();k(F,"alert-error vacancy-notification",c.server_error_txt+("error"!==H?H:E.statusText))}},t,q=function(){b&&(t&&clearTimeout(t),t=setTimeout(w,15E3))},w=function(){t=null;e.ajax({dataType:"json",url:c.refresh_url,cache:!1,data:{ids:b}}).done(function(v){v.success&&g(v.updates)}).always(q)},m=
function(v,z){var D=z.parent().block({message:null});z=z.data("vutId");var F=D.find(".vacancy-count"),E=D.find(".vacancy-notify-area");E.length||(E=e('<div class="vacancy-notify-area alert-stack"></div>'),E.appendTo(D));e.ajax({dataType:"json",url:c.increment_url,type:"POST",data:{BT_VUT_ID:z,Value:v}}).done(p(z,F,D,E)).fail(r(z,F,D,E))},l=function(){if(c.permission_url){n=e(".vacancy-count");var v=n.map(function(){return e(this).data("vutId")}).get();if(b=v=v.join())e.ajax({dataType:"json",url:c.permission_url,
