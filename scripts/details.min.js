...
(function(){var c=null;window.initialize_record_maps=function(a,b){c=$("div#map_canvas");if(c.length){var e="https://www.google.com/maps/embed/v1/place?"+a,d=c.attr("latitude")+","+c.attr("longitude"),e=e+"&"+$.param({center:d,zoom:13,q:d,maptype:"roadmap",language:b});c.show();c.append($("<iframe>").prop({src:e,frameborder:0}).css("border",0))}}})();
